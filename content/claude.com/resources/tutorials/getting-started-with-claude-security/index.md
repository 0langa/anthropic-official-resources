...
## **Prerequisites**[](https://academy.claude.com/tutorials/getting-started-with-claude-security)
...
## **Setup**[](https://academy.claude.com/tutorials/getting-started-with-claude-security)
...
## **Running a Scan**[](https://academy.claude.com/tutorials/getting-started-with-claude-security)
...
## **Reviewing and Acting on Findings**[](https://academy.claude.com/tutorials/getting-started-with-claude-security)
...
## **Operationalizing the tool for ongoing use**[](https://academy.claude.com/tutorials/getting-started-with-claude-security)
