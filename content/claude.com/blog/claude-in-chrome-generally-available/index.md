...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/claude-in-chrome-generally-available)Claude for Teachers, now available for U.S. K-12 schools and districts
...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-in-chrome-generally-available)Claude gets its own browser in Cowork
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-in-chrome-generally-available)Compliance API coverage extends to Claude Cowork and Claude Code
...
[Claude's memory works everywhere, and you decide what's in it](https://claude.com/blog/claude-in-chrome-generally-available)Claude's memory works everywhere, and you decide what's in it
