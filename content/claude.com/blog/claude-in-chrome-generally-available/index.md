...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/claude-in-chrome-generally-available)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/claude-in-chrome-generally-available)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/claude-in-chrome-generally-available)Claude Cowork and chat are now one Claude
