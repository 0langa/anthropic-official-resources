...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot)Compliance API coverage extends to Claude Cowork and Claude Code
