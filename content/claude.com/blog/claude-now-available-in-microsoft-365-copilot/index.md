...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/claude-now-available-in-microsoft-365-copilot)Claude Cowork and chat are now one Claude
