...
[Projects redesigned: from folder to conversation](https://claude.com/blog/introducing-the-claude-apps-gateway)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/introducing-the-claude-apps-gateway)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/introducing-the-claude-apps-gateway)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/introducing-the-claude-apps-gateway)Build and share AI-powered apps with Claude
