...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/introducing-the-claude-apps-gateway)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/introducing-the-claude-apps-gateway)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/introducing-the-claude-apps-gateway)Claude Cowork and chat are now one Claude
