...
[Projects redesigned: from folder to conversation](https://claude.com/blog/claude-managed-agents-updates)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/claude-managed-agents-updates)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/claude-managed-agents-updates)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/claude-managed-agents-updates)Build and share AI-powered apps with Claude
