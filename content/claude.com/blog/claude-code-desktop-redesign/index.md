...
[Claude Code on the web](https://claude.com/blog/claude-code-desktop-redesign)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/claude-code-desktop-redesign)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/claude-code-desktop-redesign)Claude Marketplace: one place to discover plugins, agents, and services from our partners
...
[How to prepare for AI-driven code modernization projects](https://claude.com/blog/claude-code-desktop-redesign) How to prepare for AI-driven code modernization projects
