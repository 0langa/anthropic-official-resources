...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
...
[How to prepare for AI-driven code modernization projects](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples) How to prepare for AI-driven code modernization projects
...
[Reducing cost and improving performance with Claude Platform](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Reducing cost and improving performance with Claude Platform
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/how-to-create-skills-key-steps-limitations-and-examples)Projects redesigned: from folder to conversation
