...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/building-agents-with-skills-equipping-agents-for-specialized-work)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
...
[How to prepare for AI-driven code modernization projects](https://claude.com/blog/building-agents-with-skills-equipping-agents-for-specialized-work) How to prepare for AI-driven code modernization projects
...
[Reducing cost and improving performance with Claude Platform](https://claude.com/blog/building-agents-with-skills-equipping-agents-for-specialized-work)Reducing cost and improving performance with Claude Platform
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/building-agents-with-skills-equipping-agents-for-specialized-work)Projects redesigned: from folder to conversation
