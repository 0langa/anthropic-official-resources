...
[Claude Code on the web](https://claude.com/blog/observability-for-developers-building-connectors)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/observability-for-developers-building-connectors)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/observability-for-developers-building-connectors)Claude Marketplace: one place to discover plugins, agents, and services from our partners
