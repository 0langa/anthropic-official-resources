...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/fine-tune-claude-3-haiku)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/fine-tune-claude-3-haiku)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/fine-tune-claude-3-haiku)Claude Cowork and chat are now one Claude
