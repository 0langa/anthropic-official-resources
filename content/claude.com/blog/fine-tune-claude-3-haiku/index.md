...
[Claude gets its own browser in Cowork](https://claude.com/blog/fine-tune-claude-3-haiku)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/fine-tune-claude-3-haiku) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/fine-tune-claude-3-haiku)Compliance API coverage extends to Claude Cowork and Claude Code
