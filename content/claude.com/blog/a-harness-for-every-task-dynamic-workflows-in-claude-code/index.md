...
[Projects redesigned: from folder to conversation](https://claude.com/blog/a-harness-for-every-task-dynamic-workflows-in-claude-code)Projects redesigned: from folder to conversation
