...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/code-w-claude-london-2026-rethinking-how-we-build)Claude for Teachers, now available for U.S. K-12 schools and districts
...
[Claude gets its own browser in Cowork](https://claude.com/blog/code-w-claude-london-2026-rethinking-how-we-build)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/code-w-claude-london-2026-rethinking-how-we-build) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/code-w-claude-london-2026-rethinking-how-we-build)Compliance API coverage extends to Claude Cowork and Claude Code
