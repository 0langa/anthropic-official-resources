...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-2-1-prompting)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-2-1-prompting) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-2-1-prompting)Compliance API coverage extends to Claude Cowork and Claude Code
