...
[Claude Code on the web](https://claude.com/blog/cowork-chrome-side-panel)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/cowork-chrome-side-panel)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/cowork-chrome-side-panel)Claude Marketplace: one place to discover plugins, agents, and services from our partners
