...
[Claude gets its own browser in Cowork](https://claude.com/blog/cowork-chrome-side-panel)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/cowork-chrome-side-panel) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/cowork-chrome-side-panel)Compliance API coverage extends to Claude Cowork and Claude Code
