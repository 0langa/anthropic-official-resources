...
[Claude gets its own browser in Cowork](https://claude.com/blog/evaluate-prompts)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/evaluate-prompts) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/evaluate-prompts)Compliance API coverage extends to Claude Cowork and Claude Code
