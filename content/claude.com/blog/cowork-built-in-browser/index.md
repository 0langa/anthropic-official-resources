...
[Claude Code on the web](https://claude.com/blog/cowork-built-in-browser)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/cowork-built-in-browser)Claude Cowork and chat are now one Claude
