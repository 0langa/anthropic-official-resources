...
- Share
  ...
  [Copy link](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)
...
[Prev](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)Prev

0/5

[Next](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)Next
...
You can use the env variable `${CLAUDE_PLUGIN_DATA}` to get a stable directory where you can store data, read more persisting data in skills here: [https://code.claude.com/docs/en/plugins-reference#persistent-data-directory](https://code.claude.com/docs/en/plugins-reference).
...
[The AI-Native SDLC playbook](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)The AI-Native SDLC playbook
...
[How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep
...
[Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions
...
[The new rules of context engineering for Claude 5 generation models](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills) The new rules of context engineering for Claude 5 generation models
...
[Subscribe](https://claude.com/blog/lessons-from-building-claude-code-how-we-use-skills)Subscribe
