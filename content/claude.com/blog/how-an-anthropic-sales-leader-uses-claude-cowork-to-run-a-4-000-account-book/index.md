...
[How people are using Claude Cowork](https://claude.com/blog/how-an-anthropic-sales-leader-uses-claude-cowork-to-run-a-4-000-account-book)How people are using Claude Cowork
