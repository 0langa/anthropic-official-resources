...
[Projects redesigned: from folder to conversation](https://claude.com/blog/using-claude-code-the-unreasonable-effectiveness-of-html)Projects redesigned: from folder to conversation
