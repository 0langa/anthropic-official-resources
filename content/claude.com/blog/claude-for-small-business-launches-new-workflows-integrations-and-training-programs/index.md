...
Ask“give me my Monday brief”

or type`/monday-brief`

Set it to “weekly” during setup and it runs at the same time every Monday, with the option to push to a standing dashboard via an artifact or website.

Works with37 connectors

All 37 partner connectors are eligible.
...
Juanny Romero, founder and CEO · Las Vegas

22%in-store margins, credited in part to tighter scheduling, ordering, and inventory reporting

6cafés run from one consolidated view
...
Ask“answer new leads as they come in”

or type`/speed-to-lead`

A standing workflow, on the schedule you set.

Works with15 connectors
...
$60,000in sales tied to the tool in its first four days

18%of online revenue newly attributed to in-person visits, two weeks into the pilot
...
Ask“turn this into a proposal”

or type`/proposal-builder`

First: attach the memo, photos, or RFP, or pull a call transcript.

Works with17 connectors
...
Michael and Joni Kazantzis, co-founders · Princeton, New Jersey

Weeks → minutesfrom scoping a deal to a statement of work out for signature
...
Ask“plan next week's content”

or type`/social-content-engine`

Keeps the posting calendar full.

Runs on a weekly schedule for the numbers and reviews.

type`/marketing-monday`

Works with16 connectors
...
Kirsten Maitland, co-founder and CEO · Austin
...
or type`/build-connector`

Ask“make this part of the close”

or type`/build-agent`

Works with14 connectors
...
Chris Scott, COO, and Jennifer Scott, founder and CEO · Dallas

16transactions isolated behind a $13,000 discrepancy

10 secondsfor a monthly reporting task that used to take two hours

HireEffect, a Dallas firm that runs bookkeeping, payroll, and HR for small businesses nationwide, had a client whose books carried a $13,000 discrepancy buried in two and a half years and tens of thousands of PayPal transactions. COO Chris Scott used Claude to isolate the exact 16 transactions responsible. “It was literally a needle in a haystack. There's no way we'd have found it without this,” says Founder and CEO Jennifer Scott.
...
Half the owners we surveyed on the spring tour named data security as their biggest hesitation about using AI. Here's how controls work:

- **By default, you decide what runs, and when.** Every workflow starts in approval mode. Claude drafts the work and stages it, then waits for your OK. Once you’re comfortable with a workflow, you can let it run on its own. You make that choice one workflow at a time and can switch it back whenever you want.
- **Some workflows stop short of the last step.** For instance, Claude stages payroll in Gusto for you to submit.
- **Your existing software permissions hold.** If an employee can’t see something in Intuit QuickBooks or Google Drive today, they can’t see it through Claude.
- By default, we don’t train on your business data on Team and Enterprise plans.

Full details are in our [Trust Center](https://trust.anthropic.com/).

## New opportunities for training and enablement
...
In the coming weeks, we’ll be announcing community-run Claude workshops hosted by Approved Claude SMB Trainers, who were trained via dedicated, Tenex and Anthropic-hosted “Train the Trainer” events in San Francisco and New York City this summer.

This fall, the companies behind our integrations will also teach small business owners how to use Claude with the tools they already run on. In the Claude for Small Business partner webinar series, 14 technology partners will each host a free, live webinar on their connector from late September through November. Each session covers what the connector can do inside Claude, how your data moves between the tool and Claude, and a workflow you'll run live before the session ends.

Register here: [Notion](https://luma.com/0p7fmc93) (Sept. 25), [RingCentral](https://events.ringcentral.com/events/ringcentral-anthropic-webinar?code=1VT0iDMhkYRYHvCvKuh7xHS1x) (Oct. 1), [Zoom](https://events.zoom.us/ev/AiJIgCaSD_osXZeGeXnc35LGiTBIHdUDmFozuhmTENO1P2oUl3I-~AgAG7IFCoItAIlAIpdM2J7wX0K8l1OTZimYEPk8HrltCwvlqK6sEY7HXfqtWBB5w0i-aA4o-9WIvF50a6y0xYOIbiQ) (Oct. 8), [monday.com](https://monday.zoom.us/webinar/register/WN_WkuWnYDXQ9GQMisrSzJgpg) (Oct. 12), [Expensify](https://monday.zoom.us/webinar/register/WN_WkuWnYDXQ9GQMisrSzJgpg) (Oct. 13), [Apollo](https://events.apollo.io/apollo-claude-growth/) (Oct. 15), [HubSpot](https://adminhug.info/claude102026) (Oct. 20), [Gusto](https://event.on24.com/wcc/r/5496016/977F305A86D5D6E06F602DE266A993C6) (Oct. 21), [Zapier](https://zapier.com/resources/events/claude-smb-zapier-with-anthropic) (Oct. 22) [Xero](https://xero.zoom.us/webinar/register/WN_c_4fE7BGRGi35kiIK1OwCA) (Oct. 27), [Clay](https://www.clay.com/livestreams/claude-for-small-business-build-your-growth-engine-with-clay) (Oct. 28), [TikTok](https://www.tiktokacademy.com/student/page/3663358-north-american-europe-putting-ai-agents-to-work-powering-growth-with-tiktok-ads-and-claude-for-small-business) (Oct. 29), [Alignable](https://www.alignable.com/groups/invite-only-events/events/how-small-businesses-are-growing-with-ai-nov-2026) (Nov. 5), and [Atlassian](https://www.linkedin.com/events/run-grow-andenableyourbusinessw7503923852599525376/) (Nov. 17). We'll add more in the coming weeks, [here](https://claude.com/solutions/small-business?tab=virtual).
...
[Claude for Financial Advisors](https://claude.com/blog/claude-for-small-business-launches-new-workflows-integrations-and-training-programs)Claude for Financial Advisors
...
[Building commerce agents with Claude](https://claude.com/blog/claude-for-small-business-launches-new-workflows-integrations-and-training-programs)Building commerce agents with Claude
...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/claude-for-small-business-launches-new-workflows-integrations-and-training-programs)Claude for Teachers, now available for U.S. K-12 schools and districts
...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-for-small-business-launches-new-workflows-integrations-and-training-programs)Claude gets its own browser in Cowork
