...
- Share
  ...
  [Copy link](https://claude.com/blog/whats-new-in-claude-managed-agents)
...
[Prev](https://claude.com/blog/whats-new-in-claude-managed-agents)Prev

0/5

[Next](https://claude.com/blog/whats-new-in-claude-managed-agents)Next
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/whats-new-in-claude-managed-agents)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/whats-new-in-claude-managed-agents)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/whats-new-in-claude-managed-agents)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/whats-new-in-claude-managed-agents)Build and share AI-powered apps with Claude
...
[Subscribe](https://claude.com/blog/whats-new-in-claude-managed-agents)Subscribe
