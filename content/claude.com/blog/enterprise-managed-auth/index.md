...
[Build plugins for Claude](https://claude.com/blog/enterprise-managed-auth)Build plugins for Claude
...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/enterprise-managed-auth)Claude Tag now supports personal connectors in channels
...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/enterprise-managed-auth)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/enterprise-managed-auth)Claude Marketplace: one place to discover plugins, agents, and services from our partners
