...
[Claude Code on the web](https://claude.com/blog/enterprise-managed-auth)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/enterprise-managed-auth)Claude Cowork and chat are now one Claude
...
[How CodeRabbit, Power Digital, and ThoughtSpot scale with Snowflake and Vercel on Claude Marketplace](https://claude.com/blog/enterprise-managed-auth)How CodeRabbit, Power Digital, and ThoughtSpot scale with Snowflake and Vercel on Claude Marketplace
