...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/new-in-claude-managed-agents)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/new-in-claude-managed-agents)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/new-in-claude-managed-agents)Claude Cowork and chat are now one Claude
