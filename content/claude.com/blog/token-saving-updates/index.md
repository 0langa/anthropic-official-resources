...
[Claude gets its own browser in Cowork](https://claude.com/blog/token-saving-updates)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/token-saving-updates) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/token-saving-updates)Compliance API coverage extends to Claude Cowork and Claude Code
