...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/claude-code-and-slack)Claude for Teachers, now available for U.S. K-12 schools and districts
...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-code-and-slack)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-code-and-slack) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-code-and-slack)Compliance API coverage extends to Claude Cowork and Claude Code
