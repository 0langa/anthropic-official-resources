...
- Share
  ...
  [Copy link](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)
...
Compaction is tricky but luckily, you don't need to learn these lessons yourself—based on our learnings from Claude Code we built [compaction](https://platform.claude.com/docs/en/build-with-claude/compaction) directly into the API, so you can apply these patterns in your own applications.
...
[Prev](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)Prev

0/5

[Next](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)Next
...
[The AI-Native SDLC playbook](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)The AI-Native SDLC playbook
...
[How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep
...
[Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions
...
[The new rules of context engineering for Claude 5 generation models](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything) The new rules of context engineering for Claude 5 generation models
...
[Subscribe](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)Subscribe
