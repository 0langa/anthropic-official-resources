...
[Projects redesigned: from folder to conversation](https://claude.com/blog/lessons-from-building-claude-code-prompt-caching-is-everything)Projects redesigned: from folder to conversation
