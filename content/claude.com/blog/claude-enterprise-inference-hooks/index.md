...
[Claude Code on the web](https://claude.com/blog/claude-enterprise-inference-hooks)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/claude-enterprise-inference-hooks)Claude Cowork and chat are now one Claude
...
[How CodeRabbit, Power Digital, and ThoughtSpot scale with Snowflake and Vercel on Claude Marketplace](https://claude.com/blog/claude-enterprise-inference-hooks)How CodeRabbit, Power Digital, and ThoughtSpot scale with Snowflake and Vercel on Claude Marketplace
