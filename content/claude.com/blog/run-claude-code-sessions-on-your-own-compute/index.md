...
[Claude gets its own browser in Cowork](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Compliance API coverage extends to Claude Cowork and Claude Code
