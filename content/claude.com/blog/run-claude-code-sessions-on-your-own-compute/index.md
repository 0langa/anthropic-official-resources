...
- Share
  ...
  [Copy link](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)
...
[Prev](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Prev

0/5

[Next](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Next
...
When using self-hosted environments, you deploy a set of [runners](https://code.claude.com/docs/en/self-hosted-environments). These long-lived processes pick up sessions and start a Claude Code process for each [session](https://code.claude.com/docs/en/self-hosted-environments). Runners come in two modes.
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Build and share AI-powered apps with Claude
...
[Subscribe](https://claude.com/blog/run-claude-code-sessions-on-your-own-compute)Subscribe
