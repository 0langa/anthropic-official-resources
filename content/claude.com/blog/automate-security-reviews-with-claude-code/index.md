...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/automate-security-reviews-with-claude-code)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/automate-security-reviews-with-claude-code)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/automate-security-reviews-with-claude-code)Claude Cowork and chat are now one Claude
