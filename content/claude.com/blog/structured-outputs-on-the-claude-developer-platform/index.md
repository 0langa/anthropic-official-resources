...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude Marketplace: one place to discover plugins, agents, and services from our partners
