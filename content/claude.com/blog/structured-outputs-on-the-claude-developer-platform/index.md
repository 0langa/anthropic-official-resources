...
[Prev](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Prev

0/5

[Next](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Next
...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude for Teachers, now available for U.S. K-12 schools and districts
...
[Claude gets its own browser in Cowork](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Compliance API coverage extends to Claude Cowork and Claude Code
...
[Subscribe](https://claude.com/blog/structured-outputs-on-the-claude-developer-platform)Subscribe
