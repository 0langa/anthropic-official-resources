...
[Claude gets its own browser in Cowork](https://claude.com/blog/prompt-improver)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/prompt-improver) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/prompt-improver)Compliance API coverage extends to Claude Cowork and Claude Code
