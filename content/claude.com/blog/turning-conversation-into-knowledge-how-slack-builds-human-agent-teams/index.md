...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/turning-conversation-into-knowledge-how-slack-builds-human-agent-teams)Claude Tag now supports personal connectors in channels
...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/turning-conversation-into-knowledge-how-slack-builds-human-agent-teams)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
