...
- Share
  ...
  [Copy link](https://claude.com/blog/subagents-in-claude-code)
...
For more on CLAUDE.md files, see [Customizing Claude Code for your codebase: setting up a CLAUDE.md file](https://preview.claude.ai/chat/link) and our Claude Code [CLAUDE.md](http://claude.md/) [file docs](https://code.claude.com/docs/en/memory).
...
For more on using skills with Claude Code, see our [Claude Code skills docs.](https://code.claude.com/docs/en/skills)
...
[Prev](https://claude.com/blog/subagents-in-claude-code)Prev

0/5

[Next](https://claude.com/blog/subagents-in-claude-code)Next
...
[The AI-Native SDLC playbook](https://claude.com/blog/subagents-in-claude-code)The AI-Native SDLC playbook
...
[How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep](https://claude.com/blog/subagents-in-claude-code)How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep
...
[Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions](https://claude.com/blog/subagents-in-claude-code)Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions
...
[The new rules of context engineering for Claude 5 generation models](https://claude.com/blog/subagents-in-claude-code) The new rules of context engineering for Claude 5 generation models
...
[Subscribe](https://claude.com/blog/subagents-in-claude-code)Subscribe
