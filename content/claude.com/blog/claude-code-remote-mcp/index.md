...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-code-remote-mcp)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-code-remote-mcp) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-code-remote-mcp)Compliance API coverage extends to Claude Cowork and Claude Code
