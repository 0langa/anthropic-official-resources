...
Web search is available now in feature preview for all paid Claude users in the United States. Support for users on our free plan and more countries is coming soon. To get started, toggle on web search in your [profile settings](https://claude.ai/redirect/website.v1.511b92f9-8255-4545-abf4-9817c96cb7d2/settings/profile) and start a conversation with Claude 3.7 Sonnet. When applicable, Claude will search the web to inform its response.

No items found.

[Prev](https://claude.com/blog/web-search)Prev

0/5

[Next](https://claude.com/blog/web-search)Next
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/web-search)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/web-search)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/web-search)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/web-search)Build and share AI-powered apps with Claude
...
[Subscribe](https://claude.com/blog/web-search)Subscribe
