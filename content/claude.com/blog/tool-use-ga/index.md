...
[Claude gets its own browser in Cowork](https://claude.com/blog/tool-use-ga)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/tool-use-ga) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/tool-use-ga)Compliance API coverage extends to Claude Cowork and Claude Code
