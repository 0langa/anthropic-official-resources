...
[Claude gets its own browser in Cowork](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code)Compliance API coverage extends to Claude Cowork and Claude Code
