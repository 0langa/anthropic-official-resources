...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude Marketplace: one place to discover plugins, agents, and services from our partners
