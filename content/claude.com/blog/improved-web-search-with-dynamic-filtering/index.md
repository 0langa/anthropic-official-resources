...
[Claude gets its own browser in Cowork](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/improved-web-search-with-dynamic-filtering) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Compliance API coverage extends to Claude Cowork and Claude Code
