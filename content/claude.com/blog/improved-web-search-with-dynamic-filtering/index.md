...
- Share
  ...
  [Copy link](https://claude.com/blog/improved-web-search-with-dynamic-filtering)
...
- [Tool search](https://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-search-tool):Dynamically discover tools from large libraries without loading all definitions into the context window.[‍](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use)
- [Tool use examples](https://platform.claude.com/docs/en/agents-and-tools/tool-use/implement-tool-use)**:** Provide sample tool calls directly in your tool definitions to demonstrate usage patterns and reduce parameter errors.
...
[Prev](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Prev

0/5

[Next](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Next
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Build and share AI-powered apps with Claude
...
[Subscribe](https://claude.com/blog/improved-web-search-with-dynamic-filtering)Subscribe
