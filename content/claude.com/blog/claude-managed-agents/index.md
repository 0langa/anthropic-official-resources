...
- Share
  ...
  [Copy link](https://claude.com/blog/claude-managed-agents)
...
Embedded media: https://www.youtube.com/embed/I1BvAHOsjBU
...
Embedded media: https://www.youtube.com/embed/45hPRdfDEsI
...
[Prev](https://claude.com/blog/claude-managed-agents)Prev

0/5

[Next](https://claude.com/blog/claude-managed-agents)Next
...
Managed Agents is priced on consumption. Standard Claude Platform token rates apply, plus $0.08 per session-hour for active runtime. See the [docs](https://platform.claude.com/docs/en/about-claude/pricing) for full pricing details.
...
[Projects redesigned: from folder to conversation](https://claude.com/blog/claude-managed-agents)Projects redesigned: from folder to conversation
...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/claude-managed-agents)Claude for Small Business launches new workflows, integrations, and training programs
...
[Turn ideas into interactive AI-powered apps](https://claude.com/blog/claude-managed-agents)Turn ideas into interactive AI-powered apps
...
[Build and share AI-powered apps with Claude](https://claude.com/blog/claude-managed-agents)Build and share AI-powered apps with Claude
...
[Subscribe](https://claude.com/blog/claude-managed-agents)Subscribe
