...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-platform-on-aws)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-platform-on-aws) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-platform-on-aws)Compliance API coverage extends to Claude Cowork and Claude Code
