...
[Claude gets its own browser in Cowork](https://claude.com/blog/bringing-claude-mythos-5-to-more-defenders)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/bringing-claude-mythos-5-to-more-defenders) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/bringing-claude-mythos-5-to-more-defenders)Compliance API coverage extends to Claude Cowork and Claude Code
