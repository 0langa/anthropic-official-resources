...
[How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep](https://claude.com/blog/using-claude-code-session-management-and-1m-context)How an Anthropic field marketer uses Claude Code to send weekly personalized updates to every sales rep
...
[Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions](https://claude.com/blog/using-claude-code-session-management-and-1m-context)Self-service data analytics in Slack: how Anthropic deploys Claude Tag for ad-hoc questions
...
[The new rules of context engineering for Claude 5 generation models](https://claude.com/blog/using-claude-code-session-management-and-1m-context) The new rules of context engineering for Claude 5 generation models
