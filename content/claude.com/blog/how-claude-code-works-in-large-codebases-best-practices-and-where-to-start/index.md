...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/how-claude-code-works-in-large-codebases-best-practices-and-where-to-start)Claude Tag now supports personal connectors in channels
...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/how-claude-code-works-in-large-codebases-best-practices-and-where-to-start)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
