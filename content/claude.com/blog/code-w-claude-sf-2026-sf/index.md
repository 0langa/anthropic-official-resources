...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude Cowork and chat are now one Claude
