...
[Claude gets its own browser in Cowork](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/code-w-claude-sf-2026-sf) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/code-w-claude-sf-2026-sf)Compliance API coverage extends to Claude Cowork and Claude Code
