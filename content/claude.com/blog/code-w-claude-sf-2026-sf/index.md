...
[Claude for Small Business launches new workflows, integrations, and training programs](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude for Small Business launches new workflows, integrations, and training programs
...
[Claude for Financial Advisors](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude for Financial Advisors
...
[Building commerce agents with Claude](https://claude.com/blog/code-w-claude-sf-2026-sf)Building commerce agents with Claude
...
[Claude for Teachers, now available for U.S. K-12 schools and districts](https://claude.com/blog/code-w-claude-sf-2026-sf)Claude for Teachers, now available for U.S. K-12 schools and districts
