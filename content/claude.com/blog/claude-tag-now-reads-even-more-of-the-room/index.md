...
[Claude in Chrome is generally available](https://claude.com/blog/claude-tag-now-reads-even-more-of-the-room) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-tag-now-reads-even-more-of-the-room)Compliance API coverage extends to Claude Cowork and Claude Code
