...
[Claude gets its own browser in Cowork](https://claude.com/blog/claudes-memory-works-everywhere-and-you-decide-whats-in-it)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claudes-memory-works-everywhere-and-you-decide-whats-in-it) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claudes-memory-works-everywhere-and-you-decide-whats-in-it)Compliance API coverage extends to Claude Cowork and Claude Code
