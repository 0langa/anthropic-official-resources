...
[Claude gets its own browser in Cowork](https://claude.com/blog/claude-code-and-new-admin-controls-for-business-plans)Claude gets its own browser in Cowork
...
[Claude in Chrome is generally available](https://claude.com/blog/claude-code-and-new-admin-controls-for-business-plans) Claude in Chrome is generally available
...
[Compliance API coverage extends to Claude Cowork and Claude Code](https://claude.com/blog/claude-code-and-new-admin-controls-for-business-plans)Compliance API coverage extends to Claude Cowork and Claude Code
