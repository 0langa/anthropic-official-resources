...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/collaborate-with-claude-across-excel-powerpoint-word-and-outlook)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/collaborate-with-claude-across-excel-powerpoint-word-and-outlook)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/collaborate-with-claude-across-excel-powerpoint-word-and-outlook)Claude Cowork and chat are now one Claude
