...
- Only give text prompts to [Claude Code](https://claude.ai/redirect/website.v1.fa8bab37-fab1-4b07-a8ce-051f34bd0b26/code). No editing files directly.
...
From there, I turned to [Claude Code](https://claude.ai/redirect/website.v1.fa8bab37-fab1-4b07-a8ce-051f34bd0b26/code), using the extension in VS Code.
...
Given Claude’s contribution to this paper, I wanted to have Claude as co-author. Unfortunately, [current arXiv policy forbids this](https://info.arxiv.org/help/moderation/index.html). The justification is that LLMs can’t take responsibility. This is a good point. So I added to my acknowledgments:
