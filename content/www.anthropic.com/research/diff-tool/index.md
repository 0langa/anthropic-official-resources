...
Among the thousands of candidates our tool flagged, we've identified and validated several concepts that act like switches for specific model behaviors.[1](https://www.anthropic.com/research/diff-tool) For example, we discovered:
