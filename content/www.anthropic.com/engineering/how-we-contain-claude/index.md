...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.2e8f38dc-7891-4b1f-9e56-a030800666ed) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.2e8f38dc-7891-4b1f-9e56-a030800666ed) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
