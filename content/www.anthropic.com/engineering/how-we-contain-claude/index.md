...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.2f01232f-47fd-468f-97d6-8a6215c125ac) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.2f01232f-47fd-468f-97d6-8a6215c125ac) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
