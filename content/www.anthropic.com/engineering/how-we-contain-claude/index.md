...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.4ae4888f-f91e-41ec-8216-b08c31fca4da) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.4ae4888f-f91e-41ec-8216-b08c31fca4da) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
