...
This also makes [claude.ai](http://claude.ai/redirect/website.v1.f30639c3-8abe-49ad-99e3-01d1d4fdb56d) subject to a more traditional threat model. We're not protecting user machines from agents; we're protecting our own infrastructure and each tenant from one another. Our pre-launch work for [claude.ai](http://claude.ai/redirect/website.v1.f30639c3-8abe-49ad-99e3-01d1d4fdb56d) was dominated by traditional security work like network configuration, internal service auth, and orchestration.
