...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.2b563feb-b1cf-4cf4-97ef-7a2993a84fef), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.
