...
Agent Skills are [supported today](https://www.anthropic.com/news/skills) across [Claude.ai](http://claude.ai/redirect/website.v1.cda5f8cc-6ce2-4716-a25c-d273bef328bd), Claude Code, the Claude Agent SDK, and the Claude Developer Platform.
