...
[Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.](https://claude.com/blog/building-agents-with-the-claude-agent-sdk)Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind.
...
[Reducing cost and improving performance with Claude Platform](https://claude.com/blog/building-agents-with-the-claude-agent-sdk)Reducing cost and improving performance with Claude Platform
