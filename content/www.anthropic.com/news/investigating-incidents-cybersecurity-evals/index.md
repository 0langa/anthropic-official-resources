...
We began running cybersecurity evaluations in February 2025 with Claude Sonnet 3.7 on [Cybench](https://cybench.github.io/), which consisted of 40 different capture-the-flag challenges. Over time, we’ve increased the number of benchmarks we use as new ones are released and model capabilities evolve. In the [Mythos 5 System Card](https://www-cdn.anthropic.com/d00db56fa754a1b115b6dd7cb2e3c342ee809620.pdf), for example, we included CyberGym and ExploitBench, benchmarks that evaluate the ability of language models to find novel vulnerabilities.[2](https://www.anthropic.com/news/investigating-incidents-cybersecurity-evals) In most of these evaluations, the environments are not connected to the internet, and the model is told as much.
