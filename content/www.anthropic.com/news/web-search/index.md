...
[Claude Tag now supports personal connectors in channels](https://claude.com/blog/web-search)Claude Tag now supports personal connectors in channels
...
[Claude Code on the web](https://claude.com/blog/web-search)Claude Code on the web
...
[Claude Cowork and chat are now one Claude](https://claude.com/blog/web-search)Claude Cowork and chat are now one Claude
...
[Claude Marketplace: one place to discover plugins, agents, and services from our partners](https://claude.com/blog/web-search)Claude Marketplace: one place to discover plugins, agents, and services from our partners
