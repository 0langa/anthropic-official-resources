...
- Local MCP server support in the [Claude Desktop apps](https://claude.ai/redirect/website.v1.e33e63ef-cd1a-43c4-a2a4-a0d1ac439b7b/download)
...
Developers can start building and testing MCP connectors today. All [Claude.ai](http://claude.ai/redirect/website.v1.e33e63ef-cd1a-43c4-a2a4-a0d1ac439b7b) plans support connecting MCP servers to the Claude Desktop app.
...
- Install pre-built MCP servers through the [Claude Desktop app](https://claude.ai/redirect/website.v1.e33e63ef-cd1a-43c4-a2a4-a0d1ac439b7b/download)
