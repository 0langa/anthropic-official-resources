...
Cowork reads the survey export and drafts a brief with themes and next steps.

## Ask in plain English

Point Cowork at the engagement folder and describe the brief you need.

/survey-themesHuman Resources

People / engagement-Q2

## Cowork themes the responses

The skill clusters open-text comments, segments by team and tenure, and weights by distinct respondents.

Running /survey-themes

Reading engagement-q2-export.csv
...
Reading org-roster-apr.csv for team and tenure

Result

Comparing against q1-people-brief.docx; weighting by distinct respondents

Result

Google Drive · created q2-people-brief.docx in engagement-Q2

q2-people-brief.docx
...
Read survey export and roster

2

Theme open-text responses

3

Segment by team and tenure

4

Separate broad signal from loud minority

5

Write People brief to folder
...
## A one-page People brief

Top themes, anonymized quotes, and a 30-day action plan per theme — ready for the leadership readout.

Q2 ENGAGEMENT · 487 RESPONSES · 84% PARTICIPATION

**1 · Manager 1:1 frequency** — broad signal, 38% of respondents, strongest in Engineering and Support.  
“I go three or four weeks between real 1:1s.” · “My manager’s great but has eleven directs.”  
→ 30-day: audit spans over 8; managers calendar-block weekly 1:1s by May 11; HRBP spot-check in the June pulse.

**2 · Career-path clarity for senior ICs** — 27%, concentrated in the 2-4 year tenure band.  
“I don’t know what L5 looks like here.” · “Promo criteria feel different team to team.”  
→ 30-day: publish the IC4→IC5 rubric by function; managers review it with every IC4 in their next 1:1.

**3 · Cross-team request load** — 19%, loudest in Design and Data but raised across functions.  
“Half my week is other teams’ asks with no intake.” · “I can’t tell which requests actually matter.”  
→ 30-day: stand up a shared intake form for Design and Data; leads triage Tuesdays.

Q2 People Brief

Document · DOCX · 24 KB · People / engagement-Q2

## Run it every survey cycle

Customize the anonymization rules once, then schedule it — the brief is in the quarter’s folder when the survey closes.
...
Runs `/survey-themes` on the newest export in People/engagement and writes the one-page brief and 30-day action plans to that quarter’s folder.

On the **second Monday**, quarterly

Every survey cycle, the People brief — themes, quotes, and a 30-day plan — is in the folder.
