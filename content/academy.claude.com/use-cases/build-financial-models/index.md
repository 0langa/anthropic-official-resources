...
## 1. Describe the task[](https://academy.claude.com/use-cases/build-financial-models)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/build-financial-models)
...
### Required context[](https://academy.claude.com/use-cases/build-financial-models)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/build-financial-models)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/build-financial-models)

Continue the conversation with Claude to refine, expand, or explore further.

### Create the IC memo[](https://academy.claude.com/use-cases/build-financial-models)
...
### Validate the growth assumptions[](https://academy.claude.com/use-cases/build-financial-models)
...
### Research recent exit multiples[](https://academy.claude.com/use-cases/build-financial-models)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/build-financial-models)

### Keep comps fresh with connected data[](https://academy.claude.com/use-cases/build-financial-models)
...
### Work directly in your spreadsheet with Claude[](https://academy.claude.com/use-cases/build-financial-models)
...
### Unlock further capabilities[](https://academy.claude.com/use-cases/build-financial-models)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/build-financial-models)
