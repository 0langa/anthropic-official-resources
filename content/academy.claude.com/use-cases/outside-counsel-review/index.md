...
Pulls billing and matter data, flags off-pattern entries, and drafts the partner-call talking points.

### Ask in plain English

Connect your matter system, point at the billing guidelines, and describe the review.

Legal-Ops / OC-Review-Q2

### Cowork scores every line item

Entries checked against your billing guidelines, every matter measured against its budget.

Reviewing outside counsel spend
...
Reading billing-guidelines-2026.pdf from folder
...
Computing budget variance and driver per matter

Result

Microsoft 365 · wrote OC-review-Q2-talking-points.docx
...
Pull billing and matter data

2

Flag off-pattern entries

3

Surface budget drift by matter
...
PDFbilling-guidelines-2026.pdf

XLSmatter-budgets-FY26.xlsx

DOCOC-review-Q1-talking-points.docx
...
### Off-pattern entries and budget drift, surfaced

Each flag cited to the guideline rule and the invoice line that broke it.

Reviewed **1,284 entries** · **9 matters** · 23 entries off-pattern · 3 over budget

RED**Block billing — Matter 2024-0087** — single 14.5-hr entry “review documents; prepare for and attend meetings.” Guideline §3.2 caps blocks at 4 hr. *Source:* Inv 11284 / line 7.

RED**Partner-rate research — Matter 2024-0112** — 6.2 hr of legal research billed at partner rate ($925/hr). Guideline §4.1 routes research to associates. *Source:* Inv 11301 / lines 3-5.

YELLOW**Budget drift — Matter 2024-0087** — $284k spent vs $210k budget (+35%); driver: expert-witness fees not in original scope. *Source:* matter-budgets-FY26.xlsx.

OC review — Q2 talking points

Document · DOCX · 64 KB · written to Legal-Ops / OC-Review-Q2

### Turn it into a skill and run it every month

Save as /oc-spend-review and schedule it — talking points land before each partner call.
...
First business day of each month, runs `/oc-spend-review` against the prior month’s invoices, flags off-pattern entries and budget drift, and posts the talking points to Legal-Ops.
