...
## 1. Describe the task[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
### Required context[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)

Continue the conversation with Claude to refine, expand, or explore further.

### Click an element in the map to go deeper[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
### Ask Claude to write up what the map showed[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
### Tell Claude where you'd draw it differently and it redraws[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/map-your-lit-review-mid-conversation)
