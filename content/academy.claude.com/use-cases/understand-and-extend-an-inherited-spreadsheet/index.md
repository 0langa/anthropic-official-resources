...
## 1. Describe the task[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)

Upload the spreadsheet so Claude can read formulas and trace cell references directly.

### Required context[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
### Optional context[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)

Continue the conversation with Claude to refine, expand, or explore further.

### Create a changelog for what you modified[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
### Update with actuals and analyze variance[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)

### Choose Opus for complex financial models[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
### Ask Claude to annotate the file[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
### Add features to visualize patterns[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/understand-and-extend-an-inherited-spreadsheet)
