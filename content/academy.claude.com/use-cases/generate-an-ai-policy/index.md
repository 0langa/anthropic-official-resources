...
## 1. Describe the task[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Required context[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Optional context[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/generate-an-ai-policy)

Continue the conversation with Claude to refine, expand, or explore further.

### Develop staff training materials[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Add board presentation deck[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Develop donor communication strategy[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/generate-an-ai-policy)

### Review jurisdiction-specific legal requirements[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Iterate the policy for your specific concerns[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Create role-specific policy summaries[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Build in policy review triggers[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
### Start with approved use cases before restrictions[](https://academy.claude.com/use-cases/generate-an-ai-policy)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/generate-an-ai-policy)
