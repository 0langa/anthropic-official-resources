...
## 1. Describe the task[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
### Required context[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)

Continue the conversation with Claude to refine, expand, or explore further.

### Click a tier to see the gap[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
### Ask Claude to redraw with a constraint[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
### Ask Claude to turn the pyramid into a cultivation timeline[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/see-what-your-campaign-goal-actually-requires)
