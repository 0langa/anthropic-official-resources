...
## 1. Describe the task[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)

To receive tailored practice materials, provide Claude with your case materials for context.

### Required context[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)

Continue the conversation with Claude to refine, expand, or explore further.

### Compare your approach to alternative solutions[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
### Dive deeper into certain frameworks[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
### Request a review on your work[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)

### Practice different case types[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
### Store practice cases in a Project[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
### Let Claude think longer for detailed reviews[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/practice-case-interviews-with-feedback)
