...
## 1. Describe the task[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)

Connect tools where your support and feedback lives using connectors so Claude can access and analyze your data.

### Required context[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)

Continue the conversation with Claude to refine, expand, or explore further.

### Improve the file output[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
### Compare segments[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
### Create a repeatable workflow[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)

### Work with messy data[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
### Watch for echo chamber effects[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
### Combine with quantitative data for the full picture[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/analyze-patterns-in-user-feedback)
