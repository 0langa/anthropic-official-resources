...
## 1. Describe the task[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/analyze-fundraising-performance)

### Required context[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/analyze-fundraising-performance)

Continue the conversation with Claude to refine, expand, or explore further.

### Deeper Event Analysis[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
### Add an Executive Briefing Document[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
### Build in donor lifetime value analysis[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/analyze-fundraising-performance)

### Design language in prompts drives visual quality[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
### Verify key financial calculations[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
### Create a skill for recurring analysis[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/analyze-fundraising-performance)
