...
## 1. Describe the task[](https://academy.claude.com/use-cases/write-an-impact-report)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Required context[](https://academy.claude.com/use-cases/write-an-impact-report)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/write-an-impact-report)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/write-an-impact-report)

Continue the conversation with Claude to refine, expand, or explore further.

### Add specific stakeholder versions[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Generate presentation materials[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Create social media content[](https://academy.claude.com/use-cases/write-an-impact-report)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/write-an-impact-report)

### Verify information before sharing with funders[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Upload raw data, not pre-summarized reports[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Specify your audience's priorities[](https://academy.claude.com/use-cases/write-an-impact-report)
...
### Build incrementally for complex reports[](https://academy.claude.com/use-cases/write-an-impact-report)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/write-an-impact-report)
