...
Embedded media: https://www.youtube-nocookie.com/embed/FpOAn6Dh44k?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0

[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=FpOAn6Dh44k)

## 1. Describe the task[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
### Required context[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/preclinical-study-analysis)

Continue the conversation with Claude to refine, expand, or explore further.

### Generate regulatory documentation[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/preclinical-study-analysis)

### Connects directly to your source data[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
### Open external links to verify and interact with content[](https://academy.claude.com/use-cases/preclinical-study-analysis)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/preclinical-study-analysis)
