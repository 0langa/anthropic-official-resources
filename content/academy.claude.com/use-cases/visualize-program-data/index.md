...
## 1. Describe the task[](https://academy.claude.com/use-cases/visualize-program-data)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Required context[](https://academy.claude.com/use-cases/visualize-program-data)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/visualize-program-data)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/visualize-program-data)

Continue the conversation with Claude to refine, expand, or explore further.

### Add demographic breakdowns[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Focus on specific programs[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Leverage Research to Understand Benchmarks[](https://academy.claude.com/use-cases/visualize-program-data)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/visualize-program-data)

### Open the actual files to see full design quality[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Treat your first version as a strong foundation, then refine iteratively[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Push beyond defaults with specific design direction[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Consider which data stories matter most to different stakeholders[](https://academy.claude.com/use-cases/visualize-program-data)
...
### Build incremental visualization capacity rather than attempting everything at once[](https://academy.claude.com/use-cases/visualize-program-data)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/visualize-program-data)
