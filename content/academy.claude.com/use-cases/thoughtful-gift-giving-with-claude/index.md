...
## 1. Describe the task[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Required context[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)

None.

### Optional context[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)

Continue the conversation with Claude to refine, expand, or explore further.

### Search your notes and messages for forgotten hints[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Find specific products you can actually buy[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Let Claude interview you about someone you're stuck on[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)

### Share specific details, not just categories[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Set a per-person budget upfront[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Check your messages before you start[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
### Group your list by store before you go[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/thoughtful-gift-giving-with-claude)
