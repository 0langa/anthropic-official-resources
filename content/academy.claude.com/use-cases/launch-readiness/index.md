...
Reads the PRD, Slack channel, and Linear epic then writes a go/no-go checklist.

## Ask in plain English

Point Cowork at the launch folder and name the four sources to sweep.

/launch-readinessProduct Management

Launches / saved-views

## Cowork sweeps all four sources

PRD, Linear epic, Slack channel, GTM brief — read together, matched against prior retros.
...
Google Docs · read PRD-saved-views and GTM brief
...
Linear · pulled epic SAV-42 — 18 issues, 4 open
...
Slack · read #launch-saved-views — 7 days, 86 messages

Result

Comparing against retro-bulk-export-launch.md

Result

Created readiness-2026-04-27.md

readiness-2026-04-27.md
...
Read PRD and GTM brief

2

Pull Linear epic status

3

Read launch Slack channel

4

Match against prior retros

5

Write checklist to folder

#### Launches / saved-views

PRD-saved-views.docx

gtm-brief-saved-views.docx

launch-checklist-template.md

retro-bulk-export-launch.md
...
Mon Apr 27 · 8 days to launch

YELLOW

GREENFeature flag & rollout planSAV-42 merged Apr 24, staged to 5%Maya K

GREENMigration script for legacy filtersDry-run passed on 12k accountsTomás R

YELLOWPricing page copyStill marked TBD in GTM briefDerek L

REDSupport documentation0 of 3 articles drafted, no Intercom macrosPriya N

YELLOWBeta feedback close-out4 Linear tickets open, 2 are P1Sana O

Blockers to clear yellow

Support docs haven’t started with 8 days left. Pricing copy is the only TBD in the GTM brief — Derek needs the tier decision from the Apr 22 thread.

Seen before

Support docs lagging matches the bulk-export retro — same bottleneck, same week-of scramble. The retro recommended drafting docs at PRD sign-off.

Saved Views launch readiness

Document · MD · 6 KB · Launches / saved-views

## Run it daily during launch week

Customize once, then schedule it — standup opens with the current picture every morning.
...
Runs `/launch-readiness` against the PRD, Linear epic, Slack channel, and GTM brief and writes the dated checklist to Launches/saved-views.

**Daily at 8:00am**, May 4 to May 8

Every morning of launch week, the readiness checklist is in the folder before standup.
