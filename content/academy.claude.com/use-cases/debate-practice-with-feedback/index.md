...
## 1. Describe the task[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/debate-practice-with-feedback)

Enable the right capabilities for Claude to build interactive tools.

### Required context[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/debate-practice-with-feedback)

Continue the conversation with Claude to refine, expand, or explore further.

### Analyze your weaknesses[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
### Create response cards for predictable questions[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
### Handle specific rhetorical tactics[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/debate-practice-with-feedback)

### Ask for the research first, then practice[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
### Customize the artifact's design[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
### AI-powered artifacts[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/debate-practice-with-feedback)
