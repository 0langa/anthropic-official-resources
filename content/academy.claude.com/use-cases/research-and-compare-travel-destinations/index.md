...
## 1. Describe the task[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
### Required context[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)

### Optional context[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)

Continue the conversation with Claude to refine, expand, or explore further.

### Refine the comparison[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
### Generate a presentation[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
### Create a detailed itinerary[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)

### Request advanced spreadsheet features[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
### Ask Claude to verify layout before finishing[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
### Use Web Search for current data[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/research-and-compare-travel-destinations)
