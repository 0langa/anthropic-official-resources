...
## 1. Describe the task[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
### Required context[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)

Continue the conversation with Claude to refine, expand, or explore further.

### Click a button to redraw with a constraint[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
### Ask Claude to stretch one scenario across time[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
### Ask Claude to write the board-ready version[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/see-budget-futures-side-by-side)
