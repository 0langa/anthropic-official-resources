...
## 1. Describe the task[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
### Required context[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)

Continue the conversation with Claude to refine, expand, or explore further.

### Continue on desktop with full context[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
### Dig deeper on a specific finding[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
### Pressure-test the argument[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)

### Voice input doesn't need to be polished[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)

Talk the way you think. Claude parses intent from rough, stream-of-consciousness input. Save the editing for desktop.

### Upload reference docs from mobile[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
### Be explicit about your timeline[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)

Telling Claude "I have a meeting in two hours" helps it calibrate what to prioritize and how much depth to provide.

### Desktop unlocks file creation[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/turn-transit-time-into-research-time)
