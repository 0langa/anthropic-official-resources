...
## 1. Describe the task[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
### Required context[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)

Continue the conversation with Claude to refine, expand, or explore further.

### Extract direct quotes[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
### Condense and reformat findings[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
### Deep-dive on violations[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)

### Always verify dates and citations before using them in filings[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
### Protect sensitive client information appropriately[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
### Specify professional legal formatting[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/track-discovery-timelines-and-analyze-patterns)
