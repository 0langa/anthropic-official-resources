...
Reads Slack, Zendesk, and your files, then writes a ranked brief for planning.
...
## Cowork reads every source at once

Folder files, Slack, Zendesk and Linear are pulled in together; the Progress card tracks the plan.

Running `/synthesize-feedback`

![](https://www.google.com/s2/favicons?domain=slack.com&sz=64)

Slack · read #product-feedback (218 messages, last 30d)

Result

![](https://www.google.com/s2/favicons?domain=zendesk.com&sz=64)

Zendesk · pulled 47 open tickets tagged “feedback”

Result

Comparing against folder files — clustering 380 items, scoring frequency × severity

Result

![](https://cdn.prod.website-files.com/68a44d4040f98a4adf2207b6/690abff72b804fad37465165_Linear.jpg)

Linear · matched 6 themes against Q2 roadmap (12 items)

Result

Created voc-brief-q2.md
...
Write VoC brief to folder

#### Product / voc-q2

nps-verbatims-q2.csv

zendesk-export-feedback.csv

sales-call-snippets.md

interview-01…06.docx · 6 files

#### Context

Connectors

![](https://www.google.com/s2/favicons?domain=slack.com&sz=64)Slack

![](https://www.google.com/s2/favicons?domain=zendesk.com&sz=64)Zendesk
...
## The one-page Voice of Customer brief

Six themes ranked by frequency and severity, the verbatim that sells each, and a roadmap flag.

**Voice of Customer — Q2**380 items · 6 themes

64 HIGH **Permissions & sharing model** → on roadmap · LIN-2847“I genuinely cannot tell who on my team can see this board.”

41 HIGH **Mobile editor lag on tablet** ⚠ net-new“Typing on iPad freezes for 3–4 seconds every paragraph.”

38 MED **Export to PDF breaks tables** → on roadmap · LIN-3102“Headers disappear and tables split mid-row every time.”

22 MED **Bulk-invite teammates from CSV** ⚠ net-new“Had to add 60 people one at a time before the workshop.”

+ 2 more themes · 4 of 6 already on roadmap

Voice of Customer brief — Q2

Document · MD · 9 KB · Product / voc-q2

## Run it ahead of every roadmap review

Customize the skill once, then schedule it — a fresh brief lands the Friday before planning.
...
Runs `/synthesize-feedback` against the quarter’s voc folder plus live Slack and Zendesk and writes the brief back to the folder.

On the **last Friday**, monthly

Every planning cycle, the feedback brief is in the folder before roadmap review.
