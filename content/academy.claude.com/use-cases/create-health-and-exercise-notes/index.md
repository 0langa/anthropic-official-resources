...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
### Required context[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
### Optional context[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)

Continue the conversation with Claude to refine, expand, or explore further.

### Create a progress tracker[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
### Learn the science behind it[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
### Adapt the routine as you improve[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)

### Formatting for Notes[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
### Always consult healthcare providers first[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-health-and-exercise-notes)
