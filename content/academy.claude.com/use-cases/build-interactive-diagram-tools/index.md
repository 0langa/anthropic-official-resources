...
## 1. Describe the task[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Required context[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Optional context[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)

Continue the conversation with Claude to refine, expand, or explore further.

### Add self-testing[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Add advanced features[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Generate companion materials from the same session[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)

### Paste errors directly into chat[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Long sessions compound rather than drift[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Include known troubleshooting upfront[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Spot-check the panels before you study from them[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
### Add sources to make it yours[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/build-interactive-diagram-tools)
