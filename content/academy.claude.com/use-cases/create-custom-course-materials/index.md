...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-custom-course-materials)

To begin, provide context needed to create your course content.

### Required context[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-custom-course-materials)

Continue the conversation with Claude to refine, expand, or explore further.

### Enhance visual design[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
### Generate matching problem sets[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-custom-course-materials)

### Explicitly specify certain visual elements[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
### Activate design excellence through framing[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
### Use projects for consistency across chapters[](https://academy.claude.com/use-cases/create-custom-course-materials)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-custom-course-materials)
