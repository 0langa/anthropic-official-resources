...
15 minPersonalClaude in Chrome
...
## 1. Describe the task[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
### Required context[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium">Folder</th><th class="border-b border-strong p-sm text-left font-medium">Files</th><th class="border-b border-strong p-sm text-left font-medium">What's in it</th></tr></thead><tbody><tr><td class="border-b p-sm">Work</td><td class="border-b p-sm">156</td><td class="border-b p-sm">Documents with company names, meeting notes, presentations</td></tr><tr><td class="border-b p-sm">Finance</td><td class="border-b p-sm">89</td><td class="border-b p-sm">Tax docs, receipts, bank statements, invoices</td></tr><tr><td class="border-b p-sm">Photos</td><td class="border-b p-sm">234</td><td class="border-b p-sm">Images and screenshots, organized by year</td></tr><tr><td class="border-b p-sm">Personal</td><td class="border-b p-sm">67</td><td class="border-b p-sm">Travel docs, medical records, insurance</td></tr><tr><td class="border-b p-sm">Projects</td><td class="border-b p-sm">145</td><td class="border-b p-sm">Grouped by project name where I could identify one</td></tr><tr><td class="border-b p-sm">Reference</td><td class="border-b p-sm">52</td><td class="border-b p-sm">Manuals, guides, saved articles</td></tr><tr><td class="border-b p-sm">Shared With Me</td><td class="border-b p-sm">73</td><td class="border-b p-sm">Files owned by others (can't move these, but grouped the view)</td></tr><tr><td class="border-b p-sm">Archive</td><td class="border-b p-sm">0</td><td class="border-b p-sm">Empty for now—waiting for your approval on old files</td></tr></tbody></table>
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/organize-files-in-google-drive)

Continue the conversation with Claude to refine, expand, or explore further.

### Remove the duplicates[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
### Archive old files[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
### Rename files consistently[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/organize-files-in-google-drive)

### Save your organization system as a shortcut[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
### Schedule monthly maintenance[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
### Claude asks before deleting anything[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/organize-files-in-google-drive)
