...
Embedded media: https://www.youtube-nocookie.com/embed/NcBnxbEC0Ng?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0

[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=NcBnxbEC0Ng)

## 1. Describe the task[](https://academy.claude.com/use-cases/draft-investment-memos)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Required context[](https://academy.claude.com/use-cases/draft-investment-memos)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/draft-investment-memos)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/draft-investment-memos)

Continue the conversation with Claude to refine, expand, or explore further.

### Show source citations for verification[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Expand on the valuation methodology[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Transform into presentation format[](https://academy.claude.com/use-cases/draft-investment-memos)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/draft-investment-memos)

### Use specific and clear instructions[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Download the actual memo, not just the preview[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Match model to task complexity[](https://academy.claude.com/use-cases/draft-investment-memos)
...
### Unlock specialized capabilities[](https://academy.claude.com/use-cases/draft-investment-memos)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/draft-investment-memos)
