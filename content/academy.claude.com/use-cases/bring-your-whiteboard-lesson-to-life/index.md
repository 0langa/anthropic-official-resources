...
## 1. Describe the task[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
### Required context[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)

Continue the conversation with Claude to refine, expand, or explore further.

### Ask Claude to redraw it with one thing changed[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
### Click a button in the visual to see the next scenario[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
### Ask Claude to rebuild the same format for a different concept[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/bring-your-whiteboard-lesson-to-life)
