...
## 1. Describe the task[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
### Required context[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/analyze-campaign-performance)

Continue the conversation with Claude to refine, expand, or explore further.

### Update past work[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
### Add visual polish[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/analyze-campaign-performance)

### Perform competitive benchmarking[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
### Open the actual Excel file, not just the preview[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
### Work with messy data[](https://academy.claude.com/use-cases/analyze-campaign-performance)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/analyze-campaign-performance)
