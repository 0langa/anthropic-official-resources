...
Reads usage, tickets, and NPS each week and writes a status with two actions.

## Ask in plain English

Point Cowork at the account folder and ask for one health call with two actions.

Accounts / Northwind / health

## Cowork weighs the four signals

Account record, tickets, usage, and NPS — measured against the success plan you agreed.

Running `/account-health` for Northwind
...
Google Drive · read nps-responses-q1.csv (38 avg, champion scored 6)

Result

Comparing against success-plan.docx milestones

Result

Created northwind-health-apr27.md

northwind-health-apr27.md
...
Pull account record and tickets
...
Weigh against success plan

4

Call red / yellow / green

5

Write health summary to folder

#### Accounts / Northwind / health

XLSusage-export-apr.csv

DOCsuccess-plan.docx

XLSnps-responses-q1.csv

#### Context

Connectors

![](data:image/svg+xml,%3csvg%20viewBox='0%200%2024%2024'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill='%2300A1E0'%20d='M10.01%205.56a4.18%204.18%200%200%201%203.02-1.3c1.58%200%202.96.88%203.7%202.19a5.12%205.12%200%200%201%202.1-.45%205.18%205.18%200%200%201%200%2010.36c-.37%200-.73-.04-1.07-.11a3.77%203.77%200%200%201-4.94%201.55%204.3%204.3%200%200%201-7.99-.2%203.98%203.98%200%200%201-.82.09%203.97%203.97%200%200%201-1.96-7.43%204.57%204.57%200%200%201%207.96-4.7'/%3e%3c/svg%3e)Salesforce

![](data:image/svg+xml,%3csvg%20viewBox='0%200%2024%2024'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20fill='%2303363D'%3e%3cpath%20d='M11%207.7v13.1H.2L11%207.7Z'/%3e%3cpath%20d='M11%203.2a5.4%205.4%200%200%201-10.8%200H11Z'/%3e%3cpath%20d='M13%2016.3V3.2h10.8L13%2016.3Z'/%3e%3cpath%20d='M13%2020.8a5.4%205.4%200%200%201%2010.8%200H13Z'/%3e%3c/g%3e%3c/svg%3e)Zendesk

![](data:image/svg+xml,%3csvg%20viewBox='0%200%2016%2016'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='m1.846%2012.624.64%201.104c.133.233.324.415.548.548l2.284-3.953H.75c0%20.258.066.515.199.748l.897%201.553Z'%20fill='%230066DA'/%3e%3cpath%20d='M8%205.672%205.716%201.72a1.54%201.54%200%200%200-.548.548L.949%209.576a1.53%201.53%200%200%200-.199.747h4.568L8%205.672Z'%20fill='%2300AC47'/%3e%3cpath%20d='M12.966%2014.276c.225-.133.415-.315.548-.548l.266-.457%201.27-2.2a1.5%201.5%200%200%200%20.2-.748h-4.568l.972%201.91%201.312%202.043Z'%20fill='%23EA4335'/%3e%3cpath%20d='M8%205.672%2010.284%201.72a1.5%201.5%200%200%200-.748-.2H6.464a1.5%201.5%200%200%200-.748.2L8%205.672Z'%20fill='%2300832D'/%3e%3cpath%20d='M10.682%2010.323H5.318l-2.284%203.953c.224.133.482.2.747.2h8.438c.265%200%20.523-.075.747-.2l-2.284-3.953Z'%20fill='%232684FC'/%3e%3cpath%20d='m12.941%205.922-2.11-3.655a1.54%201.54%200%200%200-.547-.548L8%205.672l2.682%204.651h4.56a1.5%201.5%200%200%200-.2-.747L12.94%205.922Z'%20fill='%23FFBA00'/%3e%3c/svg%3e)Google Workspace

## One call, two moves

The health summary lands in the account folder — defensible status, actions sized for this week.

YELLOW Northwind · Account health · Apr 27

Usage has been flat three weeks running while seat count grew 18%, two SSO tickets have sat open eleven days, and NPS slipped to 38 after the champion scored a 6. Renewal is Jun 30 — this is drifting, not broken.

**1.** Book a 30-minute working session with their IT lead on the two SSO tickets before Thursday; both block the rollout milestone in the success plan.

**2.** Send Maria the Q2 roadmap one-pager — her NPS comment flagged “not seeing the items we asked for.”

Northwind health summary

Document · Markdown · Accounts / Northwind / health

## Run it across your book every week

Schedule the customized skill — every account scored Monday morning, reds rolled up first.
...
Runs `/account-health` for every account in your book and writes the summary to its health folder, with red accounts rolled up into one digest.

Every **Monday at 7:00 AM**

Every Monday, a health call and two actions are in each account folder before your day starts.
