...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-brand-assets)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-brand-assets)
...
### Required context[](https://academy.claude.com/use-cases/create-brand-assets)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-brand-assets)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-brand-assets)

Continue the conversation with Claude to refine, expand, or explore further.

### Create a brand document for future work[](https://academy.claude.com/use-cases/create-brand-assets)
...
### Extend your brand to digital[](https://academy.claude.com/use-cases/create-brand-assets)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-brand-assets)

### Prevent layout issues upfront[](https://academy.claude.com/use-cases/create-brand-assets)
...
### Use reference files to bypass lengthy prompts[](https://academy.claude.com/use-cases/create-brand-assets)
...
### Create a [Skill(opens in new tab)](https://www.anthropic.com/news/skills) for consistent quality[](https://academy.claude.com/use-cases/create-brand-assets)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-brand-assets)
