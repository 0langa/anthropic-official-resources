...
Reads strategy notes and brand guidelines, then drafts the brief and kickoff slides.

## Ask in plain English

Point Cowork at the campaign folder and describe the brief and deck you need.

/campaign-briefMarketing

Campaigns / Spring-Launch

## Cowork reads the source where it sits

Notes, brand guide, and template come together — Progress tracks the plan as it runs.

Working on `/campaign-brief`

Reading strategy-notes.docx

Result

Google Drive · pulled brand-guidelines-2026.pdf

Result

Notion · read Spring Launch planning page

Result

Comparing against brief-template.docx and brand voice

Result

Created spring-launch-brief.docx

spring-launch-brief.docx

Created spring-launch-kickoff.pptx
...
## Review-ready brief and kickoff deck

Structured to your template, written in your brand voice, saved back to the campaign folder.

DOCspring-launch-brief.docx

Spring Launch — Campaign Brief

ObjectiveDrive **4,200 trial sign-ups** for the Horizon plan in the first six weeks, lifting self-serve revenue 18% QoQ.

AudienceMid-market ops leads (50–500 seats) currently on a competitor or spreadsheets; secondary: existing Free-tier admins.

Key message**“The plan that runs itself.”** One workspace, zero hand-offs — set up in an afternoon.

Channel planPaid LinkedIn + retargeting (40%), lifecycle email × 3 touches (30%), partner webinars × 2 (20%), organic social (10%).

Success metricsTrial sign-ups, trial→paid at **22%**, CAC under **$148**, webinar attendance 600+.

Spring Launch campaign brief

Document · DOCX · 24 KB

Spring Launch kickoff deck

Presentation · PPTX · 8 slides

## Make it run on every new campaign

Customize the skill once, then schedule it — the brief drafts itself the moment notes land.
...
Checks Campaigns each weekday morning for new strategy-notes files, runs `/campaign-brief` on each, and writes the brief and deck to a campaign subfolder.

Weekdays at **9 am** — Campaigns folder

Every campaign, strategy notes become a formatted brief and kickoff deck before the first meeting.
