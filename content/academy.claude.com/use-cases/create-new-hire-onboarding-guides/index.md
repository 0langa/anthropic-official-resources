...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
### Required context[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)

Continue the conversation with Claude to refine, expand, or explore further.

### Batch create for multiple new hires[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
### Add additional features[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
### Convert to other formats[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)

### Iterate on design with specific feedback[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
### Personalize the design[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
### Create a reusable template[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-new-hire-onboarding-guides)
