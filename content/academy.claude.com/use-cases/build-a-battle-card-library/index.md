...
## 1. Describe the task[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
### Required context[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/build-a-battle-card-library)

Continue the conversation with Claude to refine, expand, or explore further.

### Generate training scenarios[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
### Analyze competitive trends over time[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/build-a-battle-card-library)

### Combine multiple data sources for better intelligence[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
### Always verify specific facts before sharing[](https://academy.claude.com/use-cases/build-a-battle-card-library)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/build-a-battle-card-library)
