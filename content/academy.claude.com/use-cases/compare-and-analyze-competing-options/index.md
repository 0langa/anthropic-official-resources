...
## 1. Describe the task[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)

Provide the vendor proposals you received so Claude can use them to compare terms and conduct analysis.

### Required context[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)

Continue the conversation with Claude to refine, expand, or explore further.

### Draft the decision memo from the analysis[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
### Create questions for vendor calls after reviewing the comparison[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
### Calculate costs for your business[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)

### Download the actual spreadsheet[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
### Use specific design language[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/compare-and-analyze-competing-options)
