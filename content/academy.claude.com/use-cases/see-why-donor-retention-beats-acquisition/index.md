...
## 1. Describe the task[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
### Required context[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)

Nothing to upload.

## 3. What Claude creates[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)

Continue the conversation with Claude to refine, expand, or explore further.

### Click a button in the visual to add a layer[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
### Ask Claude to find the threshold[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
### Ask Claude to count the churn[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/see-why-donor-retention-beats-acquisition)
