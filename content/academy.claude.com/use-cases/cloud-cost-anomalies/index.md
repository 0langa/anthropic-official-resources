...
Reads the billing export, writes the anomaly report with an owner for every spike.

Every month, the anomaly report is in your folder before anyone opens the console.
