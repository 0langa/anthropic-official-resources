...
Searches Figma, the codebase, and analytics for every existing instance, then tells you which pattern to reuse.

Every new pattern arrives at crit with the inventory of what already exists.
