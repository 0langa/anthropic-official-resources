...
# Recap ad performance

Reads your ad exports, builds a campaign summary, and posts the highlights to Slack.
...
## Cowork pulls the platforms together

Live numbers from each connector, joined to conversions, compared against last week.

Running `/ad-recap` on Spring-Launch

Google Ads · pulled spend & CTR for Spring-Launch

Result

Meta Ads · pulled reach + CPC across 12 ad sets

Result

Analytics · matched 1,840 conversions to campaign UTMs

Result

Comparing CPA and ROAS against wk16

Result

Created spring-launch-wrap-wk17.pptx

spring-launch-wrap-wk17.pptx

Slack · posted top-three digest to #paid-media
...
#### Spring-Launch / performance

CSVgoogle-ads-export.csv

CSVmeta-ads-export.csv

CSVga4-conversions.csv

PPTwrap-deck-wk16.pptx
...
## The digest lands in Slack

Top three movers with the numbers and the call — the wrap deck and live dashboard go in the thread.

#paid-mediaPosted just now

C

Claude8:02 AM

Spring-Launch — week 17 movers

**Carousel-v3 · Meta** — CPA down 31% to $14.20, now the most efficient set. Shift +$4K here.

**Brand search · Google** — ROAS up to 6.1× after the negative-keyword cleanup. Hold budget.

**Stories-broad · Meta** — CTR fell to 0.4%, $2.8K spend for 11 conversions. Pause and re-cut creative.

Full wrap deck and the live dashboard in thread.

Spring Launch wrap deck

Presentation · PPTX · 1.6 MB · written to performance/

## Make it run every Monday

Customize `/ad-recap` with your KPIs once, then schedule it — the recap lands before standup.
...
Runs `/ad-recap` against the connected ad platforms, refreshes the live artifact, writes the wrap deck to the performance folder, and posts the top-three digest to #paid-media.

Every **Monday at 8am**, weekly

Every Monday, the wrap deck lands and the   
 top three movers hit Slack — in your format.
