...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Required context[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-digital-recipe-cards)

Continue the conversation with Claude to refine, expand, or explore further.

### Request culinary deep-dives[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Quickly create shopping lists[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Create a complete recipe collection[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-digital-recipe-cards)

### Learn more about the recipe[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Elevate visual quality to your preference[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Process batches of recipes with consistent formatting[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
### Vary the format to suit your purpose[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-digital-recipe-cards)
