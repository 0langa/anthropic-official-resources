...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
### Required context[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-a-company-newsletter)

Continue the conversation with Claude to refine, expand, or explore further.

### Expand coverage and depth[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
### Add visualizations[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-a-company-newsletter)

### Use prompting techniques to trigger specific designs[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
### Publish and share the artifact[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
### Tune preferences over time and create skills[](https://academy.claude.com/use-cases/create-a-company-newsletter)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-a-company-newsletter)
