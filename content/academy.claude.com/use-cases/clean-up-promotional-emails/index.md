...
## 1. Describe the task[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
### Required context[](https://academy.claude.com/use-cases/clean-up-promotional-emails)

Before starting your Claude in Chrome session, make sure you're logged into your Gmail account.

## 3. What Claude creates[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/clean-up-promotional-emails)

Continue the conversation with Claude to refine, expand, or explore further.

### Adjust and proceed[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
### Unsubscribe from unwanted messages[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
### Flag subscription emails you may have missed[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/clean-up-promotional-emails)

### Permissions before taking actions[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
### Save and schedule tasks with shortcut[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
### Claude keeps working in the background[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/clean-up-promotional-emails)
