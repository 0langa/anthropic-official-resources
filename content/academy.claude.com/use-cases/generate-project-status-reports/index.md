...
## 1. Describe the task[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
### Required context[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/generate-project-status-reports)

Continue the conversation with Claude to refine, expand, or explore further.

### Deep dive blockers[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
### Create weekly status report[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/generate-project-status-reports)

### Create a Skill for recurring reports[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
### Specify how to handle missing information[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
### Add visual polish[](https://academy.claude.com/use-cases/generate-project-status-reports)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/generate-project-status-reports)
