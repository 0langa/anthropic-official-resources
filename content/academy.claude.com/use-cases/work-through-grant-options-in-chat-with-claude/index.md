...
## 1. Describe the task[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
### Required context[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)

Nothing strictly required. For a chart grounded in your actual pipeline, attach the sheet.

## 3. What Claude creates[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)

Continue the conversation with Claude to refine, expand, or explore further.

### Click a point on the chart to see the full profile[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
### Ask Claude to write a schedule from the chart[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
### Tell Claude what's changed and it redraws the chart[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
### Check the visual against your own understanding[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/work-through-grant-options-in-chat-with-claude)
