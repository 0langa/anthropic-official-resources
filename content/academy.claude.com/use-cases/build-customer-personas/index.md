...
## 1. Describe the task[](https://academy.claude.com/use-cases/build-customer-personas)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/build-customer-personas)
...
### Required context[](https://academy.claude.com/use-cases/build-customer-personas)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/build-customer-personas)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/build-customer-personas)

Continue the conversation with Claude to refine, expand, or explore further.

### Create a written report for distribution[](https://academy.claude.com/use-cases/build-customer-personas)
...
### Identify the biggest revenue opportunity[](https://academy.claude.com/use-cases/build-customer-personas)
...
### Find quick wins from support tickets[](https://academy.claude.com/use-cases/build-customer-personas)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/build-customer-personas)

### Check the actual files before requesting changes[](https://academy.claude.com/use-cases/build-customer-personas)
...
### [Connect(opens in new tab)](https://www.claude.com/partners/mcp) your tools to avoid stale data[](https://academy.claude.com/use-cases/build-customer-personas)
...
### Use [Projects(opens in new tab)](https://support.claude.com/en/articles/9517075-what-are-projects) for ongoing work[](https://academy.claude.com/use-cases/build-customer-personas)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/build-customer-personas)
