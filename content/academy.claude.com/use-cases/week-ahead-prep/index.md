...
Reads your calendar, Slack, and email, then writes a briefing for every meeting.
...
## Cowork gathers the context

Calendar, Slack, Gmail, and Drive fill in the back-story for every meeting on the list.

Running `/week-ahead`

31

Google Calendar · read 11 meetings, Mon Apr 27 – Fri May 1
...
Slack · searched threads with 8 attendees across 5 channels

Result

Gmail · pulled open-loop emails with Priya, Marcus, Dana
...
Google Drive · opened 6 docs attached to invites

Result

Comparing against open-items-carryover.md to rank prep

Result

Created week-ahead.md
...
Read next week’s calendar

2

Pull Slack, email, docs per meeting

3

Draft an agenda for each

4

Flag the three to prep
...
DOCstaff-meeting-agenda.docx

MDopen-items-carryover.md
...
Every meeting has an agenda. The three that need real prep are called out at the top.

Week of Mon Apr 2711 meetings · 3 flagged

Prep first**Northwind renewal** — Thu 2:00 · Priya Desai. Contract is 38% over last year’s seat count; her redlines from Friday are still unopened in your inbox.**Staff meeting** — Mon 9:30 · your directs. Q2 headcount asks are due; Marcus and Elena both raised blockers in #team-leads on Thursday.**Onboarding v3 design review** — Wed 11:00 · Dana Kim. You owe her the copy feedback you promised on Apr 14.

Mon 3:00 — Roadmap sync · Platform (Tomás, Ana)  
Last met Apr 14; you agreed to bring the API rate-limit decision. The #platform-roadmap thread has their updated proposal (12 replies, last Wed) and they attached **Q2-platform-plan** to the invite. Agenda: confirm the rate-limit tier, ask whether May 15 still holds, hand the SSO question back to Ana.

+ agendas for 8 more meetings below

Week-ahead brief with agendas

Document · Markdown · 9 KB · Planning / Week-of-2026-04-27
...
Runs `/week-ahead` against Calendar, Slack, Gmail, and Drive and writes the briefing and agendas to a new Week-of folder.

Every **Sunday** at **5:00pm**

Every Sunday, the week-ahead brief  
is in the folder before Monday starts.
