...
## 1. Describe the task[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
### Required context[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/compare-products-across-sites)

Continue the conversation with Claude to refine, expand, or explore further.

### Add another option[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
### Check reviews for the top pick[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
### Find the best price[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/compare-products-across-sites)

### Drag tabs into Claude's tab group[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
### Save your comparison template as a shortcut[](https://academy.claude.com/use-cases/compare-products-across-sites)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/compare-products-across-sites)
