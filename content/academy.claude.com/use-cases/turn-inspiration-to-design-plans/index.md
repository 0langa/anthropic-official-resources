...
## 1. Describe the task[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Required context[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Optional context[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)

Continue the conversation with Claude to refine, expand, or explore further.

### Conduct further research[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Adjust the format[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Implement your ideas[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)

### Open the actual Excel file, not just the preview[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Specify design quality expectations[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
### Track progress in a [Project(opens in new tab)](https://support.claude.com/en/articles/9517075-what-are-projects)[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/turn-inspiration-to-design-plans)
