...
## 1. Describe the task[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
### Required context[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)

Continue the conversation with Claude to refine, expand, or explore further.

### Create the control matrix as a spreadsheet[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
### Pull evidence from your ticketing system[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
### Generate policy summaries for the walkthrough[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)

### For sensitive policies, contracts, and evidence files, run your session locally[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
### Point Cowork at the mess, not just the polished files[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
### Use your existing framework as a guide[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/prep-scattered-documents-for-a-compliance-audit)
