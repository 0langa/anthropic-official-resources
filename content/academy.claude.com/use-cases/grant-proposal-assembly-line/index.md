...
## 1. Describe the task[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Required context[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Optional context[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)

Continue the conversation with Claude to refine, expand, or explore further.

### Expand library with new modules[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Generate batch proposals[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Optimize based on success patterns[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)

### Version control prevents content drift.[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Batch similar funders for efficiency.[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Track module performance metrics.[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Set up funder intelligence alerts.[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
### Maintain freshness with quarterly updates.[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/grant-proposal-assembly-line)
