...
## 1. Describe the task[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Required context[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Optional context[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)

Continue the conversation with Claude to refine, expand, or explore further.

### Send replies and set reminders[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Adapt to new information[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Try it out in other platforms[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)

### Connect to your [iOS(opens in new tab)](https://support.claude.com/en/articles/11869619-using-claude-with-ios-apps) or [Android(opens in new tab)](https://support.claude.com/en/articles/11869629-using-claude-with-android-apps) apps[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Formatting for Notes[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
### Privacy control stays with you[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/turn-text-threads-to-researched-notes)
