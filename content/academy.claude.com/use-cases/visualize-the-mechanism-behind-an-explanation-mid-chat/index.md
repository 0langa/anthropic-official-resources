...
## 1. Describe the task[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
### Required context[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)

Nothing to upload.

## 3. What Claude creates[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)

Continue the conversation with Claude to refine, expand, or explore further.

### Click a button in the visual to go deeper[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
### Ask Claude to redraw it with one thing changed[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
### Ask Claude to turn the explainer into a quiz[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
### Tell Claude what you already understand[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/visualize-the-mechanism-behind-an-explanation-mid-chat)
