...
Reads the incident channel and alerts, writes the blameless postmortem with timeline and owned action items.

After every incident, the postmortem draft is in the folder before the review.
