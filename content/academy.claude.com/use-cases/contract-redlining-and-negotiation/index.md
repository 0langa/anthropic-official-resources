...
## 1. Describe the task[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)

Share your business context and the contract to review, so Claude can identify what matters most for your situation.

### Required context[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)

Continue the conversation with Claude to refine, expand, or explore further.

### Turn redlines into negotiation strategy[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
### Adapt the format for easier comparison[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)

### Request actual redlined documents with tracked changes[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
### Improve recommendations with more context[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
### Use Projects for consistency[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/contract-redlining-and-negotiation)
