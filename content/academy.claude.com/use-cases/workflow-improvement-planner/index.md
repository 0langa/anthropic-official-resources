...
## 1. Describe the task[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/workflow-improvement-planner)

### Required context[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/workflow-improvement-planner)

Continue the conversation with Claude to refine, expand, or explore further.

### Get solution recommendations[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Create implementation materials[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Refine for your constraints[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/workflow-improvement-planner)

### Be specific about frequency and volume[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Include examples or samples if possible[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Don't self-censor workflow problems[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Think beyond time savings[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
### Connect your data sources for deeper solutions[](https://academy.claude.com/use-cases/workflow-improvement-planner)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/workflow-improvement-planner)
