...
## 1. Describe the task[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)

### Required context[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)

Continue the conversation with Claude to refine, expand, or explore further.

### See the skill in action[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
### Combine with MCP connections[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
### Expand the technique catalog[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)

### Evolve the skill through use and refinement[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
### Skills use progressive disclosure to stay efficient[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
### Quality standard questions push beyond defaults into intentional choices[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/elevate-claudes-design-using-skills)
