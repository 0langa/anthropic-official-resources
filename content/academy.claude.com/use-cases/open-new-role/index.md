...
Asks the hiring manager questions and writes a finished role spec to your folder.

## Ask to be interviewed

Point Cowork at the role folder and tell it to run the recruiter intake with you.

/open-roleHuman Resources

Hiring / Senior-PM-Growth

## Cowork runs the intake against your standards

It reads your template and leveling guide, asks the recruiter’s questions, and opens the req in your ATS.

Running `/open-role` intake

Reading role-spec-template.docx
...
Comparing intake answers against L5 product criteria

Result

![](data:image/svg+xml,%3csvg%20viewBox='0%200%2016%2016'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='m1.846%2012.624.64%201.104c.133.233.324.415.548.548l2.284-3.953H.75c0%20.258.066.515.199.748l.897%201.553Z'%20fill='%230066DA'/%3e%3cpath%20d='M8%205.672%205.716%201.72a1.54%201.54%200%200%200-.548.548L.949%209.576a1.53%201.53%200%200%200-.199.747h4.568L8%205.672Z'%20fill='%2300AC47'/%3e%3cpath%20d='M12.966%2014.276c.225-.133.415-.315.548-.548l.266-.457%201.27-2.2a1.5%201.5%200%200%200%20.2-.748h-4.568l.972%201.91%201.312%202.043Z'%20fill='%23EA4335'/%3e%3cpath%20d='M8%205.672%2010.284%201.72a1.5%201.5%200%200%200-.748-.2H6.464a1.5%201.5%200%200%200-.748.2L8%205.672Z'%20fill='%2300832D'/%3e%3cpath%20d='M10.682%2010.323H5.318l-2.284%203.953c.224.133.482.2.747.2h8.438c.265%200%20.523-.075.747-.2l-2.284-3.953Z'%20fill='%232684FC'/%3e%3cpath%20d='m12.941%205.922-2.11-3.655a1.54%201.54%200%200%200-.547-.548L8%205.672l2.682%204.651h4.56a1.5%201.5%200%200%200-.2-.747L12.94%205.922Z'%20fill='%23FFBA00'/%3e%3c/svg%3e)

Google Drive · created draft JD in Hiring/Senior-PM-Growth

Result

Created senior-pm-growth-spec.docx

senior-pm-growth-spec.docx
...
Pull leveling guide from Drive

3

Map answers to level criteria

4

Save draft JD to Drive

5

Write role spec to folder
...
## A complete role spec, in your format

Scope, must-haves, level, success criteria — plus the open items for the recruiter sync.

**Senior Product Manager, Growth** · L5 · reports to VP Product · San Francisco or remote (US)

**Owns** the activation funnel, the referral program, and the self-serve → sales-assist handoff. Partners with Data and Lifecycle Marketing.

**Must-haves** — 5+ years B2B PLG product work; has shipped an experimentation program end-to-end; fluent in SQL and a product-analytics tool. **Nice-to-haves** — pricing/packaging exposure, managed one IC.

**Good at 90 days** — activation rate up 2 points, experimentation cadence at 4 tests/week, presents the H2 growth roadmap to the leadership review.

**Open for the recruiter** — comp band pending Finance sign-off; whether the role can be fully remote outside the US.

Senior PM, Growth — role spec

Document · DOCX · 24 KB · saved to Hiring / Senior-PM-Growth

## Runs whenever a headcount is approved

Customize the intake once, then schedule it — the spec is waiting before the kickoff would have been.
...
Runs `/open-role` in every new subfolder under Hiring and writes the intake transcript and finished spec to that role’s folder.

**Weekdays at 9am**

Every approved position, the job description is in the folder before the recruiter call.
