...
## 1. Describe the task[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Required context[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)

None. This prompt works with just a role description.

### Optional context[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)

Continue the conversation with Claude to refine, expand, or explore further.

### Try it with a real deliverable you're stuck on[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Ask Claude to interview you about a problem[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Learn about features beyond chat[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)

### Share your documents, not just your title[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Be specific about what takes up your time[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Keep learning with [Claude 101(opens in new tab)](https://academy.claude.com/courses/claude-101)[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
### Use Claude as a thinking partner[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/explore-what-claude-can-do-for-you)
