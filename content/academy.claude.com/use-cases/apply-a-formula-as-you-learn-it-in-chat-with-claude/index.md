...
## 1. Describe the task[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
### Required context[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)

Nothing to upload.

## 3. What Claude creates[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)

Continue the conversation with Claude to refine, expand, or explore further.

### Ask Claude to show the math behind what you noticed[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
### Ask Claude to overlay a second thing on the same canvas[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
### Ask Claude to turn the canvas into a prediction test[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)

### How you word your prompt shapes what you get[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
### Tell Claude what to adjust and it redraws[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
### What to do with the visual next[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/apply-a-formula-as-you-learn-it-in-chat-with-claude)
