...
15 minEducationClaude Cowork
...
## 1. Describe the task[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)

Continue the conversation with Claude to refine, expand, or explore further.

### Add additional versions for more learners[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
### Rebuild the deck with a different emphasis[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
### Set it up to repeat in Cowork[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/adapt-a-standard-textbook-page-to-every-reading-level)
