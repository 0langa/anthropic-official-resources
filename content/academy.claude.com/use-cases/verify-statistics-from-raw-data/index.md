...
## 1. Describe the task[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
### Required context[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)

Continue the conversation with Claude to refine, expand, or explore further.

### Go beyond numbers and check the figures[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
### Learn what to watch for next time[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
### Draft reviewer comments[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)

### Start where you already have domain expertise[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
### Open the actual Excel file[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/verify-statistics-from-raw-data)
