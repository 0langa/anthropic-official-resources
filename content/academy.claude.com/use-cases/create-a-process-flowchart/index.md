...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
### Required context[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-a-process-flowchart)

Continue the conversation with Claude to refine, expand, or explore further.

### Export to other formats and platforms[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
### Add detail to specific sections[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
### Adjust the visual style[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-a-process-flowchart)

### Extract structure from messy documentation[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
### Make edits as the process evolves[](https://academy.claude.com/use-cases/create-a-process-flowchart)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-a-process-flowchart)
