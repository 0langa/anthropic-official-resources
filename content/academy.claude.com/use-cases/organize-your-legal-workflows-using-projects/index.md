...
## 1. Describe the task[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Required context[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Optional context[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)

Continue the conversation with Claude to refine, expand, or explore further.

### Test the setup with a real NDA in a Project[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Expand to other contract types[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Create a training resource for new associates[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)

### Start with your best-documented process[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Teams can share Projects and their configurations[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Test with real documents before going live[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### Claude can work in your file formats[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
### This pattern extends beyond legal work[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/organize-your-legal-workflows-using-projects)
