...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)

Make sure Claude has the right tools to accurately research and build your itinerary, by enabling web search.

### Required context[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)

### Optional context[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)

Continue the conversation with Claude to refine, expand, or explore further.

### Elevate the design[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
### Research local context[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
### Build it into your actual schedule[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)

### Ask Claude to cite sources[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
### Add features and elevate design quality[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
### Send to travel companions[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-a-daily-travel-itinerary)
