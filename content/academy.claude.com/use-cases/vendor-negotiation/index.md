...
Reads both contract versions and your spend, writes the redline and the one-page brief.

## Ask in plain English

Point Cowork at the renewal folder and describe the brief you need for the call.

/vendor-reviewOperations

Procurement / Northwind-renewal-2026

## Cowork reads both contracts

The skill diffs current vs proposed and pulls your real spend so the leverage is grounded.

Working on vendor review

Reading Northwind-MSA-2024-signed.pdf

Result

Reading Northwind-renewal-proposal-2026.pdf

Result

Reading usage-and-comparables.xlsx

Result

Reading Brex — Northwind spend YTD
...
Writing northwind-negotiation-brief.docx
...
Read both contract versions

2

Pull spend and comparables
...
## One page for the call

Ranked asks backed by your own usage and comparables, with the walk-away line agreed up front.

**Ask 1 — Hold the unit price.** Proposal raises per-seat from $84 to $96 (+14%). Usage is up 22% year over year and we’re already above the volume tier; comparable quotes land at $82–88.

**Ask 2 — Strike the auto-renew.** Current agreement is opt-in at term end; proposal flips to 90-day opt-out. We’ve held opt-in on every Tier-1 vendor and Legal won’t move on it.

**Walk-away** — Any per-seat above $90 with auto-renewal intact. The Contoso quote at $86 is executable inside the notice window.

Northwind negotiation brief

Document · DOCX · 22 KB

## Run it before every renewal

Schedule it once — the brief lands 60 days ahead for every vendor in the contracts sheet.
...
Runs `/vendor-review` for any vendor renewing in the next 60 days and writes the redline and brief to that vendor’s folder.
