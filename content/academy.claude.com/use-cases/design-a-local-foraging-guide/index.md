...
## 1. Describe the task[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
### Required context[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)

## 3. What Claude creates[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)

Continue the conversation with Claude to refine, expand, or explore further.

### Swap in verified information[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
### Identify something in the field[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)

### Learn from what Claude builds—or reuse it directly[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
### Keep refining in the same conversation[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
### Interactive maps work best with a data source[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/design-a-local-foraging-guide)
