...
## 1. Describe the task[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
### Required context[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/prepare-for-sales-deals)

Continue the conversation with Claude to refine, expand, or explore further.

### Pull specific deal details[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
### Create talking points[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
### Conduct further research[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/prepare-for-sales-deals)

### Connect other tools for more context[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
### Create a skill to package this workflow[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
### Sets the quality bar with design language[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/prepare-for-sales-deals)
