...
## 1. Describe the task[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/plan-your-literature-review)

Connect Claude to relevant research tools and enable the specific features that make this workflow powerful.

### Required context[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/plan-your-literature-review)

Continue the conversation with Claude to refine, expand, or explore further.

### Validate a claim you develop[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
### Understand contradicting sources[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
### Search for missing coverage[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/plan-your-literature-review)

### Always verify critical citations[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
### Open the actual file, not just the preview[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
### Expand your research infrastructure[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
### Use design language for better outputs[](https://academy.claude.com/use-cases/plan-your-literature-review)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/plan-your-literature-review)
