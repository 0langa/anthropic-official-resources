...
## 2. Give Claude context[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
### Required context[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
### Optional context[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
### Pull the evidence behind the buried finding[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
### Stress-test the model's assumptions[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)

### Front-load your context[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
...
### Verify the finding before it moves your thesis[](https://academy.claude.com/use-cases/evaluate-a-company-from-the-science-to-the-balance-sheet)
