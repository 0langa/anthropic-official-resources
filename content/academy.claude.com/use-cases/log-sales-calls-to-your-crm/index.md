...
## 1. Describe the task[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
### Required context[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)

Continue the conversation with Claude to refine, expand, or explore further.

### Update opportunity stages[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
### Catch up on the week[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
### Create missing contacts[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)

### Drag Calendar and Salesforce into the same tab group[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
### Permissions before taking actions[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
### Save your workflow as a shortcut[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/log-sales-calls-to-your-crm)
