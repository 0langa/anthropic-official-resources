...
Reads account records and call history, builds a brief with your asks and objections.
...
## Cowork reads the deal

The opp, the last three calls, and the plan — pulled live while the Progress card tracks each step.

Working on call prep

Salesforce · pulled Northwind opp ($240K ARR, Stage 4)

Result

Gong · read 3 transcripts (Apr 10, Mar 27, Mar 14)

Result

Google Drive · read mutual-action-plan.xlsx
...
Created northwind-prep-apr28.docx

northwind-prep-apr28.docx
...
Pull the Salesforce record

2

Read the last three transcripts

3

Check the mutual action plan

4

Draft asks and objections

5

Write prep sheet to folder

#### Accounts / Northwind / calls

mutual-action-plan.xlsx

call-notes-apr10.docx
...
Where the deal is, what they care about, your asks, and the objection you’ll hear — written from the live record.

**Where the deal is.** $240K ARR, Stage 4 — Proposal. Security review cleared Apr 22; Legal has the MSA. Close target on the plan is May 15.

**What they care about right now.** Priya brought up SSO rollout timing on all three calls. Derek Osei (new VP Ops, joined Mar 27 call) hasn’t seen the ROI model yet.

**Your asks.** (1) Intro to Derek for a 20-minute ROI walkthrough this week. (2) Confirm May 15 still holds on their side. (3) Redlined MSA back by Friday.

**Likely objection.** “We’re mid-Okta migration — can this wait till June?” → SSO connector runs against both their current IdP and Okta; offer a two-team pilot in parallel so the migration doesn’t gate the start.

Northwind call prep — Priya

Document · DOCX · 14 KB · Accounts / Northwind / calls

## Run it before every external call

Schedule it once — the sheet is in the account folder before the meeting reminder fires.
...
Weekdays at 7:30 AM — runs `/call-prep` for each external meeting on today’s calendar and writes the sheet to the account’s calls folder.

Weekdays at **7:30 AM**

Every external call, the prep sheet is in the account folder before the meeting reminder fires.
