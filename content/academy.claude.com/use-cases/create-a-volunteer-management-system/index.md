...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
### Required context[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)

Continue the conversation with Claude to refine, expand, or explore further.

### Customize for Additional Roles[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
### Build Program Evaluation[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
### Generate Volunteer Recruitment Materials[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)

### Maintaining consistency across documents[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
### Training staff to use the system[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
### Scaling for program growth[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-a-volunteer-management-system)
