...
## 1. Describe the task[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
## 2. Give Claude context[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
### Required context[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
## 3. What Claude creates[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
## 4. Follow up prompts[](https://academy.claude.com/use-cases/create-a-custom-webpage)

Continue the conversation with Claude to refine, expand, or explore further.

### Deploy your site live[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
### Build interactive effects[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
### Expand one project into a detailed case study[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
## 5. Tricks, tips, and troubleshooting[](https://academy.claude.com/use-cases/create-a-custom-webpage)

### Improve the design of your outputs[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
### Use Skills for consistent design standards[](https://academy.claude.com/use-cases/create-a-custom-webpage)
...
## 6. Ready to try for yourself?[](https://academy.claude.com/use-cases/create-a-custom-webpage)
