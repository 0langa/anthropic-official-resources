...
11 lessons2.5 hr1 quizCompletion badge

[Start course](https://academy.claude.com/courses/introduction-to-claude-tag/tag-claude-and-see-what-happens)[Sign in to save progress](https://academy.claude.com/login?returnTo=%2Fcourses%2Fintroduction-to-claude-tag)

11 lessons · 1 quizIntroduction to Claude Tag

What you’ll learnBy the end of this course, you’ll be able to

- Tag Claude in a channel and get an answer that draws on your organization's existing context
- Ask Claude anywhere with confidence, knowing when a DM, a private channel, or a public channel fits
- Hand Claude one whole piece of work and check the result
- Correct Claude in a way that sticks for everyone in the channel
- Have one piece of work run without you, on a schedule or as a reply Claude offers without being tagged
- Give Claude a clear job in at least one channel, and review how it is going with your team

## Who it's for[](https://academy.claude.com/courses/introduction-to-claude-tag)
...
## Before you start[](https://academy.claude.com/courses/introduction-to-claude-tag)

- **Claude Tag is installed in your team's workspace**, so it can join channels there.
- **You have access to Claude Tag in one or more channels.** Some organizations [limit it to certain roles(opens in new tab)](https://claude.com/docs/claude-tag/admins/restrict-access), so if tagging it returns an access message, ask your admin.
- **Helpful, not required:** you have used Claude in a chat.

## How to approach this course[](https://academy.claude.com/courses/introduction-to-claude-tag)
