...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-101%2Fgetting-better-results)

## Common challenges and how to fix them[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium">Challenge</th><th class="border-b border-strong p-sm text-left font-medium">What's happening</th><th class="border-b border-strong p-sm text-left font-medium">Try this</th></tr></thead><tbody><tr><td class="border-b p-sm"><strong>Claude's response is too generic</strong></td><td class="border-b p-sm">Your prompt didn't include enough context about your specific situation</td><td class="border-b p-sm">Add details about your audience, role, or constraints. Instead of "Write an email about the project delay," try "Write an email to our enterprise client explaining that the software integration will be delayed by two weeks. They've been patient so far but this is the second delay. Keep it professional but apologetic."</td></tr><tr><td class="border-b p-sm"><strong>The response is too long (or too short)</strong></td><td class="border-b p-sm">Claude is guessing at appropriate length</td><td class="border-b p-sm">Be explicit: "Give me a two-paragraph summary" or "Keep this under 100 words" or "I need a comprehensive analysis—length isn't a concern."</td></tr><tr><td class="border-b p-sm"><strong>Claude didn't follow my format</strong></td><td class="border-b p-sm">Claude understood <em>what</em> you want but not <em>how</em> you want it presented</td><td class="border-b p-sm">Show, don't just tell. Provide an example of the format, or describe the structure explicitly: "Use bullet points with bold headers for each section."</td></tr><tr><td class="border-b p-sm"><strong>I got confident-sounding information that turned out to be wrong</strong></td><td class="border-b p-sm">Claude occasionally generates plausible but incorrect information, especially with specific facts or niche topics</td><td class="border-b p-sm">For high-stakes work, verify key facts independently. Ask Claude to cite sources or indicate confidence level. Enable web search to ground responses in current information.</td></tr><tr><td class="border-b p-sm"><strong>The tone isn't right</strong></td><td class="border-b p-sm">Claude defaults to helpful and professional, which may not match your needs</td><td class="border-b p-sm">Describe the tone in plain language: "Make this more conversational" or "This should sound authoritative and formal." Provide an example of writing in the style you want.</td></tr></tbody></table>

## The iteration mindset[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
## What is AI Fluency?[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
## Evaluating Claude for your workflows[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
### Why evals matter[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
### A simple eval approach[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
### Example: Using Claude for data analysis[](https://academy.claude.com/courses/claude-101/getting-better-results)

Embedded media: https://www.youtube-nocookie.com/embed/Zzn-g8lvLMA?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=Zzn-g8lvLMA)
...
## Lesson reflection[](https://academy.claude.com/courses/claude-101/getting-better-results)
...
## What's next[](https://academy.claude.com/courses/claude-101/getting-better-results)
