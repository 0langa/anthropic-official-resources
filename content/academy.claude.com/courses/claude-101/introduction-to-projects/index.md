...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-101%2Fintroduction-to-projects)

## Video[](https://academy.claude.com/courses/claude-101/introduction-to-projects)

Embedded media: https://www.youtube-nocookie.com/embed/GJ5jTgcbRHA?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
## What are Projects?[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
### When to use Projects[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
## Creating your first project[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
### Step 2: Add project instructions[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
### Step 3: Build your knowledge base[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
### How projects handle large knowledge bases[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
## Working within your project[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
## Collaboration features[](https://academy.claude.com/courses/claude-101/introduction-to-projects)

For users on Claude for Work (Team and Enterprise) plans, projects become even more powerful through collaboration features.

### Permission levels[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
### Sharing your project[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
## Example projects to inspire you[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
...
## Best practices for projects[](https://academy.claude.com/courses/claude-101/introduction-to-projects)
