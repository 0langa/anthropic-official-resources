...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-101%2Fworking-with-skills)

## What are Skills?[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## Types of Skills[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## Enabling Skills[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## Using Skills in practice[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
Embedded media: https://www.youtube-nocookie.com/embed/LpGpwhORWr0?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
### Security considerations[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## Creating custom skills[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## Skills vs. Projects[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium"></th><th class="border-b border-strong p-sm text-left font-medium">Projects</th><th class="border-b border-strong p-sm text-left font-medium">Skills</th></tr></thead><tbody><tr><td class="border-b p-sm"><strong>Purpose</strong></td><td class="border-b p-sm">Store knowledge Claude references</td><td class="border-b p-sm">Define processes Claude executes</td></tr><tr><td class="border-b p-sm"><strong>Best for</strong></td><td class="border-b p-sm">Long-term context, reference materials, team collaboration</td><td class="border-b p-sm">Repeatable workflows, multi-step tasks, consistent methodology</td></tr><tr><td class="border-b p-sm"><strong>Example</strong></td><td class="border-b p-sm">Customer hub, research buddy, feedback generator</td><td class="border-b p-sm">Process guidelines (like brand or legal), Blog drafting, PDF creation</td></tr><tr><td class="border-b p-sm"><strong>Persistence</strong></td><td class="border-b p-sm">Knowledge available across all chats in the project</td><td class="border-b p-sm">Instructions applied when the skill is invoked</td></tr></tbody></table>

## Lesson reflection[](https://academy.claude.com/courses/claude-101/working-with-skills)
...
## What's next[](https://academy.claude.com/courses/claude-101/working-with-skills)
