...
Exercise: the learner picks a spot on a five-point continuum showing how closely to check AI's output for a summarization task, then locks in a guess to reveal where most learners place it. It builds calibrated intuition for when next token prediction needs verification.
