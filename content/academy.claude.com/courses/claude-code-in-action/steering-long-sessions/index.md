...
## Steer while Claude works[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)

Once Claude is running, you have a few ways to keep it pointed in the right direction. The first is compaction.

### Compact[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
### Rewind[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
## Let Claude run more autonomously[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
### Goal[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
### Loop[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
## Run parallel work with worktrees[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
...
## Putting it together[](https://academy.claude.com/courses/claude-code-in-action/steering-long-sessions)
