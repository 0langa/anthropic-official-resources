...
Not now[Sign in](https://academy.claude.com/login?returnTo=%2Fcourses%2Fclaude-code-in-action%2Ftrust-it-verifying-unsupervised-runs)
...
## Start with the diff, not the summary[](https://academy.claude.com/courses/claude-code-in-action/trust-it-verifying-unsupervised-runs)
...
## Turn tests into a gate, not a promise[](https://academy.claude.com/courses/claude-code-in-action/trust-it-verifying-unsupervised-runs)
...
## Get a cold second opinion[](https://academy.claude.com/courses/claude-code-in-action/trust-it-verifying-unsupervised-runs)
...
## Putting it together[](https://academy.claude.com/courses/claude-code-in-action/trust-it-verifying-unsupervised-runs)
