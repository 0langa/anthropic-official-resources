...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fintroduction-to-model-context-protocol%2Fdefining-resources)

Resources in MCP servers allow you to expose data to clients, similar to GET request handlers in a typical HTTP server. They're perfect for scenarios where you need to fetch information rather than perform actions.

## Understanding Resources Through an Example[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
...
## How Resources Work[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
...
## Types of Resources[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)

There are two types of resources:

### Direct Resources[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
...
### Templated Resources[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
...
## Implementation Details[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
...
## Testing Your Resources[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-resources)
