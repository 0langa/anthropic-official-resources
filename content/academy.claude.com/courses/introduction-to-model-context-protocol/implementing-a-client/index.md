...
## Understanding the Client Architecture[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
...
## How the Client Fits Into Our Application[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
...
## Implementing Core Client Functions[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)

We need to implement two essential functions: `list_tools()` and `call_tool()`.

### List Tools Function[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
...
### Call Tool Function[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
...
## Testing the Client[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
...
## Putting It All Together[](https://academy.claude.com/courses/introduction-to-model-context-protocol/implementing-a-client)
