...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fintroduction-to-model-context-protocol%2Fintroducing-mcp)
...
## The Problem MCP Solves[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
...
## How MCP Works[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
...
## MCP Servers Explained[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
...
## Common Questions[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)

### Who authors MCP Servers?[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
...
### How is this different from calling APIs directly?[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
...
### Isn't MCP just the same as tool use?[](https://academy.claude.com/courses/introduction-to-model-context-protocol/introducing-mcp)
