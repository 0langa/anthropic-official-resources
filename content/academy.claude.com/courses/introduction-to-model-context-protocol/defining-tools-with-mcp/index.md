...
## Setting Up the MCP Server[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-tools-with-mcp)
...
## Tool Definition with Decorators[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-tools-with-mcp)
...
## Creating a Document Reader Tool[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-tools-with-mcp)
...
## Building a Document Editor Tool[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-tools-with-mcp)
...
## Key Benefits of the SDK Approach[](https://academy.claude.com/courses/introduction-to-model-context-protocol/defining-tools-with-mcp)
