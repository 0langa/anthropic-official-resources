...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fintroduction-to-model-context-protocol%2Faccessing-resources)
...
## Implementing Resource Reading[](https://academy.claude.com/courses/introduction-to-model-context-protocol/accessing-resources)
...
## Understanding the Response Structure[](https://academy.claude.com/courses/introduction-to-model-context-protocol/accessing-resources)
...
## Content Type Handling[](https://academy.claude.com/courses/introduction-to-model-context-protocol/accessing-resources)
...
## Testing Resource Access[](https://academy.claude.com/courses/introduction-to-model-context-protocol/accessing-resources)
