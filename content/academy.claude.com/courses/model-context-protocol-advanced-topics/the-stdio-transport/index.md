...
## Seeing Stdio in Action[](https://academy.claude.com/courses/model-context-protocol-advanced-topics/the-stdio-transport)
...
## MCP Connection Sequence[](https://academy.claude.com/courses/model-context-protocol-advanced-topics/the-stdio-transport)
...
## Message Types and Flow[](https://academy.claude.com/courses/model-context-protocol-advanced-topics/the-stdio-transport)
...
## Four Communication Scenarios[](https://academy.claude.com/courses/model-context-protocol-advanced-topics/the-stdio-transport)
...
## Why This Matters[](https://academy.claude.com/courses/model-context-protocol-advanced-topics/the-stdio-transport)
