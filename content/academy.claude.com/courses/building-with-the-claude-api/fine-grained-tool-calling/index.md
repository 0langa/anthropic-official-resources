...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Ffine-grained-tool-calling)
...
## Basic Tool Streaming[](https://academy.claude.com/courses/building-with-the-claude-api/fine-grained-tool-calling)
...
## How JSON Validation Works[](https://academy.claude.com/courses/building-with-the-claude-api/fine-grained-tool-calling)
...
## Handling Invalid JSON[](https://academy.claude.com/courses/building-with-the-claude-api/fine-grained-tool-calling)
...
## When to Use Fine-Grained Tool Calling[](https://academy.claude.com/courses/building-with-the-claude-api/fine-grained-tool-calling)
