...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fproviding-examples)
...
## How Examples Work[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## Adding Examples to Handle Corner Cases[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## When to Use Examples[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## One-Shot vs Multi-Shot[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## Finding Good Examples from Evaluations[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## Adding Context to Examples[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
...
## Best Practices[](https://academy.claude.com/courses/building-with-the-claude-api/providing-examples)
