...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fimplementing-multiple-turns)
...
## Detecting Tool Requests[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## The Conversation Loop[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## Handling Multiple Tool Calls[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## Tool Result Blocks[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## Error Handling[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## Scalable Tool Routing[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
...
## Complete Workflow[](https://academy.claude.com/courses/building-with-the-claude-api/implementing-multiple-turns)
