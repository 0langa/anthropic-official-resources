...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fchaining-workflows)
...
## What is Workflow Chaining?[](https://academy.claude.com/courses/building-with-the-claude-api/chaining-workflows)
...
## Why Chain Instead of One Big Prompt?[](https://academy.claude.com/courses/building-with-the-claude-api/chaining-workflows)
...
## The Long Prompt Problem[](https://academy.claude.com/courses/building-with-the-claude-api/chaining-workflows)
...
## The Chaining Solution[](https://academy.claude.com/courses/building-with-the-claude-api/chaining-workflows)
...
## When to Use Chaining[](https://academy.claude.com/courses/building-with-the-claude-api/chaining-workflows)
