...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fproject-setup)
...
## What We're Building[](https://academy.claude.com/courses/building-with-the-claude-api/project-setup)
...
## Important Architecture Note[](https://academy.claude.com/courses/building-with-the-claude-api/project-setup)
...
## Running the Application[](https://academy.claude.com/courses/building-with-the-claude-api/project-setup)
...
## A check worth keeping[](https://academy.claude.com/courses/building-with-the-claude-api/project-setup)
