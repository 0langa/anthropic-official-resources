...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Faccessing-resources)
...
## Understanding Resource Requests[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
...
## Implementing Resource Reading[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
...
## Handling Different Content Types[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
...
## Required Imports[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
...
## Testing Resource Access[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
...
## Integration with Your Application[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-resources)
