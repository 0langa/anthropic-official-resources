...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Ftext-embeddings)
...
## Semantic Search[](https://academy.claude.com/courses/building-with-the-claude-api/text-embeddings)
...
## Understanding the Numbers[](https://academy.claude.com/courses/building-with-the-claude-api/text-embeddings)
...
## VoyageAI for Embeddings[](https://academy.claude.com/courses/building-with-the-claude-api/text-embeddings)
...
## Implementation[](https://academy.claude.com/courses/building-with-the-claude-api/text-embeddings)
