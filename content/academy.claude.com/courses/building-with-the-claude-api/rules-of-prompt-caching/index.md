...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Frules-of-prompt-caching)
...
## Cache Breakpoints[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
...
## How Cache Breakpoints Work[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
...
## Cross-Message Caching[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
...
## System Prompts and Tools[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
...
## Cache Ordering[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
...
## Minimum Content Length[](https://academy.claude.com/courses/building-with-the-claude-api/rules-of-prompt-caching)
