...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fintroducing-tool-use)
...
## The Problem Without Tools[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-tool-use)
...
## How Tool Use Works[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-tool-use)
...
## Weather Example in Practice[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-tool-use)
...
## Key Benefits[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-tool-use)
