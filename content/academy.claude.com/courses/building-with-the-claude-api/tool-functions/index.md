...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Ftool-functions)
...
## What Are Tool Functions?[](https://academy.claude.com/courses/building-with-the-claude-api/tool-functions)
...
## Best Practices for Tool Functions[](https://academy.claude.com/courses/building-with-the-claude-api/tool-functions)
...
## Building Your First Tool Function[](https://academy.claude.com/courses/building-with-the-claude-api/tool-functions)
...
## Next Steps[](https://academy.claude.com/courses/building-with-the-claude-api/tool-functions)
