...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Ftemperature)
...
## How Claude Generates Text[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## What Temperature Does[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## Interactive Temperature Demo[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## Choosing the Right Temperature[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
### Low Temperature (0.0 - 0.3)[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
### Medium Temperature (0.4 - 0.7)[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
### High Temperature (0.8 - 1.0)[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## Implementing Temperature in Code[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## Testing Temperature Effects[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
...
## Key Takeaways[](https://academy.claude.com/courses/building-with-the-claude-api/temperature)
