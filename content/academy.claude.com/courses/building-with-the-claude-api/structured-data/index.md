...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fstructured-data)
...
## The Problem with Default Responses[](https://academy.claude.com/courses/building-with-the-claude-api/structured-data)
...
## The Solution: Assistant Message Prefilling + Stop Sequences[](https://academy.claude.com/courses/building-with-the-claude-api/structured-data)
...
## Processing the Response[](https://academy.claude.com/courses/building-with-the-claude-api/structured-data)
...
## Beyond JSON[](https://academy.claude.com/courses/building-with-the-claude-api/structured-data)
