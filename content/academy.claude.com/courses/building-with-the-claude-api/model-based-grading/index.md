...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fmodel-based-grading)
...
## Types of Graders[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
...
### Code Graders[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
...
### Model Graders[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
...
### Human Graders[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
...
## Defining Evaluation Criteria[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
...
## Implementing a Model Grader[](https://academy.claude.com/courses/building-with-the-claude-api/model-based-grading)
