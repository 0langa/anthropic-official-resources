...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fresponse-streaming)
...
## The Problem with Standard Responses[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
...
## How Streaming Works[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
...
## Understanding Stream Events[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
...
## Basic Streaming Implementation[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
...
## Simplified Text Streaming[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
...
## Getting the Complete Message[](https://academy.claude.com/courses/building-with-the-claude-api/response-streaming)
