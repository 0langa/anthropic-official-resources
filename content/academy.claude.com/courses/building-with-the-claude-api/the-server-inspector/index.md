...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fthe-server-inspector)

When building MCP servers, you need a way to test your functionality without connecting to a full application. The Python MCP SDK includes a built-in browser-based inspector that lets you debug and test your server in real-time.

## Starting the Inspector[](https://academy.claude.com/courses/building-with-the-claude-api/the-server-inspector)
...
## Important Note About the Interface[](https://academy.claude.com/courses/building-with-the-claude-api/the-server-inspector)
...
## Connecting and Testing Tools[](https://academy.claude.com/courses/building-with-the-claude-api/the-server-inspector)
...
## Testing Document Operations[](https://academy.claude.com/courses/building-with-the-claude-api/the-server-inspector)
...
## Development Workflow[](https://academy.claude.com/courses/building-with-the-claude-api/the-server-inspector)
