...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fmaking-a-request)
...
## Setting Up Your Environment[](https://academy.claude.com/courses/building-with-the-claude-api/making-a-request)
...
## The Create Function[](https://academy.claude.com/courses/building-with-the-claude-api/making-a-request)
...
## Understanding Messages[](https://academy.claude.com/courses/building-with-the-claude-api/making-a-request)
...
## Making Your First Request[](https://academy.claude.com/courses/building-with-the-claude-api/making-a-request)
...
## Extracting the Response[](https://academy.claude.com/courses/building-with-the-claude-api/making-a-request)
