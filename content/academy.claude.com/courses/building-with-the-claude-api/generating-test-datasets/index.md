...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fgenerating-test-datasets)
...
## Setting Up the Goal[](https://academy.claude.com/courses/building-with-the-claude-api/generating-test-datasets)
...
## Creating an Evaluation Dataset[](https://academy.claude.com/courses/building-with-the-claude-api/generating-test-datasets)
...
## Generating Test Data with Code[](https://academy.claude.com/courses/building-with-the-claude-api/generating-test-datasets)
...
## Testing the Dataset Generation[](https://academy.claude.com/courses/building-with-the-claude-api/generating-test-datasets)
...
## Saving the Dataset[](https://academy.claude.com/courses/building-with-the-claude-api/generating-test-datasets)
