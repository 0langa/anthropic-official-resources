...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fworkflows-vs-agents)
...
## What Are Workflows?[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## What Are Agents?[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## Benefits of Workflows[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## Benefits of Agents[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## Downsides of Workflows[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## Downsides of Agents[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
...
## When to Use Each Approach[](https://academy.claude.com/courses/building-with-the-claude-api/workflows-vs-agents)
