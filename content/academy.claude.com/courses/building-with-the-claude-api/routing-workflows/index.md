...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Frouting-workflows)
...
## The Problem with Generic Prompts[](https://academy.claude.com/courses/building-with-the-claude-api/routing-workflows)
...
## Setting Up Content Categories[](https://academy.claude.com/courses/building-with-the-claude-api/routing-workflows)
...
## How Routing Works in Practice[](https://academy.claude.com/courses/building-with-the-claude-api/routing-workflows)
...
## Routing Workflow Architecture[](https://academy.claude.com/courses/building-with-the-claude-api/routing-workflows)
...
## When to Use Routing[](https://academy.claude.com/courses/building-with-the-claude-api/routing-workflows)
