...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fusing-multiple-tools)
...
## The Tools We're Adding[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
...
## Adding Tools to the Conversation[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
...
## Updating the Tool Router[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
...
## Testing Multiple Tool Usage[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
...
## Understanding the Message Flow[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
...
## The Simple Pattern for Adding Tools[](https://academy.claude.com/courses/building-with-the-claude-api/using-multiple-tools)
