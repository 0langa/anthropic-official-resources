...
## Why Citations Matter[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
...
## Enabling Citations[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
...
## Understanding Citation Structure[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
...
## Building User Interfaces with Citations[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
...
## Citations with Plain Text[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
...
## When to Use Citations[](https://academy.claude.com/courses/building-with-the-claude-api/citations)
