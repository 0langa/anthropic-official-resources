...
## Why Structure Matters[](https://academy.claude.com/courses/building-with-the-claude-api/structure-with-xml-tags)
...
## Practical Example: Code and Documentation[](https://academy.claude.com/courses/building-with-the-claude-api/structure-with-xml-tags)
...
## Custom Tag Names[](https://academy.claude.com/courses/building-with-the-claude-api/structure-with-xml-tags)
...
## When to Use XML Tags[](https://academy.claude.com/courses/building-with-the-claude-api/structure-with-xml-tags)
...
## Real-World Application[](https://academy.claude.com/courses/building-with-the-claude-api/structure-with-xml-tags)
