...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fintroducing-mcp)
...
## Understanding MCP Through a Real Example[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
...
## The Tool Function Problem[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
...
## How MCP Solves This[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
...
## Common Questions About MCP[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)

![](https://academy.claude.com/assets/media/8f732f327ed47e73d82dcc2c4056fa8e2b7c923c60a9dab0d1992113af222e5f.jpg)

### Who Authors MCP Servers?[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
...
### How is MCP Different from Direct API Calls?[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
...
### Isn't MCP Just Tool Use?[](https://academy.claude.com/courses/building-with-the-claude-api/introducing-mcp)
