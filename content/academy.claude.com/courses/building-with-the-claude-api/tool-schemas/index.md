...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Ftool-schemas)
...
## Understanding JSON Schema[](https://academy.claude.com/courses/building-with-the-claude-api/tool-schemas)
...
## Writing Effective Descriptions[](https://academy.claude.com/courses/building-with-the-claude-api/tool-schemas)
...
## The Easy Way to Generate Schemas[](https://academy.claude.com/courses/building-with-the-claude-api/tool-schemas)
...
## Implementing the Schema in Code[](https://academy.claude.com/courses/building-with-the-claude-api/tool-schemas)
...
## Adding Type Safety[](https://academy.claude.com/courses/building-with-the-claude-api/tool-schemas)
