...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fdefining-resources)

Resources in MCP servers allow you to expose data to clients, similar to GET request handlers in a typical HTTP server. They're perfect for scenarios where you need to fetch information rather than perform actions.

## Understanding Resources Through an Example[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## How Resources Work[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## Types of Resources[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## Implementing Resources[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)

Resources are defined using the `@mcp.resource()` decorator. Here's how to create both types:

### Direct Resource (List Documents)[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
### Templated Resource (Fetch Document)[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## MIME Types[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## Testing Resources[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
...
## Key Points[](https://academy.claude.com/courses/building-with-the-claude-api/defining-resources)
