...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fbeing-specific)
...
## Two Types of Guidelines[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
### Output Quality Guidelines[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
### Process Steps[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
## Real-World Impact[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
## When to Use Each Approach[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)

Here's a practical guide for when to use each type of specificity:

### Always Use Output Guidelines[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
### Use Process Steps For Complex Problems[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
...
## Combining Both Approaches[](https://academy.claude.com/courses/building-with-the-claude-api/being-specific)
