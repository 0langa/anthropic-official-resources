...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fpdf-support)
...
## Setting Up PDF Processing[](https://academy.claude.com/courses/building-with-the-claude-api/pdf-support)
...
## Key Changes from Image Processing[](https://academy.claude.com/courses/building-with-the-claude-api/pdf-support)
...
## What Claude Can Extract from PDFs[](https://academy.claude.com/courses/building-with-the-claude-api/pdf-support)
