...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fdefining-tools-with-mcp)
...
## Setting Up the MCP Server[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
...
## Tool Definition with Decorators[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
...
## Creating the Document Reader Tool[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
...
## Building the Document Editor Tool[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
...
## Error Handling[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
...
## Key Benefits of the SDK Approach[](https://academy.claude.com/courses/building-with-the-claude-api/defining-tools-with-mcp)
