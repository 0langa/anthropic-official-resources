...
## The Five-Step Request Flow[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## Why You Need a Server[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## Making API Requests[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## Inside Claude's Processing[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
### Tokenization[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
### Embedding[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
### Contextualization[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
### Generation[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## When Claude Stops Generating[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## The API Response[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
...
## Key Takeaways[](https://academy.claude.com/courses/building-with-the-claude-api/accessing-the-api)
