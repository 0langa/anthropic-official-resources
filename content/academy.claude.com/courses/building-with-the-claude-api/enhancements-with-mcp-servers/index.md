...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fenhancements-with-mcp-servers)
...
## How MCP Extends Claude[](https://academy.claude.com/courses/building-with-the-claude-api/enhancements-with-mcp-servers)
...
## Setting Up an MCP Server[](https://academy.claude.com/courses/building-with-the-claude-api/enhancements-with-mcp-servers)
...
## Example: Document Processing[](https://academy.claude.com/courses/building-with-the-claude-api/enhancements-with-mcp-servers)
...
## Popular MCP Integrations[](https://academy.claude.com/courses/building-with-the-claude-api/enhancements-with-mcp-servers)
...
## Building Your Development Workflow[](https://academy.claude.com/courses/building-with-the-claude-api/enhancements-with-mcp-servers)
