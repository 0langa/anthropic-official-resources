...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fsending-tool-results)
...
## Running the Tool Function[](https://academy.claude.com/courses/building-with-the-claude-api/sending-tool-results)
...
## Tool Result Block[](https://academy.claude.com/courses/building-with-the-claude-api/sending-tool-results)
...
## Handling Multiple Tool Calls[](https://academy.claude.com/courses/building-with-the-claude-api/sending-tool-results)
...
## Building the Follow-up Request[](https://academy.claude.com/courses/building-with-the-claude-api/sending-tool-results)
...
## Making the Final Request[](https://academy.claude.com/courses/building-with-the-claude-api/sending-tool-results)
