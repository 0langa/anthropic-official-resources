...
## Making Tool-Enabled API Calls[](https://academy.claude.com/courses/building-with-the-claude-api/handling-message-blocks)
...
## Understanding Multi-Block Messages[](https://academy.claude.com/courses/building-with-the-claude-api/handling-message-blocks)
...
## Managing Conversation History with Multi-Block Messages[](https://academy.claude.com/courses/building-with-the-claude-api/handling-message-blocks)
...
## The Complete Tool Usage Flow[](https://academy.claude.com/courses/building-with-the-claude-api/handling-message-blocks)
...
## Updating Helper Functions[](https://academy.claude.com/courses/building-with-the-claude-api/handling-message-blocks)
