...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fbuilding-with-the-claude-api%2Fmulti-turn-conversations)
...
## The Problem with Stateless Conversations[](https://academy.claude.com/courses/building-with-the-claude-api/multi-turn-conversations)
...
## How Multi-Turn Conversations Work[](https://academy.claude.com/courses/building-with-the-claude-api/multi-turn-conversations)
...
## Building Helper Functions[](https://academy.claude.com/courses/building-with-the-claude-api/multi-turn-conversations)
...
## Putting It All Together[](https://academy.claude.com/courses/building-with-the-claude-api/multi-turn-conversations)
