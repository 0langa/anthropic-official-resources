...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=hftmYd97LBw)

## The maintenance problem[](https://academy.claude.com/courses/claude-platform-101/mcp)
...
## Tools vs. skills vs. MCP[](https://academy.claude.com/courses/claude-platform-101/mcp)
...
## Connecting to an MCP server[](https://academy.claude.com/courses/claude-platform-101/mcp)
...
## Filtering which tools Claude can use[](https://academy.claude.com/courses/claude-platform-101/mcp)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/mcp)
