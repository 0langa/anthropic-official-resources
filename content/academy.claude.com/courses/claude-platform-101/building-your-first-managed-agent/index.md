...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-platform-101%2Fbuilding-your-first-managed-agent)

Embedded media: https://www.youtube-nocookie.com/embed/1Rl3gZrlQJo?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=1Rl3gZrlQJo)

## What is a managed agent?[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## The four primitives[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## The smallest possible managed agent[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Step 1: Create the agent[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Step 2: Create the environment[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Step 3: Create the session[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Step 4: Open the stream, then send the kickoff[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Step 5: Consume the stream[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## The trade[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/building-your-first-managed-agent)
