...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=RfeC02NmLqs)
...
## The three layers of the platform[](https://academy.claude.com/courses/claude-platform-101/what-is-the-claude-platform)
...
## A real example: drafting help desk replies[](https://academy.claude.com/courses/claude-platform-101/what-is-the-claude-platform)
...
## From "ask Claude a question" to "Claude is part of my product"[](https://academy.claude.com/courses/claude-platform-101/what-is-the-claude-platform)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/what-is-the-claude-platform)
