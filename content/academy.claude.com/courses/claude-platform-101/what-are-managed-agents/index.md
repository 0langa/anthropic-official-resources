...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-platform-101%2Fwhat-are-managed-agents)

Embedded media: https://www.youtube-nocookie.com/embed/haeslvB0zpg?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=haeslvB0zpg)

## The agent loop, hosted for you[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
...
## Example 1: A Kanban board that does the work[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
...
## Example 2: A recurring research agent with memory[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
...
## Example 3: Incident response with multiple agents[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
...
## The building blocks[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/what-are-managed-agents)
