...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=pm8iwdSIs3M)

## Server tools: declared by you, run by Anthropic[](https://academy.claude.com/courses/claude-platform-101/built-in-tools)
...
## Two server tools in one file[](https://academy.claude.com/courses/claude-platform-101/built-in-tools)
...
## Running it[](https://academy.claude.com/courses/claude-platform-101/built-in-tools)
...
## The other category: client tools[](https://academy.claude.com/courses/claude-platform-101/built-in-tools)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/built-in-tools)
