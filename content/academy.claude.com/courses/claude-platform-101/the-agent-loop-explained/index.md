...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-platform-101%2Fthe-agent-loop-explained)

Embedded media: https://www.youtube-nocookie.com/embed/tBIdyIoCQVU?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0
...
[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=tBIdyIoCQVU)

## What an agent actually is[](https://academy.claude.com/courses/claude-platform-101/the-agent-loop-explained)
...
## A minimal working example[](https://academy.claude.com/courses/claude-platform-101/the-agent-loop-explained)
...
## Running it[](https://academy.claude.com/courses/claude-platform-101/the-agent-loop-explained)
...
## The same loop in production[](https://academy.claude.com/courses/claude-platform-101/the-agent-loop-explained)
...
## Recap[](https://academy.claude.com/courses/claude-platform-101/the-agent-loop-explained)
