...
## Chat, Cowork, and Claude Code[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
A working session. Point Claude at a folder or project and your tools, describe an outcome—Claude plans, executes, and delivers.
