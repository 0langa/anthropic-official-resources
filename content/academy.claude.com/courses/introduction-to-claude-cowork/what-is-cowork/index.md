...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fintroduction-to-claude-cowork%2Fwhat-is-cowork)

## Introducing Cowork[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
## Key takeaways[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
## What Cowork actually is[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
## How Cowork works in your environment[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
## Chat vs. Cowork vs. Code[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
"Read the five vendor PDFs in my Downloads folder, compare them on price and SLAs, and put the result in a spreadsheet."

ChatCoworkCode

Pick a mode to continueNext task
...
## Lesson reflection[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
...
## What’s next[](https://academy.claude.com/courses/introduction-to-claude-cowork/what-is-cowork)
