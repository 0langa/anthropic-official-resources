...
## Set up so mistakes can't reach what matters[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## Write prompts that leave no room for the wrong action[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## In the moment: the three checks that catch the rest[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## When Cowork isn't the right tool[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## Go deeper[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## Lesson reflection[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
...
## What’s next[](https://academy.claude.com/courses/introduction-to-claude-cowork/permissions-usage-choosing-your-model)
