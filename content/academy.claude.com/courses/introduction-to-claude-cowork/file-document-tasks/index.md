...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fintroduction-to-claude-cowork%2Ffile-document-tasks)

## What a skill actually is[](https://academy.claude.com/courses/introduction-to-claude-cowork/file-document-tasks)
...
## What’s inside a skill[](https://academy.claude.com/courses/introduction-to-claude-cowork/file-document-tasks)
...
meeting-recapboard-memovariance-analysis
...
## Build a skill with Claude[](https://academy.claude.com/courses/introduction-to-claude-cowork/file-document-tasks)
...
## Lesson reflection[](https://academy.claude.com/courses/introduction-to-claude-cowork/file-document-tasks)
...
## What’s next[](https://academy.claude.com/courses/introduction-to-claude-cowork/file-document-tasks)
