...
## How you’re billed[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## The settings that move spend[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## Reviewing before you raise[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## Reading your spend[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)

Three surfaces answer three kinds of questions, so use the one that fits.

<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium"><strong>Surface</strong></th><th class="border-b border-strong p-sm text-left font-medium"><strong>What it answers</strong></th><th class="border-b border-strong p-sm text-left font-medium"><strong>Use it for</strong></th></tr></thead><tbody><tr><td class="border-b p-sm">The analytics dashboard</td><td class="border-b p-sm">Adoption and spend trends: spend by model, top consumers, where usage is climbing</td><td class="border-b p-sm">Your regular review</td></tr><tr><td class="border-b p-sm">Analytics chat</td><td class="border-b p-sm">Ad-hoc questions in plain language (“who spent the most this month, and on which model?”)</td><td class="border-b p-sm">A one-off question that doesn’t need a report</td></tr><tr><td class="border-b p-sm">The Analytics API</td><td class="border-b p-sm">The same usage and cost data, pulled programmatically into your own finance tooling</td><td class="border-b p-sm">Reconciliation and chargeback; a Primary Owner generates the key</td></tr></tbody></table>
...
## Pluto’s spend governance[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
group cap · per member

High-effort runsRoutine tasksPAUSED AT CAP

one member · monthly usage ↑

Group capRaise Platform’s capThe line moves up for every Platform member, not just this one.Role defaultLower the role’s default modelMembers start in a mid-range model unless they switch. Same volume, less usage.Role capCap the role’s effort levelRoutine work can’t run at the highest effort. Trims the high-effort runs.No changeLeave the settings aloneStays paused until the month resets or the increase request is approved.

Illustrative direction only, not a forecast; these four levers are examples, not your only options.

## 1 · Your decision[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)

What is your spend-governance posture: where the defaults sit, how often you review, and what happens before a cap moves?

## 2 · The choices you can make[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## 3 · If you change this later[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## Set up resources[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## Lesson activity[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
...
## What’s next[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/managing-spend)
