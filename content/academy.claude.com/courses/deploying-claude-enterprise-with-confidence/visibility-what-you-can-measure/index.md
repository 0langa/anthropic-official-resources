...
## What visibility is for[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## The Compliance API: your record of conversation content[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## OpenTelemetry: how the surfaces are running[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## Retention: how long content is kept[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
Compliance APIChat, Cowork, and Claude Code session content. The Primary Owner enables it; access keys are scoped.

OpenTelemetry exportHow Cowork and Claude Code are running. Cowork includes prompt content by default (filter it in your collector); Claude Code logs prompts only by opt-in.

Retention windowHow far back content still exists. Default: no limit.
...
Was Cowork slow for one group last Tuesday?

OpenTelemetryAnswerable

What exactly did Claude say in a member’s chat **two days ago**?

Compliance APIAnswerable

A regulator asks for a chat from **five months ago**.

Retention ≥ 5 moCompliance APIAnswerable

Legal needs a project file a member uploaded **ten months ago**.

Retention ≥ 10 moCompliance APIAnswerable

What did an engineer type into Claude Code last month?

Compliance APIAnswerable

## Pluto’s visibility[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## 1 · Your decision[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)

What retention window do you set, and is the Compliance API on and routed to a reviewer?

## 2 · The choices you can make[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)

<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium"><strong>The choice</strong></th><th class="border-b border-strong p-sm text-left font-medium"><strong>When you’d choose it</strong></th><th class="border-b border-strong p-sm text-left font-medium"><strong>What it means and the impact it has</strong></th></tr></thead><tbody><tr><td class="border-b p-sm"><strong>Match your existing data policy, Compliance API on</strong></td><td class="border-b p-sm">The default. You have a data-governance policy for this class of content and a security/compliance review process a named reviewer already runs.</td><td class="border-b p-sm">Retention set to whatever your data-governance policy already says for this class of content. Compliance API on and routed to the review you already run.</td></tr><tr><td class="border-b p-sm"><strong>Regulated posture, Compliance API expected</strong></td><td class="border-b p-sm">You handle regulated data.</td><td class="border-b p-sm">Compliance API moves from optional to expected. The retention window is typically set organization-wide against your regulatory and contractual obligations rather than your general data policy — that call sits with your risk owner. The whole organization gets the regulated group’s number.</td></tr><tr><td class="border-b p-sm"><strong>Compliance API off, condition documented</strong></td><td class="border-b p-sm">No review process exists and none is planned.</td><td class="border-b p-sm">Leave the Compliance API off for now and write down the condition that turns it on. Note that until it’s on, questions about that period have no content record to draw on.</td></tr></tbody></table>
...
## 3 · If you change this later[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## Set up resources[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## Lesson activity[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
...
## What’s next[](https://academy.claude.com/courses/deploying-claude-enterprise-with-confidence/visibility-what-you-can-measure)
