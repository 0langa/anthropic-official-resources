...
## How Tools Make the Agent[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/agents-and-tools)
...
## Tools Should Be Abstract[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/agents-and-tools)
...
## Best Practice: Provide Reasonably Abstract Tools[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/agents-and-tools)
