...
## The Problem with One-Size-Fits-All Prompts[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
...
## Setting Up Content Categories[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
...
## The Two-Step Process[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)

A routing workflow uses two separate calls to Claude:

### Step 1: Categorization[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
...
### Step 2: Specialized Processing[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
...
## Key Benefits[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
...
## When to Use Routing[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/routing-workflows)
