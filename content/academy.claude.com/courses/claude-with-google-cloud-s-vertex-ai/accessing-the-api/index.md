...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-google-cloud-s-vertex-ai%2Faccessing-the-api)
...
## The Complete Request Flow[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## Why You Need a Server[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## Making the API Request[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## Inside Claude: Text Generation Process[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
### Tokenization[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
### Embedding[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
### Contextualization[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
### Generation[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## When Generation Stops[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## The Response[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
...
## The Complete Picture[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/accessing-the-api)
