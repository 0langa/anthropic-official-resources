...
## How Re-ranking Works[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
...
## The Re-ranking Prompt[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
...
## Efficiency Considerations[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
...
## Implementation[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
...
## Results[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
...
## Trade-offs[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/reranking-results)
