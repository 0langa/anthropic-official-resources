...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-google-cloud-s-vertex-ai%2Fusing-multiple-tools)
...
## Adding Tools to the Conversation[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/using-multiple-tools)
...
## Handling Tool Execution[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/using-multiple-tools)
...
## Testing Multiple Tool Usage[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/using-multiple-tools)
...
## Understanding the Message Flow[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/using-multiple-tools)
...
## Key Takeaways[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/using-multiple-tools)
