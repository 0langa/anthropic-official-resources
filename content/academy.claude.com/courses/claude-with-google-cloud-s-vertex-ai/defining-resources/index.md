...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-google-cloud-s-vertex-ai%2Fdefining-resources)

Resources in MCP servers allow you to expose data to clients, similar to GET request handlers in a typical HTTP server. They're perfect for scenarios where you need to fetch information rather than perform actions.

## Understanding Resources[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/defining-resources)
...
## Two Types of Resources[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/defining-resources)
...
## Creating Resources[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/defining-resources)
...
## Testing Your Resources[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/defining-resources)
...
## Practical Use Cases[](https://academy.claude.com/courses/claude-with-google-cloud-s-vertex-ai/defining-resources)
