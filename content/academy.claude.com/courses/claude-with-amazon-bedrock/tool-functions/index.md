...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Ftool-functions)
...
## Why This Is Challenging[](https://academy.claude.com/courses/claude-with-amazon-bedrock/tool-functions)
...
### Best Practices[](https://academy.claude.com/courses/claude-with-amazon-bedrock/tool-functions)
...
## JSON Schema Specification[](https://academy.claude.com/courses/claude-with-amazon-bedrock/tool-functions)
...
### Schema Best Practices[](https://academy.claude.com/courses/claude-with-amazon-bedrock/tool-functions)
