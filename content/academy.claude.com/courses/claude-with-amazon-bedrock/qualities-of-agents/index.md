...
## How Agents Work in Practice[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)
...
## Key Qualities of Effective Agents[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)

Based on these observations, successful agents share four critical qualities:

### Focused Tool Sets Running in Loops[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)
...
### Context is Everything[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)
...
### High Value Tasks with Low Error Costs[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)
...
### Continuous Evaluation[](https://academy.claude.com/courses/claude-with-amazon-bedrock/qualities-of-agents)
