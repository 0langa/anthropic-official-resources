...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Ftext-embeddings)
...
## Finding Relevant Chunks[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-embeddings)
...
## What Are Text Embeddings?[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-embeddings)
...
## Understanding the Numbers[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-embeddings)
...
## Generating Embeddings with Code[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-embeddings)
...
## Why Embeddings Matter for RAG[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-embeddings)
