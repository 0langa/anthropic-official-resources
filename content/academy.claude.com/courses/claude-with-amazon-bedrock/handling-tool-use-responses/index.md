...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fhandling-tool-use-responses)
...
## Tool Choice Configuration[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
...
## Multi-Part Message Structure[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
...
## Understanding the ToolUse Part[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
...
## Conversation Flow with Tools[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
...
## Updating Helper Functions[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
...
## Checking the Stop Reason[](https://academy.claude.com/courses/claude-with-amazon-bedrock/handling-tool-use-responses)
