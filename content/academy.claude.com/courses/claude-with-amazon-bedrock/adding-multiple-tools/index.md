...
## Adding Tools to the Conversation[](https://academy.claude.com/courses/claude-with-amazon-bedrock/adding-multiple-tools)
...
## Key Takeaway[](https://academy.claude.com/courses/claude-with-amazon-bedrock/adding-multiple-tools)
