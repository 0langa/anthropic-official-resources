...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fjson-schema-for-tools)
...
## Understanding JSON Schema[](https://academy.claude.com/courses/claude-with-amazon-bedrock/json-schema-for-tools)
...
## Creating a JSON Schema: Step-by-Step[](https://academy.claude.com/courses/claude-with-amazon-bedrock/json-schema-for-tools)

Here's the simplest way to create a JSON schema for any function:

### Step 1: Write a Dictionary with Sample Data[](https://academy.claude.com/courses/claude-with-amazon-bedrock/json-schema-for-tools)
...
### Step 4: Add Descriptions[](https://academy.claude.com/courses/claude-with-amazon-bedrock/json-schema-for-tools)
...
## Putting It All Together[](https://academy.claude.com/courses/claude-with-amazon-bedrock/json-schema-for-tools)
