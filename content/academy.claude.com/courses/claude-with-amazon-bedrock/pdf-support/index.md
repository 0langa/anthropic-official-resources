...
## Setting Up PDF Processing[](https://academy.claude.com/courses/claude-with-amazon-bedrock/pdf-support)
...
## Document Message Structure[](https://academy.claude.com/courses/claude-with-amazon-bedrock/pdf-support)
...
## What Claude Can Do with PDFs[](https://academy.claude.com/courses/claude-with-amazon-bedrock/pdf-support)
