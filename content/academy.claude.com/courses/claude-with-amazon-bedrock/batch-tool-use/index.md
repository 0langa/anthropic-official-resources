...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fbatch-tool-use)
...
## How the Batch Tool Works[](https://academy.claude.com/courses/claude-with-amazon-bedrock/batch-tool-use)
...
## Implementation[](https://academy.claude.com/courses/claude-with-amazon-bedrock/batch-tool-use)

The batch tool implementation involves two main functions:

### The run\_batch Function[](https://academy.claude.com/courses/claude-with-amazon-bedrock/batch-tool-use)
...
### Adding to run\_tool[](https://academy.claude.com/courses/claude-with-amazon-bedrock/batch-tool-use)
...
## Results[](https://academy.claude.com/courses/claude-with-amazon-bedrock/batch-tool-use)
