...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fenhancements-with-mcp-servers)
...
## How MCP Integration Works[](https://academy.claude.com/courses/claude-with-amazon-bedrock/enhancements-with-mcp-servers)
...
## Testing the Integration[](https://academy.claude.com/courses/claude-with-amazon-bedrock/enhancements-with-mcp-servers)
...
## Popular MCP Servers for Development[](https://academy.claude.com/courses/claude-with-amazon-bedrock/enhancements-with-mcp-servers)
...
## Building Your Custom Workflow[](https://academy.claude.com/courses/claude-with-amazon-bedrock/enhancements-with-mcp-servers)
