...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fproviding-examples)
...
## How Examples Work[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## Adding Examples to Your Prompt[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## Handling Corner Cases[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## When to Use Examples[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## Finding Good Examples from Evaluations[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## Adding Context to Examples[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
...
## Best Practices[](https://academy.claude.com/courses/claude-with-amazon-bedrock/providing-examples)
