...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Ftemperature)
...
## How Claude Generates Text[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
## Temperature Ranges and Use Cases[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
### Medium Temperature (0.4 - 0.7)[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
### High Temperature (0.8 - 1.0)[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
## Setting Temperature in Code[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
## Temperature in Practice[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
...
## Key Takeaways[](https://academy.claude.com/courses/claude-with-amazon-bedrock/temperature)
