...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fdefining-tools-with-mcp)
...
## MCP Python SDK Benefits[](https://academy.claude.com/courses/claude-with-amazon-bedrock/defining-tools-with-mcp)
...
## Setting Up the Server[](https://academy.claude.com/courses/claude-with-amazon-bedrock/defining-tools-with-mcp)
...
## Implementing the Read Tool[](https://academy.claude.com/courses/claude-with-amazon-bedrock/defining-tools-with-mcp)
...
## Implementing the Edit Tool[](https://academy.claude.com/courses/claude-with-amazon-bedrock/defining-tools-with-mcp)
...
## Key Implementation Details[](https://academy.claude.com/courses/claude-with-amazon-bedrock/defining-tools-with-mcp)
