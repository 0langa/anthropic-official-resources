...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fsending-tool-results)
...
## Adding the Assistant Message[](https://academy.claude.com/courses/claude-with-amazon-bedrock/sending-tool-results)
...
## Running Tools and Creating Tool Results[](https://academy.claude.com/courses/claude-with-amazon-bedrock/sending-tool-results)
...
## Adding Tool Results to the Conversation[](https://academy.claude.com/courses/claude-with-amazon-bedrock/sending-tool-results)
