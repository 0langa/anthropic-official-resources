...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Ftext-chunking-strategies)
...
## Size-Based Chunking[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
...
## Structure-Based Chunking[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
...
## Implementation Examples[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)

Here are three practical chunking functions you can implement:

### Character-Based Chunking[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
...
### Sentence-Based Chunking[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
...
### Section-Based Chunking[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
...
## Choosing the Right Strategy[](https://academy.claude.com/courses/claude-with-amazon-bedrock/text-chunking-strategies)
