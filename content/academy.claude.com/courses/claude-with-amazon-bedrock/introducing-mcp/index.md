...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fintroducing-mcp)
...
## The Problem MCP Solves[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)
...
## How MCP Works[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)
...
## Common Questions[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)

### Who authors MCP Servers?[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)
...
### How is this different from calling APIs directly?[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)
...
### Isn't MCP just the same as tool use?[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-mcp)
