...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fstructured-data)
...
## The Problem with Default Responses[](https://academy.claude.com/courses/claude-with-amazon-bedrock/structured-data)
...
## The Solution: Assistant Message Prefilling + Stop Sequences[](https://academy.claude.com/courses/claude-with-amazon-bedrock/structured-data)
...
## Processing the Results[](https://academy.claude.com/courses/claude-with-amazon-bedrock/structured-data)
...
## Beyond JSON[](https://academy.claude.com/courses/claude-with-amazon-bedrock/structured-data)
