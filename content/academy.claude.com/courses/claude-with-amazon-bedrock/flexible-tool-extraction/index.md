...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fflexible-tool-extraction)
...
## The Flexible Schema Approach[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
...
## How It Works[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
...
## Setting Up the Prompt[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
...
## Making the API Call[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
...
## Easy Structure Changes[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
...
## When to Use Each Approach[](https://academy.claude.com/courses/claude-with-amazon-bedrock/flexible-tool-extraction)
