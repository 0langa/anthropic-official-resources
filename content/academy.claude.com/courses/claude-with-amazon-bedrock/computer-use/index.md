...
## Real-World Example: Automated QA Testing[](https://academy.claude.com/courses/claude-with-amazon-bedrock/computer-use)
...
## Setting Up Computer Use[](https://academy.claude.com/courses/claude-with-amazon-bedrock/computer-use)
...
## Best Practices for Computer Use[](https://academy.claude.com/courses/claude-with-amazon-bedrock/computer-use)
