...
Not now[Sign in](https://academy.claude.com/login?returnTo=https%3A%2F%2Facademy.claude.com%2Fcourses%2Fclaude-with-amazon-bedrock%2Fintroducing-tool-use)
...
## How Tool Use Works[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-tool-use)
...
## Weather Example in Practice[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-tool-use)
...
## Implementation Challenges[](https://academy.claude.com/courses/claude-with-amazon-bedrock/introducing-tool-use)
