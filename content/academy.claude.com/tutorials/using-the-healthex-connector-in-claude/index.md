...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **Who should use the HealthEx integration**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **Who can access the HealthEx integration**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **Setting up the HealthEx integration in Claude**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **How to securely connect to your HealthEx account**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
...
## **How does Claude protect my data privacy and safety?**[](https://academy.claude.com/tutorials/using-the-healthex-connector-in-claude)
