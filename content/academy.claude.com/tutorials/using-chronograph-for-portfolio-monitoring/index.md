...
## What This Integration Provides[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)

### Capabilities[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
## How Claude Uses Chronograph Data[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
## Setting Up Chronograph Integration[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)

You will need to contact Chronograph to get access to the MCP server.

### For Organization Owners[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
### For Individual Users[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
## Common Use Cases[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)

### Portfolio Performance Summary[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
### Exposure Analysis[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
### Entity Due Diligence[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
### Custom Metric Tracking[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
### Platform Guidance[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
...
## Tips for Using Chronograph[](https://academy.claude.com/tutorials/using-chronograph-for-portfolio-monitoring)
