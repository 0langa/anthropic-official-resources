...
## What this integration provides[](https://academy.claude.com/tutorials/using-the-synapse-org-connector-in-claude)
...
## Who can access the Synapse.org integration[](https://academy.claude.com/tutorials/using-the-synapse-org-connector-in-claude)
...
More details on accessing the integration can be found in [Synapse’s MCP Server Documentation(opens in new tab)](https://github.com/susheel/synapse-mcp?tab=readme-ov-file).

## Setting up the Synapse.org integration[](https://academy.claude.com/tutorials/using-the-synapse-org-connector-in-claude)
...
Technical details of the Synapse.org integration can be found in [Synapse’s MCP Server Documentation(opens in new tab)](https://github.com/susheel/synapse-mcp?tab=readme-ov-file).

## Common use cases[](https://academy.claude.com/tutorials/using-the-synapse-org-connector-in-claude)
