...
## **About the ToolUniverse integration**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Data sets and services available in this integration**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Who should use the ToolUniverse integration**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Who can access the ToolUniverse integration**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Setting up the ToolUniverse integration**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
...
## **Demos and Documentation**[](https://academy.claude.com/tutorials/using-the-tooluniverse-extension-in-claude)
