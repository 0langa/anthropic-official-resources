...
## **What is the Clinical Trial Protocol Draft Generation demo skill?**[](https://academy.claude.com/tutorials/how-to-use-the-clinical-trial-protocol-draft-generation-sample-skill-with-claude)
...
## **Who should use the Clinical Trial Protocol Draft Generation demo skill?**[](https://academy.claude.com/tutorials/how-to-use-the-clinical-trial-protocol-draft-generation-sample-skill-with-claude)
...
## **How to access the skill in** [**Claude.ai**(opens in new tab)](http://claude.ai/)[](https://academy.claude.com/tutorials/how-to-use-the-clinical-trial-protocol-draft-generation-sample-skill-with-claude)
...
## **How to access the skill in Claude Code**[](https://academy.claude.com/tutorials/how-to-use-the-clinical-trial-protocol-draft-generation-sample-skill-with-claude)
