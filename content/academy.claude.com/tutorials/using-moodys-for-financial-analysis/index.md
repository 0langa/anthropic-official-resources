...
## What This Connector Provides[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)

### Integration Capabilities[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
## How Claude Uses Moody’s Data[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
## Setting up the Moody’s Connector[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### Adding the Connector as an Organization Owner[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### For Individual Users[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
## Common Use Cases[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)

### Available Tools Example[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### Credit Analysis for Portfolio Management[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### M&A Due Diligence[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### Investment Portfolio Monitoring[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
### Counterparty Risk Assessment[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
...
## Tips for Using Moody’s[](https://academy.claude.com/tutorials/using-moodys-for-financial-analysis)
