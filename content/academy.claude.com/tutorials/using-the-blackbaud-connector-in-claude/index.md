...
## What this connector provides[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
## Setting up the connector[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)

### For Blackbaud marketplace admins[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### For organization owners[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### For individual users[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
## Common use cases[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)

### Donor lookup[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### Gift history analysis[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### Event research[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### Thank-you letter drafting[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
### Constituent search[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
...
## Tips for using the connector[](https://academy.claude.com/tutorials/using-the-blackbaud-connector-in-claude)
