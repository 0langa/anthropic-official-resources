...
## What This Integration Provides[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)

### Capabilities[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## How Claude Uses Daloopa Data[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Setting Up Daloopa Integration[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
### For Organization Owners[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
### For Individual Users[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Common Use Cases[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)

### Multi-Company Benchmarking[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
### Time Series Analysis[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Operational KPI Analysis[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Quarter-over-Quarter Analysis[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Post-Earnings Analysis[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Discovering Available Metrics[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
...
## Tips for Using Daloopa[](https://academy.claude.com/tutorials/using-daloopa-for-financial-analysis)
