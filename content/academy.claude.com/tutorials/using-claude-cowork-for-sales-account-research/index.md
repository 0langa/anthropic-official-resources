...
Embedded media: https://www.youtube-nocookie.com/embed/dDg7vhvtbEE?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0

[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=dDg7vhvtbEE)
...
## Step 1: Set up the account-research skill[](https://academy.claude.com/tutorials/using-claude-cowork-for-sales-account-research)
...
3. **In the chat bar**, pick a place Claude can read, edit, and save to: a working folder if you're in the desktop app, or a project. The brief lands there before the call and the debrief goes next to it after, so over time it becomes the account’s history.
...
## Step 2: Run the account brief before the call[](https://academy.claude.com/tutorials/using-claude-cowork-for-sales-account-research)

Before each call

The skill is set up and your tools are connected. Now, the morning of a first call, open Claude, type `/`, pick the `account-research` skill, and name the account:
...
## Step 3: Run the debrief after the call[](https://academy.claude.com/tutorials/using-claude-cowork-for-sales-account-research)
...
## Make it yours[](https://academy.claude.com/tutorials/using-claude-cowork-for-sales-account-research)
...
## Learn more[](https://academy.claude.com/tutorials/using-claude-cowork-for-sales-account-research)
