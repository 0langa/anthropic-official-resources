...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-chembl-connector-in-claude)
...
## **Who should use the ChEMBL integration**[](https://academy.claude.com/tutorials/using-the-chembl-connector-in-claude)
...
## **Setting up the ChEMBL integration**[](https://academy.claude.com/tutorials/using-the-chembl-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-chembl-connector-in-claude)
