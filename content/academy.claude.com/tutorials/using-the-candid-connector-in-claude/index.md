...
## What this connector provides[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Who can use this[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Setting up the connector[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

### For organization owners (Team and Enterprise)[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### For individual users[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Example use cases[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

### Finding local organizations[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Researching sector trends[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Finding by mission and criteria[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Learning resources[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Tips for best results[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

### Be specific with locations[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

- ✓ `nonprofits in Brooklyn, New York`
- ✓ `foundations serving rural Montana communities`
- ✗ `organizations in the Northeast` (too broad)

### Describe work, not just keywords[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

- ✓ `organizations helping homeless youth find permanent housing`
- ✓ `funders supporting immigrant and refugee integration programs`

### Combine multiple filters[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Ask follow-up questions[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

- `Tell me more about [organization name]`
- `Are there similar organizations in other states?`

## Understanding seals of transparency[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Frequently asked questions[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

### Does it cost extra?[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)

Basic search is free for all paid Claude plans. Advanced features may require additional authentication.

### How current is the data?[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Does it include international organizations?[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
### Can't find a specific organization?[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
...
## Privacy and data usage[](https://academy.claude.com/tutorials/using-the-candid-connector-in-claude)
