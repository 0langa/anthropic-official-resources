...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-owkin-connector-in-claude)
...
## **Who should use the Owkin integration**[](https://academy.claude.com/tutorials/using-the-owkin-connector-in-claude)
...
## **Who can access the Owkin integration**[](https://academy.claude.com/tutorials/using-the-owkin-connector-in-claude)

Prerequisites to access the connector are:

- An account with access to the K Pro platform ([product page(opens in new tab)](https://www.owkin.com/k-os/k-pro), [signup page(opens in new tab)](https://k.owkin.com/auth/signin?next=%2Fchat))
...
## **Setting up the Owkin integration**[](https://academy.claude.com/tutorials/using-the-owkin-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-owkin-connector-in-claude)
