...
## Introduction[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)

### What Is Claude Cowork?[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
## Phase 1: Technical Setup[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Planning & Prerequisites[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Identity & Access[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Connectors & Hardening[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Deployment & Launch[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Claude Cowork Analytics[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Define Success Metrics[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium">1. Are people using it?</th><th class="border-b border-strong p-sm text-left font-medium">2. How deeply?</th><th class="border-b border-strong p-sm text-left font-medium">3. Is it paying off?</th></tr></thead><tbody><tr><td class="border-b p-sm">Activation rate (logged in / licensed)</td><td class="border-b p-sm">Sessions per active user</td><td class="border-b p-sm">Hours re-allocated per week (self-reported)</td></tr><tr><td class="border-b p-sm">Weekly actives by cohort</td><td class="border-b p-sm">Advanced-feature uptake (connectors, skills, plugins)</td><td class="border-b p-sm">Named wins per cohort</td></tr><tr><td class="border-b p-sm">Return rate (week-2 retention)</td><td class="border-b p-sm">Champion-to-user touchpoints</td><td class="border-b p-sm">Workflows now running on Claude</td></tr><tr><td class="border-b p-sm">Days from training to first real task</td><td class="border-b p-sm">Help-session participation</td><td class="border-b p-sm">Cost-to-value comparison</td></tr></tbody></table>
...
### Identify & Enable Champions[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
## Phase 3: Enablement & Training[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Structured Training Programs[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Self-Service Resources[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Claude Cowork Features to Cover[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Internal Support Channels[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
## Phase 4: Scaling Adoption[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Expanding Across Teams[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Measuring Impact[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Governance[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Capability Governance[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
...
### Building a Lasting Program[](https://academy.claude.com/tutorials/claude-cowork-enterprise-administrator-guide)
