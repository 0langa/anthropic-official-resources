...
## How to access nonprofit tools and features[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)
...
## Nonprofit operations and fundraising connectors[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)
...
## AI fluency for nonprofits[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)
...
## Common nonprofit use cases[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)

Explore the [use case library(opens in new tab)](https://academy.claude.com/all) for inspiration, including:
...
## Frequently asked questions[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)
...
Individual users can access Claude Pro at $20/month. Explore the [AI fluency for nonprofits course(opens in new tab)](https://academy.claude.com/courses/ai-fluency-for-nonprofits) and the [use case library(opens in new tab)](https://academy.claude.com/all) to get started.

#### What support and training is available?

Visit the [use case library(opens in new tab)](https://academy.claude.com/all) and [help center(opens in new tab)](https://support.claude.com/en/) for resources and guidance.

## Troubleshooting[](https://academy.claude.com/tutorials/getting-started-with-claude-for-nonprofits)
