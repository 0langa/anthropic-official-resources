...
## Where answers come from[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
## Parametric memory[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
## Where parametric memory runs out[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
ThefirstpresidentoftheUnitedStatesofAmericawasGeorgeWashingtonreveal

0 / 6 judged

## Adding context[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
Without contextContrived contextAuthentic context

What's the guest wifi password at our Lakeside office?

Will the model get this right?
...
## The context window[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
system prompt + preloaded context345 tokens
...
## Compaction[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
Tomatoes are a great first crop. Start with transplants rather than seeds, give them 6–8 hours of direct sun, and water at the base. Where are you located?
...
web\_search("best time plant tomato seeds zone 7b")

tool result184 tokens

[1] almanac.com: Zone 7b, start seeds indoors 6–8 weeks before last frost. [2] ncsu.edu/extension: Piedmont NC last frost ≈ Apr 10–15. [3] burpee.com: Zone 7 tomato calendar, indoor sow Feb 15.

For zone 7b, start seeds indoors mid-February to early March, about 6–8 weeks before your last frost (around April 15). Harden them off for a week, then transplant outdoors late April.

62 tokens

What about pests? And how often should I water?

22 tokens

For pests, watch for hornworms (handpick them) and aphids (spray with water). Water deeply 1–2 inches per week, in the morning, at the base. Mulch helps retain moisture and prevent disease splash. Stake or cage your plants early. Want me to put together a planting calendar for your zone?
...
Claude's calendar reply needs about 140 tokens, but only 128 remain. The context window is full.
...
## Written memory[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
Keep updates to my team short and bulleted, please.

Done. That sounds like a standing preference, so I'm writing it down.



saved to memorymemory file *"Prefers short, bulleted team updates."*

nap

Conversation 2 · Thursday

memory fileloaded with memory in context

"Prefers short, bulleted team updates."

Email this week's update to my team.

Sent - short and bulleted, the way you like it.
...
I'm coordinating the November leadership summit - about 250 people, working back from a Nov 12 date. Help me get organized?

Happy to. I'll remember the summit is your main project right now, so you won't have to re-explain it tomorrow.

memory file · end of Mon

# Memory

- Coordinating the November leadership summit (~250 attendees, working back from Nov 12)+ new

1 / 5 days seen

Next day: Tue

1 session = 1 day here for simplicity. In practice, sessions and days aren't 1:1.
...
## Prepended context[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
written by Anthropic (the app's developers)

Instructions that define Claude's role, tone, and guardrails inside Cowork.

```
You are Claude, operating inside a product called Cowork. Your goal is to help the user accomplish work tasks. You have access to the user's connected tools, memory, and skills. When the user asks you to take an action, prefer using a tool over describing what you would do …
```
...
An illustrative mock-up of what Claude sees before your first message arrives. Contents and token counts in this diagram are representative, but not byte-accurate to the current state of any specific Claude product.
...
## Agentic context[](https://academy.claude.com/tutorials/parametric-memory-and-context)
...
- `calendar_list_events`List events on the user's calendar.
- `messages_read`Read recent messages from a team channel.
...
The six highlighted phrases in this Cowork reply came from a prepended source. Click each phrase and identify the most likely source.

Cowork · replying to: “When's the venue walkthrough for the summit? And can you let the team know I'll be joining remotely?”

Short version: the venue walkthrough is **Thursday at 2:00 pm** (Pacific), and Dana has already accepted.

I can email the team to say you'll be joining remotely - I'd copy Dana, since she gets your Friday recaps, unless you'd rather choose the recipients yourself. Want me to go ahead?

Tip: click a dotted phrase to open the source picker. You can change your answer by clicking the phrase again.

0 of 6 tagged

Reveal answers

## What you can do now[](https://academy.claude.com/tutorials/parametric-memory-and-context)
