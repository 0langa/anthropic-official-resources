...
## What this connector provides[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
...
## Setting up the Blender connector[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
...
### **Prerequisites**[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
...
### **Step 1: Add the connector in Claude Desktop**[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
...
### **Step 3: Start the connection**[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
...
## Example use cases[](https://academy.claude.com/tutorials/using-the-blender-connector-in-claude)
