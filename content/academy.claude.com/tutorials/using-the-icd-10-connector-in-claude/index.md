...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-icd-10-connector-in-claude)
...
## **Who should use the ICD-10 integration**[](https://academy.claude.com/tutorials/using-the-icd-10-connector-in-claude)
...
## **Setting up the ICD-10 integration**[](https://academy.claude.com/tutorials/using-the-icd-10-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-icd-10-connector-in-claude)
