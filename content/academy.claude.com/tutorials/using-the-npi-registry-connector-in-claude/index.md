...
## What this integration provides[](https://academy.claude.com/tutorials/using-the-npi-registry-connector-in-claude)
...
## Who should use the NPI Registry integration[](https://academy.claude.com/tutorials/using-the-npi-registry-connector-in-claude)
...
## Setting up the NPI Registry integration[](https://academy.claude.com/tutorials/using-the-npi-registry-connector-in-claude)
...
## Example use cases[](https://academy.claude.com/tutorials/using-the-npi-registry-connector-in-claude)
