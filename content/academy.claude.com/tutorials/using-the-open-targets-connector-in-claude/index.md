...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-open-targets-connector-in-claude)
...
## **Who should use the Open Targets integration**[](https://academy.claude.com/tutorials/using-the-open-targets-connector-in-claude)
...
## **Who can access the Open Targets integration**[](https://academy.claude.com/tutorials/using-the-open-targets-connector-in-claude)
...
## **Setting up the Open Targets integration**[](https://academy.claude.com/tutorials/using-the-open-targets-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-open-targets-connector-in-claude)
