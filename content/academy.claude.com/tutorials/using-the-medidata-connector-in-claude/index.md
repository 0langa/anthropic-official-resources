...
## **What this integration provides**[](https://academy.claude.com/tutorials/using-the-medidata-connector-in-claude)
...
## **Who should use the Medidata integration**[](https://academy.claude.com/tutorials/using-the-medidata-connector-in-claude)
...
## **Who can access the Medidata integration**[](https://academy.claude.com/tutorials/using-the-medidata-connector-in-claude)
...
## **Setting up the Medidata integration**[](https://academy.claude.com/tutorials/using-the-medidata-connector-in-claude)
...
## **Example use cases**[](https://academy.claude.com/tutorials/using-the-medidata-connector-in-claude)
