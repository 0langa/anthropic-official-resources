...
## Meet the four models[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
## When to use each model[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
### Use Haiku for:[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
### Use Sonnet for:[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
### Use Opus for:[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
## What this looks like in practice[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)

Let's see how this plays out with a few common tasks.

<table class="w-full text-body"><thead><tr><th class="border-b border-strong p-sm text-left font-medium">Task</th><th class="border-b border-strong p-sm text-left font-medium">Pick</th><th class="border-b border-strong p-sm text-left font-medium">Why</th></tr></thead><tbody><tr><td class="border-b p-sm">Summarizing articles</td><td class="border-b p-sm">Haiku</td><td class="border-b p-sm">Straightforward content extraction without complex reasoning</td></tr><tr><td class="border-b p-sm">Debugging code</td><td class="border-b p-sm">Sonnet</td><td class="border-b p-sm">Exceptional coding capabilities, fast feedback, and clear bug identification</td></tr><tr><td class="border-b p-sm">Analyzing complex research papers</td><td class="border-b p-sm">Opus</td><td class="border-b p-sm">Deep analysis across long specialized documents, including methodology critique and forward-looking insights</td></tr><tr><td class="border-b p-sm">Building a working project from a rough idea</td><td class="border-b p-sm">Fable</td><td class="border-b p-sm">Plans the steps, checks its own work, and keeps working on long tasks with fewer mid-task check-ins</td></tr></tbody></table>

## Try the same task on two models[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
...
## Choosing models over time[](https://academy.claude.com/tutorials/choosing-the-right-claude-model)
