...
## What you can do[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
## In this video[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)

Follow along with the video, or copy these prompts to try in your own workbook.

### 0:51 — Get oriented in an inherited model[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 1:18 — Claude maps data flow and finds errors[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 1:57 — Investigate a broken formula[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 2:33 — Choose how to fix it[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 3:18 — Run a what-if scenario[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 4:26 — Create a pivot table and chart[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
### 5:33 — Build a calculated column with business logic[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
## What to notice[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
...
## Get started[](https://academy.claude.com/tutorials/how-to-use-claude-in-excel-for-hr-headcount-planning)
