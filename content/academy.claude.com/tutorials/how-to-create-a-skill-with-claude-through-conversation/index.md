...
Embedded media: https://www.youtube-nocookie.com/embed/kS1MJFZWMq4?enablejsapi=1&origin=https%3A%2F%2Facademy.claude.com&rel=0

[Watch on YouTube(opens in new tab)](https://www.youtube.com/watch?v=kS1MJFZWMq4)
...
## Creating a skill through conversation[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### 1. Start a conversation[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### 2. Answer Claude's questions[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### 3. Claude builds the Skill[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### 4. Activate and test the skill[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
## Skills you can build[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
## What you can include within a skill[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### Reference materials and assets[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### Scripts[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
## Additional Resources[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)

### Getting started[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
...
### Going deeper[](https://academy.claude.com/tutorials/how-to-create-a-skill-with-claude-through-conversation)
