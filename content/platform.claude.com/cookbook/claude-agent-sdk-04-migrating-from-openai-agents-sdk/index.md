...
![Preston Tuggle](https://github.com/preston-tuggle.png)
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">OpenAI Agents SDK</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Claude Agent SDK</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">Agent(name, instructions, tools)</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ClaudeAgentOptions</code> + system prompt</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@function_tool</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@tool</code> + <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">create_sdk_mcp_server</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@input_guardrail</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Plain function before the loop (or <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">UserPromptSubmit</code> hook)</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@output_guardrail</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Plain function on <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ResultMessage.result</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">Runner.run(agent, msg)</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ClaudeSDKClient</code> context manager</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">Sessions</code> (client-managed)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Reuse the same <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ClaudeSDKClient</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">conversation_id</code> (server-managed)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">resume=session_id</code> (disk-backed)</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Built-in tracing dashboard</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">OTel-native — plugs into your existing Grafana/Datadog/Honeycomb</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">handoffs=[...]</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">AgentDefinition</code> + Agent tool — see appendix</td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">Agent(...)</code> field</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ClaudeAgentOptions</code> equivalent</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">instructions=...</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">system_prompt=...</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">tools=[fn]</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">mcp_servers={...}</code> + <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">allowed_tools=[...]</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">model=...</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">model=...</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">name=...</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Not needed — options are a config value, not a named entity. Subagent names go on <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">AgentDefinition</code> (see appendix).</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">input_guardrails=[...]</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Called in your run function — see next section</td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">OAI</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Claude</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@input_guardrail</code> decorator</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Plain function called before the loop</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">@output_guardrail</code> decorator</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Plain function called on <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">result.result</code> after the loop</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">tripwire_triggered=True</code> raises</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Return early (input) or override result (output)</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Registered on <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">Agent(input_guardrails=[...])</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Called in your run function</td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Event</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Contains</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">SystemMessage</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Session init metadata</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">AssistantMessage</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Text blocks or tool-use blocks</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">UserMessage</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool-result blocks</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ResultMessage</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Always last: <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">.result</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">.usage</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">.total_cost_usd</code></td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">OAI mode</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Durability</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Claude equivalent</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">result.to_input_list()</code> + re-send</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Client holds history in memory</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Reuse one <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">ClaudeSDKClient</code> — call <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">.query()</code> again on the same open context</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">conversation_id</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Server-side, survives process restarts</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">resume=session_id</code> — conversation transcript is written to disk locally, survives restarts</td></tr></tbody></table>
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/claude_agent_sdk/04_migrating_from_openai_agents_sdk.ipynb)
