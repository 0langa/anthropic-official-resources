...
![Henry Keetay](https://avatars.githubusercontent.com/u/227475578?v=4)
...
- [Tool Search Tool Documentation(opens in new tab)](https://docs.anthropic.com/en/docs/build-with-claude/tool-use) - Official documentation on the tool search pattern

Was this page helpful?



[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/tool_search_with_embeddings.ipynb)
