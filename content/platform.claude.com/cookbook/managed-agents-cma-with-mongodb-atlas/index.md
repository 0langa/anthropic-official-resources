[Claude Managed Agents](https://platform.claude.com/cookbook/?category=Claude+Managed+Agents)[RAG & Retrieval](https://platform.claude.com/cookbook/?category=RAG+%26+Retrieval)[Integrations](https://platform.claude.com/cookbook/?category=Integrations)[Tools](https://platform.claude.com/cookbook/?category=Tools)

[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/managed_agents/CMA_with_mongodb_atlas.ipynb)
...
![Mohammad Daoud Farooqi](https://avatars.githubusercontent.com/u/179705398?v=4)
...
1. [Connect MongoDB to a managed agent](https://platform.claude.com/cookbook/managed-agents-cma-with-mongodb-atlas)
2. [Retrieve: four patterns, one engine](https://platform.claude.com/cookbook/managed-agents-cma-with-mongodb-atlas)
3. [The end-to-end agent: human-in-the-loop fraud review](https://platform.claude.com/cookbook/managed-agents-cma-with-mongodb-atlas)
4. [MongoDB Atlas as the system of record and audit backbone](https://platform.claude.com/cookbook/managed-agents-cma-with-mongodb-atlas)
5. [Recap](https://platform.claude.com/cookbook/managed-agents-cma-with-mongodb-atlas)
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Pattern</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Builder</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">MongoDB stage</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Vector search</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">build_vector_pipeline</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">$vectorSearch</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Full-text search</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">build_lexical_pipeline</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">$search</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Hybrid (reciprocal rank fusion)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">build_rank_fusion_pipeline</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">$rankFusion</code> (8.0+)</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Graph traversal</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">build_graph_pipeline</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">$graphLookup</code></td></tr></tbody></table>
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/managed_agents/CMA_with_mongodb_atlas.ipynb)
