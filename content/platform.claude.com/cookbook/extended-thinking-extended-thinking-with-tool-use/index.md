[Thinking](https://platform.claude.com/cookbook/?category=Thinking)[Tools](https://platform.claude.com/cookbook/?category=Tools)

[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/extended_thinking/extended_thinking_with_tool_use.ipynb)
...
- [Setup](https://platform.claude.com/cookbook/extended-thinking-extended-thinking-with-tool-use)
- [Basic example](https://platform.claude.com/cookbook/extended-thinking-extended-thinking-with-tool-use)
- [Multiple tool calls](https://platform.claude.com/cookbook/extended-thinking-extended-thinking-with-tool-use)
- [Preserving thinking blocks](https://platform.claude.com/cookbook/extended-thinking-extended-thinking-with-tool-use)
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/extended_thinking/extended_thinking_with_tool_use.ipynb)
