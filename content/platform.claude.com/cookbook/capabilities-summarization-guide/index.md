[RAG & Retrieval](https://platform.claude.com/cookbook/?category=RAG+%26+Retrieval)[Responses](https://platform.claude.com/cookbook/?category=Responses)
...
1. [Setup](https://platform.claude.com/cookbook/capabilities-summarization-guide)
2. [Data Preparation](https://platform.claude.com/cookbook/capabilities-summarization-guide)
3. [Basic Summarization](https://platform.claude.com/cookbook/capabilities-summarization-guide)
4. [Multi-Shot Basic Summarization](https://platform.claude.com/cookbook/capabilities-summarization-guide)
5. [Advanced Techniques](https://platform.claude.com/cookbook/capabilities-summarization-guide)
   - [Guided Summarization](https://platform.claude.com/cookbook/capabilities-summarization-guide)
   - [Domain-Specific Guided Summarization](https://platform.claude.com/cookbook/capabilities-summarization-guide)
   - [Meta-Summarization](https://platform.claude.com/cookbook/capabilities-summarization-guide)
6. [Summary Indexed Documents: An Advanced RAG Approach](https://platform.claude.com/cookbook/capabilities-summarization-guide)
   - [Best Practices for Summarization Rag](https://platform.claude.com/cookbook/capabilities-summarization-guide)
7. [Evaluations](https://platform.claude.com/cookbook/capabilities-summarization-guide)
8. [Iterative Improvement](https://platform.claude.com/cookbook/capabilities-summarization-guide)
9. [Conclusion and Best Practices](https://platform.claude.com/cookbook/capabilities-summarization-guide)
