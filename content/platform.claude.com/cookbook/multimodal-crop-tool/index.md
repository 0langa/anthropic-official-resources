...
![Nadine Yasser](https://avatars.githubusercontent.com/u/238355370?v=4)

Nadine Yasser

@nadine-anthropic

![Brad Abrams](https://avatars.githubusercontent.com/u/718350?v=4)
...
Two facts about [how Claude processes images(opens in new tab)](https://platform.claude.com/docs/en/build-with-claude/vision) shape the design of the tool:
