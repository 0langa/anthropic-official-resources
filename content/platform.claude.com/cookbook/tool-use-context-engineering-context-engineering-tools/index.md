...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">API</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Identifier</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Beta header</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Triggered by</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Configurable knobs</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Compaction</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">compact_20260112</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">compact-2026-01-12</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Token threshold (server-side, min 50K)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">trigger</code> (default 150K), <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">instructions</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">pause_after_compaction</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool clearing</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">clear_tool_uses_20250919</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">context-management-2025-06-27</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Token threshold (server-side)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">trigger</code> (default 100K), <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">keep</code> (default 3 tool uses), <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">clear_at_least</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">exclude_tools</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">clear_tool_inputs</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Memory tool</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">memory_20250818</code></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">none (standalone)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">The model (it's a tool call)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Client implements: <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">view</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">create</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">str_replace</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">insert</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">delete</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">rename</code></td></tr></tbody></table>
...
The `instructions` parameter lets you replace the default summarization prompt entirely. The [compaction docs(opens in new tab)](https://platform.claude.com/docs/en/build-with-claude/compaction) give the default prompt verbatim:
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Primitive</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Operates on</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">What's traded away</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Solves</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><strong class="font-semibold text-primary">Compaction</strong></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">The whole conversation in the current window</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Verbatim detail compressed into a summary; obscure specifics may be lost</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">All in-session growth</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><strong class="font-semibold text-primary">Clearing</strong></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool results in the current window</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Old tool results are gone from context (must re-fetch if needed again)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool-result bloat</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><strong class="font-semibold text-primary">Memory</strong></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">External storage, across windows</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool-call overhead; only as good as what the agent chose to save</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Cross-session persistence</td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">If your workload has...</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Worth trying first</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Watch for</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Sessions spanning days or weeks</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Memory tool</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool-call overhead; stale memory if facts change</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">An agent that should learn user preferences across sessions</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Memory tool</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">PII/sensitive data policy; stale preferences if the user changes their mind</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Large, re-fetchable tool results</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Clearing</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Agent re-reading what was just cleared; tune <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">keep</code> and trigger</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Dialogue as the primary context</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Compaction</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Specific figures getting summarized away</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Tool results that aren't easily re-fetchable (ephemeral APIs, uploads)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Compaction over clearing</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Summary fidelity on those specific results</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Every session should start fresh</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Skip memory</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Cross-session state you don't want</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Sessions stay well under the window</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Skip compaction</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Lossiness you don't need</td></tr></tbody></table>
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/tool_use/context_engineering/context_engineering_tools.ipynb)
