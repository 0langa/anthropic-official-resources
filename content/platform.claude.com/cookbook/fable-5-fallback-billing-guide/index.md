...
![Alexander Bricken](https://avatars.githubusercontent.com/u/44481408?v=4)

Alexander Bricken

@Briiick

![Mahesh Murag](https://avatars.githubusercontent.com/u/5667029?v=4)

Mahesh Murag

@maheshmurag

![Mikaela Grace](https://avatars.githubusercontent.com/u/6231796?v=4)
...
1. [What a classifier block looks like](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
2. [Server-side fallback (recommended)](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
3. [Streaming](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
4. [Billing changes](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
5. [Client-side fallback with the SDK](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
6. [Common anti-patterns](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide)
...
> **Note:** When you are **not** using the server-side fallback feature, `stop_details` also includes a `fallback_credit_token`, which you use to bill your fallback model request as a cache read — see [Billing changes](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide).
...
`recommended_model` is populated **only** in this case (fallbacks configured *and* the fallback couldn't execute). On a plain block with no fallbacks configured, it isn't present — which is why it's absent from the basic example in [section 1](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide).
...
- **sends the `fallback-credit-2026-06-01` beta header automatically on every request**, so you get the cache-read billing change from [section 4](https://platform.claude.com/cookbook/fable-5-fallback-billing-guide) without managing tokens yourself;
