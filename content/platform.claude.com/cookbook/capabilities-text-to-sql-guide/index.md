...
[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/capabilities/text_to_sql/guide.ipynb)
...
1. [Introduction](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
2. [Setup](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
3. [Creating a Basic Text to SQL Prompt](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
4. [Improving the Prompt with Examples](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
5. [Using Chain-of-Thought Prompting](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
6. [Implementing RAG for Complex Database Schemas](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
7. [Implementing Query Self-Improvement](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
8. [Evaluations](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
9. [Further Exploration & Next Steps](https://platform.claude.com/cookbook/capabilities-text-to-sql-guide)
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/capabilities/text_to_sql/guide.ipynb)
