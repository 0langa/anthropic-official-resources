...
[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/skills/notebooks/01_skills_introduction.ipynb)
...
1. [Setup & Installation](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
2. [Understanding Skills](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
3. [Discovering Available Skills](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
4. [Quick Start: Excel](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
5. [Quick Start: PowerPoint](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
6. [Quick Start: PDF](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
7. [Troubleshooting](https://platform.claude.com/cookbook/skills-notebooks-01-skills-introduction)
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Type</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Description</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Example</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><strong class="font-semibold text-primary">Anthropic-Managed</strong></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Pre-built skills maintained by Anthropic</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">xlsx</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">pptx</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">pdf</code>, <code class="relative inline bg-alpha-2 px-2 py-0.5 rounded text-sm font-mono break-words box-decoration-clone">docx</code></td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]"><strong class="font-semibold text-primary">Custom</strong></td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">User-defined skills for specific workflows</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Brand guidelines, financial models</td></tr></tbody></table>
...
<table class="bg-page min-w-full border-separate border-spacing-0 text-sm leading-[1.88888]"><thead class="border-b-[0.5px] text-left"><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Approach</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Token Cost</th><th class="text-primary px-2 [&amp;:not(:first-child)]:border-l-[0.5px]">Performance</th></tr></thead><tbody><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Manual instructions</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">5,000-10,000 tokens/request</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Variable quality</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Skills (metadata only)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Minimal (just name/description)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Expert-level</td></tr><tr class="[tbody&gt;&amp;]:odd:bg-alpha-1"><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Skills (full load)</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">~5,000 tokens when skill is used</td><td class="border-t-[0.5px] px-2 text-secondary [&amp;:not(:first-child)]:border-l-[0.5px]">Expert-level</td></tr></tbody></table>
...
[Back to Cookbook](https://platform.claude.com/cookbook/)[View on GitHub](https://github.com/anthropics/claude-cookbooks/blob/main/skills/notebooks/01_skills_introduction.ipynb)
