...
![Prithvi Rajasekaran](https://avatars.githubusercontent.com/u/64937816)
...
<table><tbody><tr><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">Without Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Baseline output without aesthetics guidance" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/baseline_saas.png"/></p></td><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">With Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Enhanced output with distilled aesthetics prompt" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/distilled_saas.png"/></p></td></tr></tbody></table>

###  Example 2: Blog Post

**Prompt:** `"Build a blog post layout with author bio, reading time, and related articles"`

<table><tbody><tr><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">Without Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Baseline portfolio without aesthetics guidance" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/baseline_portfolio.png"/></p></td><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">With Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Enhanced portfolio with distilled aesthetics prompt" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/distilled_portfolio.png"/></p></td></tr></tbody></table>

###  Example 3: Admin Table

**Prompt:** `"Create an admin panel with a data table showing users, their roles, and action buttons"`

<table><tbody><tr><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">Without Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Baseline dashboard without aesthetics guidance" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/baseline_dashboard.png"/></p></td><td valign="top" width="50%"><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><strong class="font-semibold text-primary">With Aesthetics Prompt</strong></p><p class="mb-4 last:mb-0 whitespace-pre-wrap break-words text-secondary"><img alt="Enhanced dashboard with distilled aesthetics prompt" class="max-w-full h-auto rounded-lg my-6" loading="lazy" src="https://platform.claude.com/cookbook/images/notebooks/coding-prompting-for-frontend-aesthetics/distilled_dashboard.png"/></p></td></tr></tbody></table>
