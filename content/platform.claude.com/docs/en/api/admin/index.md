...
- `UsageBucket object { data, data_refreshed_at, has_more, 2 more }`
  ...
  - `data: array of object { ending_at, results, starting_at }`
    ...
    - `results: array of object { cache_creation, cache_read_input_tokens, claude_tag_category, 12 more }`
...
- `UserUsage object { data, data_refreshed_at, has_more, 2 more }`
  ...
  - `data: array of object { actor, cache_creation, cache_read_input_tokens, 16 more }`
...
- `CostBucket object { data, data_refreshed_at, has_more, 2 more }`
  ...
  - `data: array of object { ending_at, results, starting_at }`
    ...
    - `results: array of object { amount, claude_tag_category, claude_tag_user_id, 12 more }`
...
- `UserCost object { data, data_refreshed_at, has_more, 2 more }`
  ...
  - `data: array of object { actor, amount, claude_tag_category, 15 more }`
...
- `UserActivity object { data, next_page }`
  ...
  - `data: array of object { chat_metrics, claude_code_metrics, cowork_metrics, 9 more }`
    ...
    - `claude_code_metrics: object { core_metrics, tool_actions }`
      ...
      - `core_metrics: object { artifacts_created_count, commit_count, distinct_session_count, 2 more }`
    ...
    - `cowork_metrics: object { action_count, artifacts_created_count, connectors_used_count, 14 more }`
