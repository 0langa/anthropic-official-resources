...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: f7cf3b8d8a2a101e */}
<Copy k="widget.description">
  Explorer: a mock plugin detail page lets the learner compare two plugin
  shapes by switching between a Legal plugin, labeled a function's toolkit,
  and an Experiment Readout plugin, labeled an end-to-end pipeline. Each shows
  the same kind of layout — metadata, a description, a grid of skill cards,
  and connectors — but the skills themselves differ: the Legal plugin's skills
  are independent jobs a team reaches for as needed, while the Experiment
  Readout plugin's skills read as sequential steps of one workflow. Clicking
  metadata fields, the customize control, the enabled toggle, the description,
  or the connectors reveals what each represents; clicking a skill expands
  what it does. The goal is to recognize that plugins package skills,
  connectors, and subagents into one of these two shapes, while outputs still
  require human review.
</Copy>
<Copy k="widget.summary">
  Explorer: a mock plugin detail page lets the learner switch between two
  sample plugins, one a function's toolkit and one an end-to-end pipeline,
  clicking metadata, toggle, description, skills, and connectors to reveal
