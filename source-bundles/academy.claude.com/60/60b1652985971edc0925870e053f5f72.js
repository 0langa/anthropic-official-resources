import{Qp as e,em as t}from"../../../../content-de-meta-ll4flgq0.js";var n=e();function r(e){let r={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...e.components},{LessonDownloads:i}=r;return i||a("LessonDownloads",!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.p,{children:"We're going to build a CLI-based chatbot that demonstrates how MCP clients and servers work together. This hands-on project will give you practical experience with both sides of the MCP architecture."}),`
...
`,(0,n.jsxs)(r.p,{children:["Download ",(0,n.jsx)(r.code,{children:"cli_project.zip"})," from the Downloads section at the end of this lesson and extract it to your preferred development directory. Open your code editor in the project folder."]}),`
...
`,(0,n.jsx)(r.p,{children:"The starter project already includes basic chat functionality with Claude. In the following videos, we'll add MCP server capabilities and document management features to create a fully functional document-aware chatbot."}),`
`,(0,n.jsx)(i,{})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};