...
`,(0,n.jsxs)(r.p,{children:["The ",(0,n.jsx)(r.code,{children:"@mcp.tool"})," decorator and its signature-based schema generation come from the MCP Python SDK. The ",(0,n.jsxs)(r.a,{href:"https://code.claude.com/docs/en/agent-sdk/custom-tools",children:["Claude Agent SDK provides a separate ",(0,n.jsx)(r.code,{children:"@tool"})," decorator"]})," for defining custom tools, and it expects an explicit ",(0,n.jsx)(r.code,{children:"input_schema"})," argument rather than pydantic ",(0,n.jsx)(r.code,{children:"Field"})," annotations on the function signature. In Python that schema is a dict mapping parameter names to types, like ",(0,n.jsx)(r.code,{children:'{"latitude": float}'}),", which the Agent SDK converts to JSON Schema for you, or a full JSON Schema dict when you need enums, ranges, optional fields, or nested objects. When you read tool code elsewhere, check which SDK it imports, since the two decorators are easy to confuse."]})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}export{i as default};