...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 2eb334e7d68f90ba */}
<Copy k="widget.description">
  Exercise: the learner answers intake questions about their own organization
  — which functions join the first wave, whether a named data-risk owner
  exists, who runs identity and provisioning, whether any regulated data or
  work is involved, whether a budget owner can commit spend, and how many
  enterprise contracts or identity providers exist. These answers resolve five
  deployment decisions, each as soon as its own answers are in: Structure &
  Identity, Access, Governance, Spend, and Visibility. One triggering answer
  can flag a decision for extra attention at once, with a stated reason; a
  decision only settles as unaffected once all the answers it depends on are
  in. The goal is to surface which decisions need broader involvement or more
  care at the learner's own company before decisions are made, and the result
  can be copied as a summary for later reference.
</Copy>
<Copy k="widget.summary">
  Exercise: the learner answers intake questions about their own
  organization's functions, identity setup, regulated work, and budget owner,
  which flag which of five deployment decisions need extra attention and why,
  with a copyable summary.
</Copy>
`;export{e as default};