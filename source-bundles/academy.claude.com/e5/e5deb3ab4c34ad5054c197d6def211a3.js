...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 6f9f72bf490a20c0 */}
<Copy k="widget.description">
  Film: a walkthrough of using Claude, via a vendor-review skill, to prepare
  for a contract renewal negotiation. The user asks Claude to compare the
  signed agreement against a renewal proposal, pulling in team Slack
  discussion, usage data, and competing quotes. Claude reads these sources,
  asks the user a judgment question about whether switching vendors is a
  realistic alternative, then produces a redline table listing every material
  contract change with a recommended position beside it, plus a one-page
  negotiation brief covering leverage, likely vendor pushback, ranked
  negotiating asks, and a confirmed walk-away position. It closes by showing
  how this process can be scheduled to run automatically for upcoming
  renewals. It teaches how Claude can turn scattered documents and
  conversations into a structured, negotiation-ready brief.
</Copy>
<Copy k="widget.summary">
  Film: the user asks Claude to compare a signed vendor agreement against a
  renewal proposal using contracts, Slack discussion, usage data, and quotes.
  Claude asks a judgment question, then produces a redline table and
  negotiation brief, and can be scheduled to run for future renewals.
</Copy>
`;export{e as default};