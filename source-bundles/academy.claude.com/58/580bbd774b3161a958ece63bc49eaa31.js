...
`,(0,n.jsxs)(r.p,{children:["Claude Code installs it and prints a short summary. Either it says the plugin is already active in this session, or it mentions ",(0,n.jsx)(r.code,{children:"/reload-plugins"})," and Claude Code runs that reload for you. You step in only if the reload warns that your next message would re-read the whole conversation: run ",(0,n.jsx)(r.code,{children:"/reload-plugins --force"})," to activate the plugin anyway."]}),`
...
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Name is the only required field."})," It namespaces your skills as ",(0,n.jsx)(r.code,{children:"/plugin-name:skill-name"}),", so a skill in this plugin runs as ",(0,n.jsx)(r.code,{children:"/svg-splitter-review:<skill-name>"}),". That keeps your skills from colliding with anyone else's."]}),`
...
`]}),`
`,(0,n.jsx)(r.p,{children:"That's the whole point. One installable unit, and the setup you trust reaches your entire team."})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};