...
<Copy k="kind.slides.sub">Claude Slides · Only you</Copy>
...
<Copy k="kind.design.sub">Claude Design · Only you</Copy>
...
<Copy k="kind.docs.sub">Claude Docs · Anyone at {org}</Copy>
...
{/* Written from this widget's copy or code by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy or code. described-from: a6a6e01956b64f2b */}
<Copy k="widget.description">
  Explorer: five tabs show the forms a Claude response can take, each with its
  own sample conversation. Plain text is the default written answer. Inline
  visuals are diagrams or charts drawn in the reply, here a process flow.
  Artifacts are work products that open beside the chat, in four kinds:
  Design, editable artboards in a design system; Slides, a deck with an
  editor, a download menu, a present mode, and a comment that Claude acts on;
  Docs, a shared document the team comments on; and Interactive, a small tool
  Claude builds, here a room planner with pieces to drag. Files are generated
  files to download, such as a spreadsheet with working formulas, a PDF, and a
  PowerPoint deck, each with a preview. Cards are ready-made answers for the
  weather, a recipe, a hike with a map, and a playlist. Each tab suggests ways
  to ask for that form, teaching that you can ask for the form the task needs.
</Copy>
<Copy k="widget.summary">
  Explorer: a five-tab carousel showing the different forms a Claude response
  can take, from plain text and inline diagrams to editable artifacts,
  generated files, and ready-made cards, teaching that the right form depends
  on what's asked for.
</Copy>
`;export{e as default};