...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 505dd483b4dfba8e */}
<Copy k="widget.description">
  Film: a use-case walkthrough showing Cowork used to create on-brand
  marketing content. The user asks Claude, via a marketing skill, to draft a
  full content set (blog post, landing page copy, an email sequence, and ad
  copy) from a campaign brief, instructed to hold the brand voice and approved
  messaging exactly and to flag anywhere the brief is thin. Claude reads the
  brief, brand guidelines, past top-performing pieces, and approved messaging,
  then writes the drafted files back to the working folder, reproducing
  approved lines word for word and marking unclear or missing details rather
  than inventing them. The film also shows scheduling this process to run
  automatically on new briefs. It teaches that Cowork can draft consistent,
  on-brand content across formats while transparently surfacing gaps for human
  review.
</Copy>
<Copy k="widget.summary">
  Film: the user asks Claude to draft a full on-brand content set from a
  campaign brief, and the film shows it reading brand guidelines and past
  pieces, reproducing approved messaging word for word, and flagging thin
  spots instead of inventing details.
</Copy>
`;export{e as default};