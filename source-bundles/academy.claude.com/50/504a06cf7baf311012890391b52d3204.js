...
`,(0,n.jsx)(d,{title:"Now in your Cowork",plugins:[{slug:"human-resources"}],tools:[{slug:"google-drive"}],folder:"Hiring",next:{label:"Interview debrief synthesis",slug:"interview-debrief"},children:(0,n.jsx)(r.p,{children:"Every role you open gets the same structured intake and a complete spec in your standard format, with open questions listed for the recruiter — ready before the first call."})})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};