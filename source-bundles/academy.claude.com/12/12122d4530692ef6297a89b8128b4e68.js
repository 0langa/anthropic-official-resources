...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: ee733069ab553cac */}
<Copy k="widget.description">
  Explorer: this widget lets the learner switch between three example Cowork
  project setups built around different kinds of work: a customer account, a
  recurring deliverable, and a launch. For each, it displays the project's
  scoped instructions, its scheduled recurring tasks, and its context sources,
  broken into files or folders on the learner's computer, links to external
  tools, and memory that accumulates automatically from conversations inside
  the project. Each example closes with a caption explaining why that stream
  of work suits a dedicated project. The goal is to show the four components
  that make up a Cowork project and how their makeup shifts depending on the
  kind of work the project scopes.
</Copy>
<Copy k="widget.summary">
  Explorer: toggle between three example Cowork project setups—a customer
  account, a recurring deliverable, and a launch—to see how instructions,
  scheduled tasks, context, and memory shift for each kind of work.
</Copy>
`;export{e as default};