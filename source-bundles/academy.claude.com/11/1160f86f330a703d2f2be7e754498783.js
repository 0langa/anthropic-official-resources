...
{/* Written from this widget's copy or code by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy or code. described-from: 3d1a995fd6222c10 */}
<Copy k="widget.description">
  Diagram: a worked example links an income statement to the
  operating-activities section of a cash flow statement, showing how accrual
  net income is reconciled to actual cash. Hand-drawn-style annotations trace
  each adjustment: depreciation is added back because it reduced reported
  profit without moving cash; an increase in accounts receivable is subtracted
  because that revenue hasn't been collected yet; an increase in accounts
  payable is added back because the expense was booked but not yet paid. A
  summary rule states the general pattern: non-cash expenses get added back,
  rising operating assets get subtracted, and rising operating liabilities get
  added. Clicking individual adjustment lines offers follow-up questions to
  explore each one further. The goal is to replace memorized sign rules with
  an understanding of why each adjustment moves cash up or down relative to
  accrual profit.
</Copy>
<Copy k="widget.summary">
  Diagram: annotated arrows link an income statement to the
  operating-activities section of a cash flow statement, showing how accrual
  net income reconciles to actual cash. Clickable adjustment lines offer
  follow-up questions, teaching why each item is added or subtracted rather
  than memorized.
</Copy>
`;export{e as default};