...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.a,{href:"https://www.anthropic.com/webinars/claude-code-maximizing-value",children:(0,n.jsx)(r.strong,{children:"Maximizing value from Claude Code"})}),": a recorded webinar on where a session's tokens go, how to pick the right model and effort level, and what CLAUDE.md and MCP servers add to every turn, from the Claude Code team."]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.a,{href:"https://platform.claude.com/docs/en/about-claude/models/optimizing-for-cost-and-intelligence",children:(0,n.jsx)(r.strong,{children:"Optimizing for cost and intelligence"})}),": measured results for effort, prompt caching, and model choice, compared on cost per task, from the Claude Platform docs."]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.a,{href:"https://platform.claude.com/cookbook/cost-optimization-cost-optimization",children:(0,n.jsx)(r.strong,{children:"Cost Optimization on the Claude API"})}),": cost levers applied one at a time to a working agent, for Platform builders, from the Claude Cookbook."]}),`
