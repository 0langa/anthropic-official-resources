import{Hf as e,Wf as t}from"../../../../../content-es-meta-ejw6i4rz.js";var n=e(),r=`# How Claude Code works
...
`,(0,n.jsxs)(i.li,{children:[(0,n.jsx)(i.strong,{children:`Manual (the default):`}),` Claude asks for explicit permission before editing a file or running a shell command.`]}),`
...
`,(0,n.jsx)(i.p,{children:`Claude Code combines several agentic concepts: an agentic loop, a managed context window, tools, and configurable permissions — all inside your terminal. It can read your codebase, take action, and verify its own work. That's what makes it fundamentally different from a chat window.`})]})}function a(e={}){let{wrapper:r}={...t(),...e.components};return r?(0,n.jsx)(r,{...e,children:(0,n.jsx)(i,{...e})}):i(e)}function o(e,t){throw Error(`Expected `+(t?`component`:`object`)+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default};