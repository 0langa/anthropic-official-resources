...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 21dbb45f14c2a3fb */}
<Copy k="widget.description">
  Explorer: a four-tab lab lets learners examine a food-delivery app mockup
  through four UX principles AI often gets wrong by default: clarity,
  hierarchy, accessibility, and feedback. Each tab shows a flawed version of
  the screen; hovering over individual elements reveals why that element fails
  the principle (for example, unlabeled icons, buried critical information,
  color-only status signals, jargon, or raw error codes). A toggle swaps in a
  corrected version of the same screen so learners can compare the flawed and
  fixed designs directly. The goal is to build design literacy for working
  with AI: recognizing specific, nameable UX problems rather than vague
  dissatisfaction, and understanding that accessibility and clear feedback
  must be deliberately specified, not assumed.
</Copy>
<Copy k="widget.summary">
  Explorer: a four-tab lab shows a food-delivery app mockup with flawed
  designs for clarity, hierarchy, accessibility, and feedback, where hovering
  reveals each flaw and a toggle shows the corrected version.
</Copy>
`;export{e as default};