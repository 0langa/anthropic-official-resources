...
`,(0,n.jsx)(r.p,{children:`Before diving into temperature, it helps to understand Claude's text generation process. When you send Claude a prompt like "What do you think?", it goes through three key steps:`}),`
...
`,(0,n.jsx)(r.p,{children:'In this example, Claude might assign a 30% probability to "about", 20% to "would", 10% to "of", and so on. The model then selects one token and repeats this entire process to build complete sentences.'}),`
...
`,(0,n.jsx)(r.h2,{id:"interactive-temperature-demo",children:"Interactive Temperature Demo"}),`
`,(0,n.jsx)(r.p,{children:"You can see temperature in action with Claude's interactive demo. Watch how the probability distribution changes as you adjust the temperature slider:"}),`
`,(0,n.jsx)(r.p,{children:(0,n.jsx)(r.img,{src:"./ad9d8c12ce4f.png",alt:""})}),`
`,(0,n.jsx)(r.p,{children:'At temperature 0.0, "about" gets 100% probability - completely deterministic. At temperature 1.0, probabilities spread more evenly across all possible tokens, introducing randomness and creativity.'}),`
`,(0,n.jsx)(r.h2,{id:"choosing-the-right-temperature",children:"Choosing the Right Temperature"}),`
`,(0,n.jsx)(r.p,{children:"Different tasks call for different temperature ranges:"}),`
...
`})}),`
`,(0,n.jsx)(r.p,{children:`At temperature 0.0, you might consistently get responses like "A time-traveling archaeologist must prevent ancient artifacts from being stolen." At temperature 1.0, you'll see much more variety in themes, characters, and plot elements.`}),`
`,(0,n.jsx)(r.h2,{id:"key-takeaways",children:"Key Takeaways"}),`
`,(0,n.jsx)(r.p,{children:"Remember that temperature doesn't guarantee different outputs - it just changes the probability of getting them. Even at high temperatures, Claude might occasionally produce similar responses. The key is matching your temperature choice to your specific use case:"}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsx)(r.li,{children:"Need consistent, factual responses? Use low temperature"}),`
`,(0,n.jsx)(r.li,{children:"Want creative brainstorming? Dial up the temperature"}),`
`,(0,n.jsx)(r.li,{children:"Somewhere in between? Medium temperatures work well for most general tasks"}),`
`]}),`
`,(0,n.jsx)(r.p,{children:"Temperature is one of the most practical parameters you can adjust to fine-tune Claude's behavior for your specific needs."})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}export{i as default};