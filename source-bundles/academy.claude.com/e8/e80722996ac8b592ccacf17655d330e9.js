...
`,(0,n.jsx)(r.p,{children:"The next lesson covers which Claude surfaces you’ll grant to each group, along with how to phase that access and how the model defaults, organization-wide and per role, decide what each group runs on."})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};