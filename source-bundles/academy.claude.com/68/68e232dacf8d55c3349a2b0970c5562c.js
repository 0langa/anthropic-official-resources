...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"In the chat bar"}),", pick a place Claude can read, edit, and save to (a working folder in the desktop app, or a project), so every brief lands somewhere you can find it later."]}),`
`]}),`
