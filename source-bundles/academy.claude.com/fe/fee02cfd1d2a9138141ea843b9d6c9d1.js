...
`,(0,n.jsxs)(r.p,{children:["Extended thinking lets Claude reason step by step before producing a final response. When it's enabled, Claude generates internal reasoning tokens — often called a ",(0,n.jsx)(r.strong,{children:"chain of thought"})," — and then delivers the answer. On Claude Opus 5, the thinking text stays hidden unless your request's ",(0,n.jsx)(r.code,{children:"thinking"})," setting includes ",(0,n.jsx)(r.code,{children:'"display": "summarized"'}),", as the example below does. When it does, a summary of Claude's reasoning comes back in the response alongside the final text."]}),`
...
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Extended thinking"})," gives Claude room to reason before it answers. On Opus 5, the response carries a summary of that reasoning only when you ask for it."]}),`
