import{Nm as e,jm as t}from"../../../content-de-meta-mdrrzgmt.js";var n=t();function r(t){let r={a:"a",em:"em",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e(),...t.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h2,{id:"introduction",children:"Introduction"}),`
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Claude Desktop app:"})," Required for work on local files, desktop applications, or the browser. Available for macOS, Windows, and Linux (Debian and Ubuntu, in beta). Claude Cowork is also available on the web and in the Claude mobile app, subject to your organization's settings."]}),`
...
`,(0,n.jsx)(r.p,{children:"Claude Cowork introduces a fundamentally different way of working with Claude. In a chat, users collaborate — prompting back and forth to work toward an answer together. In Claude Cowork, users delegate — they describe a task, provide context and tools, define what good looks like, and come back to finished work."}),`
...
`,(0,n.jsx)(r.p,{children:"Stage your communications so users know what’s coming, why it matters, and where to go for help. Claude Cowork works with your files, tools, and browser and hands back finished work — it's a different experience from asking Claude questions, and your messaging should set that expectation."}),`
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.a,{href:"/collections/collaborating-with-ai",children:"Collaborating with AI"})," — broader AI literacy for users new to working with AI."]}),`
