...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: b07c12dfa0b790b1 */}
<Copy k="widget.description">
  Exercise: Following a sample creative project, the learner steps through six
  moments in a comic artist's collaboration with AI and, for each one, chooses
  from two or three offered competencies (Delegation, Description,
  Discernment, or Diligence), receiving feedback on each choice. A final map
  arranges the six moments into the Two Nested Loops model, with an outer loop
  bracketing the whole project and an inner loop nested within the work
  itself. The exercise's goal is to show how the inner loop nests inside the
  outer one, and that fluent AI use means moving between them.
</Copy>
<Copy k="widget.summary">
  Exercise: Step through six moments of a sample creative AI collaboration,
  choosing from a short set of competencies for each one, then reveal how they
  map onto the Two Nested Loops model.
</Copy>
`;export{e as default};