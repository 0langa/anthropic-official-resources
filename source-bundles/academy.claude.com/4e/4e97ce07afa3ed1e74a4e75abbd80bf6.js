...
{/* Written from this widget's copy or code by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy or code. described-from: 30407ca5d5ea3b93 */}
<Copy k="widget.description">
  Simulation: learners adjust a team's size (1 to 8 people), choose whether
  everyone uses AI privately or agents work in a shared team channel, and set
  a time span (1, 4, or 12 weeks), then watch three metrics respond: duplicate
  requests made, versions of a recurring summary produced, and posts a new
  hire could later search. When everyone works alone, each person's assistant
  repeats the same recurring questions and produces its own slightly different
  summary, none of it searchable. When agents work in a shared channel, a
  question gets asked and answered once, producing a single shared summary and
  a growing, searchable record. The goal is to show how siloed single-player
  AI use creates duplicated effort and untraceable knowledge as a team grows,
  while shared, multiplayer use consolidates answers and leaves a record
  others can build on.
</Copy>
<Copy k="widget.summary">
  Simulation: adjust team size, choose private AI use versus agents in a
  shared channel, and set a time span to see duplicate requests, summary
  versions, and searchable posts change, showing how shared AI use reduces
  duplicated work as teams grow.
</Copy>
`;export{e as default};