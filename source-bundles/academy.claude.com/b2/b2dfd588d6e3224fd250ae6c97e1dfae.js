...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: c788bc22d614f8c9 */}
<Copy k="widget.description">
  Explorer: a still depiction of the claude.ai message composer holding one
  worked example prompt, built from a short message plus one attached file. A
  numbered legend explains that a good prompt gives Claude context (what the
  work is for), the task (what you want back), the format (length and shape of
  the answer), and the material (an attached file Claude works from). Below
  that, four selectable controls correspond to parts of the composer: adding
  files, connecting tools such as email, calendar, drive, or chat through
  connectors, choosing the output type such as a document, deck, or design,
  and picking a model, where more capable models suit longer or higher-stakes
  work and an effort setting controls how long Claude thinks. Selecting a
  control highlights its location and explains its purpose, teaching the parts
  of a well-formed prompt and the composer's main controls.
</Copy>
<Copy k="widget.summary">
  Explorer: a still of the claude.ai composer with a worked prompt, its
  numbered legend showing what context, task, format, and material give
  Claude, and selectable controls revealing how to add files, connect tools,
  set output, and pick a model.
</Copy>
`;export{e as default};