...
`,(0,n.jsx)(r.p,{children:"When you use other tools, you write both the JSON schema and the function implementation. With the text editor tool, Claude provides the schema knowledge, but you must write functions to handle Claude's requests to create files, read directories, replace text, and so on."}),`
`,(0,n.jsx)(r.h2,{id:"schema-versions",children:"Schema Versions"}),`
`,(0,n.jsx)(r.p,{children:"While the main schema is built into Claude, you do need to include a small schema stub when making requests. The exact schema depends on which Claude model you're using:"}),`
...
`})}),`
`,(0,n.jsx)(r.p,{children:(0,n.jsx)(r.img,{src:"./9d50519a5375.png",alt:""})}),`
`,(0,n.jsx)(r.p,{children:"Claude sees this small schema and automatically expands it into the full text editor tool specification behind the scenes."}),`
...
`]}),`
`,(0,n.jsx)(r.p,{children:'You can take this further by asking Claude to modify files. For instance: "Open the ./main.py file and write out a function to calculate pi to the 5th digit. Then create a ./test.py file to test your implementation."'}),`
