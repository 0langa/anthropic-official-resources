...
`,(0,n.jsx)(i,{surface:"chat",prompts:["How do I create a derived dataset in Data Connect?","How do I configure edit checks for Rave EDC?","When is the last release of Clinical Data Studio and what features did it include?","We need to import external lab data into Data Connect. How do I do this and ensure alignment with our SOPs?"]})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};