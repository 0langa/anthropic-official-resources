...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: d2f8f0c85323b4c7 */}
<Copy k="widget.description">
  Film: the user asks Claude, through a Human Resources recruiting skill, to
  run a hiring-manager intake for a new role and produce a role specification.
  Claude reads a role-spec template, a leveling guide, and a team charter,
  then asks the user questions drawn from those documents wherever judgment is
  needed, such as which areas of a team the new hire will own, rather than
  guessing. Claude pushes back on vague answers, writes each must-have as
  something testable in an interview, and separates decided scope from items
  left open for the recruiter. The finished spec is delivered in the
  organization's own template. The user is shown saving this intake as a
  shared skill so every hiring manager answers the same standardized questions
  going forward.
</Copy>
<Copy k="widget.summary">
  Film: the user asks Claude, via a Human Resources recruiting skill, to
  interview them about a new role and draft a specification, reading a
  template, leveling guide, and team charter to ask judgment-based questions,
  push back on vague answers, and flag open items for the recruiter.
</Copy>
`;export{e as default};