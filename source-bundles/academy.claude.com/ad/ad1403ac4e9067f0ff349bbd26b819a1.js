...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 411899653cbce41b */}
<Copy k="widget.description">
  Exercise: a worksheet that walks a learner through running one real project
  by the full Delegation–Diligence process, producing a one-page decision
  memo. It asks the learner to name the project and its standards, establish
  Problem Awareness (what's really being solved, and whether AI suits it),
  establish Platform Awareness (what the chosen tool can actually do), then
  build a stage-by-stage Task Delegation table recording where AI is involved
  and the rationale, checked against the three Diligence checks. A final
  reach-goal prompt asks the learner to test the plan against a finished
  project with known standards. Responses autosave locally and can be copied
  or downloaded. The goal is a defensible, standards-based delegation decision
  rather than a reflexive choice to use AI.
</Copy>
<Copy k="widget.summary">
  Exercise: a worksheet that builds a one-page decision memo for a real
  project, covering Problem Awareness, Platform Awareness, and a
  stage-by-stage Task Delegation table checked against Creation, Transparency,
