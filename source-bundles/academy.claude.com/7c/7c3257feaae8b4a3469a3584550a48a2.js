...
`,(0,n.jsx)(r.li,{children:"Sample Prompts:"}),`
`]}),`
`,(0,n.jsx)(i,{surface:"chat",prompts:["Show me the hierarchy of breast cancer diagnosis codes to identify if we're using the most specific code","Search for diabetes codes with retinopathy complications - which codes distinguish between severity levels?","What ICD-10 codes exist in the category E08 for diabetes due to underlying condition?","Find all gastrointestinal resection procedures by body system. Are we coding to the appropriate specificity level?"]})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};