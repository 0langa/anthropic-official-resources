...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 53dc5002fd15a87d */}
<Copy k="widget.description">
  Film: after an opening shot of a product-analytics dashboard showing a
  weekly activation metric down, the user gives Claude, in a working folder
  with the funnel export, a changelog, and last week's narrative attached, a
  prompt to find the anomaly, segment by plan, platform, and signup source to
  isolate the driver, check it against what shipped that week, and write a
  "what happened and why" narrative with two supporting charts. Claude reads
  the files, searches the issue tracker, segments the funnel, ties the drop to
  one segment and one likely shipped change with a stated confidence level,
  and delivers the narrative with charts. The film closes by scheduling the
  same workflow to run weekly, ready before the team's review. It teaches a
  repeatable method: segment to isolate a driver, correlate with known
  changes, and document the explanation with visual proof.
</Copy>
<Copy k="widget.summary">
  Film: the user asks Claude to explain a weekly activation metric drop by
  segmenting the funnel, checking the isolated driver against what shipped,
  then writing a narrative with charts, scheduled to repeat weekly.
</Copy>
`;export{e as default};