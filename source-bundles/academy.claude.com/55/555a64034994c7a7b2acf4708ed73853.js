...
`,(0,n.jsx)(r.p,{children:"They have the same shape as a custom tool, but the SDK gives you the schema and a sensible runner."}),`
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Client tools"})," like memory and bash run where your code runs, but the SDK ships the schema and a runner for you."]}),`
