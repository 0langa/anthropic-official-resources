...
`,(0,n.jsxs)(r.p,{children:["Your ",(0,n.jsx)(r.code,{children:"add_user_message"})," and ",(0,n.jsx)(r.code,{children:"add_assistant_message"})," functions currently assume they're always working with plain text. Update them to handle full message objects:"]}),`
...
`,(0,n.jsx)(r.p,{children:"Since the chat function now returns full messages instead of just text, add a helper to extract text when needed:"}),`
...
`,(0,n.jsx)(r.h2,{id:"why-these-changes-matter",children:"Why These Changes Matter"}),`
`,(0,n.jsx)(r.p,{children:"These refactoring steps prepare your code for the reality of tool-enabled conversations:"}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Multiple blocks per message"})," - Claude's responses can contain both text and tool use blocks"]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Flexible message handling"})," - Your functions can now work with various message formats"]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Full message preservation"})," - You maintain all the information Claude provides, not just the text portions"]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Tool list support"})," - Your chat function can now receive and use multiple tools"]}),`
`]}),`
`,(0,n.jsx)(r.p,{children:"With these foundations in place, you're ready to implement the full conversation loop that handles multiple tool calls automatically, creating a seamless experience where Claude can use whatever tools it needs to answer user questions completely."})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}export{i as default};