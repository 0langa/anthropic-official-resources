...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: d2fe211ec0900b61 */}
<Copy k="widget.description">
  Exercise: the learner works through a scenario where a new product surface
  arrives inside an already-deployed Claude organization, and answers three
  questions about it: who gets access, whether it carries its own settings or
  connectors, and whether it changes any group's risk. Toggling each answer
  recolors and updates the reasoning behind five existing deployment decisions
  (structure and identity, access, governance, spend, visibility), showing
  which reopen for reconsideration and which carry over unchanged, with a
  running summary count. The goal is to internalize that most prior decisions
  carry over when a new surface appears, but answers to these three questions
  determine which specific ones must be revisited, and that a genuinely novel
  surface can still raise a new question beyond these three.
</Copy>
<Copy k="widget.summary">
  Exercise: toggling three answers about a new product surface's access,
  settings, and risk updates which of five existing deployment decisions
  reopen versus carry over, with a live summary count.
</Copy>
`;export{e as default};