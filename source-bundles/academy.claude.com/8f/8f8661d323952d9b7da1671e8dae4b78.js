...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: b80648a324422957 */}
<Copy k="widget.description">
  Simulation: in a mock Slack channel, Claude answers a request for call prep
  with a long brief, and the learner picks one or more things to tell Claude:
  to make that brief shorter, to keep replies casual, short and in bullets
  from now on, to check a legal channel before preparing a brief, or not to
  reply to thank-you messages. The next morning, a new request shows which of
  these Claude still follows. The learner can remove a saved note and can add
  the saved reply style to the channel instructions. It teaches the difference
  between a one-time correction, a rule Claude saves to channel notes, and
  channel instructions, which Claude reads in every new thread and which
  outrank memory.
</Copy>
<Copy k="widget.summary">
  Simulation: after Claude writes a call brief in a mock Slack channel, tell
  it what to do differently, then see the next morning what it saved to the
  channel's notes and what applied once. You can add the saved reply style to
