...
`,(0,r.jsxs)(i.p,{children:["MCP connects Claude Code to your external tools and data sources. Add servers with ",(0,r.jsx)(i.code,{children:"claude mcp add"}),". Scope them to your project with ",(0,r.jsx)(i.code,{children:".mcp.json"})," so your team gets them automatically. And keep an eye on context usage by disabling servers you're not actively using."]})]})}function a(e={}){let{wrapper:n}={...t(),...e.components};return n?(0,r.jsx)(n,{...e,children:(0,r.jsx)(i,{...e})}):i(e)}function o(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default};