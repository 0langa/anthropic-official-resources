...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 008faca798af65b1 */}
<Copy k="widget.description">
  Exercise: a fillable workbook for educators to practice the 4D Framework for
  using AI responsibly (Description, Discernment, Delegation, Diligence),
  framed as two loops. Learners read three guardrails, check off past AI
  experiences in a warm-up, then work through the 4Ds: building a prompt with
  Role, Task, Context, Format, Constraint, and judging output against the
  CHECK criteria (Correct, Human, Equitable, Curriculum-aligned, Kid-safe). A
  delegation matrix has them sort sample tasks by impact and AI risk into
  categories from full delegation to keeping work human. A third activity has
  them plan Delegation and Diligence for a real task of their own. It closes
  with a one-week commitment, and responses can be downloaded as HTML or PDF
  to keep, print, or share.
</Copy>
<Copy k="widget.summary">
  Exercise: a fillable workbook guiding educators through the 4D Framework,
  practicing prompt-building and judgment criteria, sorting sample tasks by
  impact and AI risk, and committing to a real next step, downloadable as HTML
  or PDF.
</Copy>
`;export{e as default};