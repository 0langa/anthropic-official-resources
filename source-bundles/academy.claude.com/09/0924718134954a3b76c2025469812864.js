...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 8b499472611590e7 */}
<Copy k="widget.description">
  Explorer: a filterable catalog of behavioral indicators across the four
  dimensions of AI fluency — Description (communicating clearly with AI),
  Delegation (deciding what to hand off to AI versus do yourself), Discernment
  (evaluating AI's output), and Diligence (using AI responsibly and
  accountably). Learners browse by dimension or view all indicators, expanding
  each to see why it matters, example phrases showing what the behavior sounds
  like, and concrete things to try in their own conversations. The goal is to
  help learners recognize and build these collaboration habits. A separate
  prompt can be opened directly in Claude to analyze the learner's own past
  conversations and generate a personalized, exploratory scorecard against a
  smaller set of eleven behavioral indicators drawn from the Description,
  Delegation, and Discernment dimensions, not the full catalog.
</Copy>
<Copy k="widget.summary">
  Explorer: a filterable catalog of AI fluency behavioral indicators across
  four dimensions—Description, Delegation, Discernment, and Diligence—each
  expandable to show why it matters and example phrases. Includes a prompt to
  open in Claude for a personalized reflection on one's own conversation
  patterns.
</Copy>
`;export{e as default};