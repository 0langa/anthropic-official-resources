...
`]}),`
`,(0,n.jsx)(r.p,{children:"The behavior worth keeping from this lesson: whenever you enable extended thinking on a new task, read the reasoning content on a few representative requests and re-run your evaluations before deciding the setting stays."})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}export{i as default};