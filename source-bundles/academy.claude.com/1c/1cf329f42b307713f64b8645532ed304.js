...
{/* Learner-facing copy for Embed3.tsx, a working replica of the claude.ai
    ...
    Product control names (Output, Effort, Connectors, Document,
    Presentation, Design, Artifact, Research, Web search, Memory, Extended
    thinking) should match the claude.ai interface in the target language;
    the model names Claude Fable, Opus, Sonnet and Haiku stay as they are.
    "+" names the composer's plus button; "⌘U", file names and the sample
    design system "Halden" are data in the widget and do not appear here. */}
...
<Copy k="role.general.step3.hint">
  ...
  Presentation. You get a deck you can present, edit and export.
</Copy>
...
<Copy k="output.docs.label">Document</Copy>
<Copy k="output.slides.label">Presentation</Copy>
...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 312e5b1feca9a93e */}
<Copy k="widget.description">
  Simulation: a working replica of the claude.ai message box, for setting up a
  first task. The learner picks a kind of work: general, personal, sales,
  marketing, legal, or finance. Each kind loads a sample prompt with a blank
  to fill and a checklist of three steps. The first step gives Claude
  something to read, either a connected tool or an attached file. The second
  fills in a missing detail, such as who the work is for. The third sets a
  control under the message box: the Output, such as slides or a design, a
  look at the model, or a higher effort for careful work. When all three are
  done, the checklist says the task is ready to send. It teaches that a good
  setup says what Claude should read, what you want back, and the form it
  should take. Sending is only an illustration.
</Copy>
<Copy k="widget.summary">
  Simulation: a replica of the claude.ai message box where you pick a kind of
  work, then give Claude a tool or file, fill in a missing detail, and set the
  output, model, or effort.
</Copy>
`;export{e as default};