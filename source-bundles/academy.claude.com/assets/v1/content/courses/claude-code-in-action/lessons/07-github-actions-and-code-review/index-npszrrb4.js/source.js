import{Hf as e,Wf as t}from"../../../../../content-es-meta-mstc7yuz.js";var n=e();function r(e){let r={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...t(),...e.components},{LessonVideo:i}=r;return i||a("LessonVideo",!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i,{youtubeId:"gIVt_iqmACw",title:"GitHub Actions and Code Review",children:(0,n.jsx)(r.p,{children:`The best place to hand off repetitive work is the pull request. It's where
...
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.code,{children:"anthropic_api_key"})," — optional."]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.code,{children:"github_token"})," — defaults to ",(0,n.jsx)(r.code,{children:"secrets.GITHUB_TOKEN"}),"."]}),`
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.code,{children:"use_bedrock"})," / ",(0,n.jsx)(r.code,{children:"use_vertex"})," — switch to those providers if you're on Bedrock or Vertex."]}),`
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.code,{children:"prompt"})," — the instruction for the run."]}),`
...
`,(0,n.jsxs)(r.p,{children:["Drop a workflow into ",(0,n.jsx)(r.code,{children:".github/workflows/claude.yaml"})," and it listens for ",(0,n.jsx)(r.code,{children:"@claude"})," on PR comments and issue comments. The core step looks like this:"]}),`
