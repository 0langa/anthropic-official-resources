...
<Copy k="card.cowork.line">
  A workspace. Point Claude at a folder and your tools, describe an
  outcome—Claude plans, executes, and delivers.
</Copy>
...
<Copy k="quiz.title">Match the task to the mode</Copy>
<Copy k="quiz.intro">
...
<Copy k="status.pick">Pick a mode to continue</Copy>
