...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 08d8f1d1854b0bf9 */}
<Copy k="widget.description">
  Diagram: a decision tree for choosing where to start a piece of work with
  Claude. It first asks whether the work is only for you, and if so, whether
  it needs the team's tools. Work only for you that needs no team tools goes
  to a DM. All other work meets one more question, whether it must be kept to
  specific people: if not, it goes to a public channel, marked as recommended;
  if so, it goes to a private channel or a channel with only you and Claude.
  For each place, the diagram says who can see the work, which tools Claude
  can use, and how what Claude learns is used: only in that DM, for everyone
  in a public channel, or only in that private channel. It teaches that the
  right place depends on who the work is for and what it needs.
</Copy>
<Copy k="widget.summary">
  Diagram: a decision tree for where to start work with Claude. Questions
  about who the work is for, the team's tools, and keeping it to specific
  people lead to a DM, a recommended public channel, or a private channel.
</Copy>
`;export{e as default};