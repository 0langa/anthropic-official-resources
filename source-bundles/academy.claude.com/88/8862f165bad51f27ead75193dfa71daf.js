...
`,(0,n.jsx)(i,{type:"note",children:(0,n.jsx)(r.p,{children:(0,n.jsxs)(r.em,{children:[`Note that Claude Fable 5.1 has been generally available since September 1,
...
`,(0,n.jsx)(r.a,{href:"https://www.anthropic.com/claude-fable-and-mythos-5-1",children:"here"}),`. The video and
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Claude Fable"})," is our most capable model yet — a new tier that sits above Opus, built for your toughest challenges. It comes at a higher cost than Opus, so reserve it for work where that extra capability is worth paying for. The current Fable model is Claude Fable 5.1 (",(0,n.jsx)(r.code,{children:"claude-fable-5-1"}),")."]}),`
...
`]}),`
`,(0,n.jsx)(r.p,{children:(0,n.jsx)(r.img,{src:"./8750225705f5.png",alt:"Three cards from before Claude Fable 5.1, comparing three of the four Claude model tiers: Haiku (fastest, lowest cost, for classification and routing), Sonnet (capable and fast, for most production work), and Opus (labeled most intelligent and highest cost, for deep reasoning and complex analysis). The fourth tier, Claude Fable, now sits above Opus in capability and cost and is not shown."})}),`
