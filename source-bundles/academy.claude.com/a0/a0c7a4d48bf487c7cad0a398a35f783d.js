...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: b8feea22873bcb20 */}
<Copy k="widget.description">
  Exercise: a builder that turns a real piece of the learner's work into a
  prompt for the Claude desktop app. The learner first chooses one or more
  places where the work is, and each choice names the feature that reaches it:
  folders for files on the computer, extensions or computer use for a program,
  the built-in browser for a website, and connectors for email, calendar, and
  Drive. Then the learner chooses what to do, such as getting ready for a
  meeting, writing something up, or getting through a backlog. The widget
  writes a prompt with blanks to fill in, which can be copied, and a checklist
  of only the setup those choices need, such as giving Claude a folder or
  connecting a tool. An optional menu fills in a worked example for one of six
  roles.
</Copy>
<Copy k="widget.summary">
  Exercise: choose where a real piece of your work is, such as files, a
  program, a website, or email, and what you need to do. You get an editable
  prompt for the desktop app and a matching setup checklist.
</Copy>
`;export{e as default};