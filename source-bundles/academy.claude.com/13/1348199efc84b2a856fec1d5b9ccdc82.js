...
`]}),`
`,(0,n.jsx)(r.p,{children:"Remember that the default cache lasts 5 minutes (refreshed on each use), with a 1-hour option available at additional cost, so it's designed for applications with relatively frequent API usage rather than long-term storage."})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}export{i as default};