import{Nm as e,jm as t}from"../../../../../content-de-meta-mdrrzgmt.js";var n=t(),r=`# Creating your first skill
...
`;function i(t){let i={code:"code",h2:"h2",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...e(),...t.components},{CodeCommand:a,LessonVideo:s}=i;return a||o("CodeCommand",!0),s||o("LessonVideo",!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i.h2,{id:"creating-your-first-skill",children:"Creating your first skill"}),`
...
`,(0,n.jsxs)(i.p,{children:["In the next lesson, you'll learn about advanced configuration options including metadata fields, tool restrictions with ",(0,n.jsx)(i.code,{children:"allowed-tools"}),", and how to structure larger skills using progressive disclosure and multi-file organization."]})]})}function a(t={}){let{wrapper:r}={...e(),...t.components};return r?(0,n.jsx)(r,{...t,children:(0,n.jsx)(i,{...t})}):i(t)}function o(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{a as default};