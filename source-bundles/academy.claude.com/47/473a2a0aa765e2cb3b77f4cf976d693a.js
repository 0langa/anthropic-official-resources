import{Hf as e,Wf as t}from"../../../../../content-es-meta-mstc7yuz.js";var n=e();function r(e){let r={code:"code",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...e.components},{CodeCommand:i,LessonVideo:o}=r;return i||a("CodeCommand",!0),o||a("LessonVideo",!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(o,{youtubeId:"b9TCW-pdzDA",title:"Routines and headless",children:[(0,n.jsx)(r.p,{children:`Once you trust Claude to do a task, the next move is to stop doing it by
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsxs)(r.strong,{children:["Each run starts from a fresh clone of your default branch and can only push to ",(0,n.jsx)(r.code,{children:"claude/"})," prefixed branches"]})," unless you loosen that per repo. This is the guardrail that keeps an autonomous run from rewriting main."]}),`
`]}),`
...
`]}),`
`,(0,n.jsx)(r.p,{children:"Start with routines. Drop down the spectrum only when the job actually needs the extra control."})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};