...
`,(0,n.jsx)(r.h2,{id:"getting-the-complete-message",children:"Getting the Complete Message"}),`
`,(0,n.jsx)(r.p,{children:"While streaming individual chunks is great for user experience, you often need the complete message for storage or further processing. After streaming completes, you can get the assembled final message:"}),`
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:"language-python",children:`with client.messages.stream(
    model=model,
    max_tokens=1000,
    messages=messages
...
`})}),`
`,(0,n.jsx)(r.p,{children:"This gives you the best of both worlds: real-time streaming for users and a complete message object for your application logic."})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}export{i as default};