...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 9d0eca740e761b7a */}
<Copy k="widget.description">
  Reference list: three example use cases for messaging Claude in a DM, each
  showing a goal, the steps Claude takes to get there, and a ready-to-copy
  sample message illustrating how to phrase the request. The cases cover
  preparing for a meeting by pulling channel, email, and calendar information;
  drafting a status update by checking project channels against your own email
  and calendar; and receiving a recurring daily brief that lists what is
  waiting on you and drafts replies you owe. The goal is to show concretely
  what kinds of personal, cross-source work suit a DM with Claude, and how to
  word a request so Claude knows what to search, check, and produce, including
  turning a request into a standing routine.
</Copy>
<Copy k="widget.summary">
  Reference list: three example use cases for messaging Claude in a DM, each
  with a goal, the steps Claude takes, and a copyable sample message, showing
  how to phrase requests for personal, cross-source work.
</Copy>
`;export{e as default};