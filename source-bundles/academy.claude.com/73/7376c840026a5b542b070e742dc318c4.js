...
`,(0,n.jsxs)(r.p,{children:["A skill isn't just a single ",(0,n.jsx)(r.code,{children:"skill.md"})," file. The folder around it can carry other things, and this is what makes skills powerful for verification."]}),`
`,(0,n.jsxs)(r.ul,{children:[`
`,(0,n.jsxs)(r.li,{children:["Drop a ",(0,n.jsx)(r.code,{children:"reference.md"})," next to the skill for detailed material, then link to it from ",(0,n.jsx)(r.code,{children:"skill.md"}),". Claude only reads it when it actually needs that depth. Your main file stays short."]}),`
...
`,(0,n.jsxs)(r.p,{children:["A skill is a folder with a ",(0,n.jsx)(r.code,{children:"skill.md"})," inside it: a name, a description that triggers it, and the procedure itself. Only the descriptions load into context until a skill is actually needed, so there's no cost to packaging every procedure you repeat."]}),`
`,(0,n.jsxs)(r.p,{children:["Start with verification. Build the skill, check it into your project's ",(0,n.jsx)(r.code,{children:".claude/skills"}),", and now the whole team inherits the same move. Everyone's work gets checked the same way, automatically, without anyone having to remember to ask."]})]})}function i(t={}){let{wrapper:i}={...e(),...t.components};return i?(0,n.jsx)(i,{...t,children:(0,n.jsx)(r,{...t})}):r(t)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};