...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"Plan"})," researches and proposes changes without editing anything. Reads run freely, and when auto mode is available, auto's classifier reviews the commands Claude runs to explore and lets the approved ones run without a prompt."]}),`
...
`,(0,n.jsx)(r.li,{children:"Irreversibly destroying files that existed before the session"}),`
`]}),`
...
`]}),`
`,(0,n.jsx)(r.p,{children:"Pick the mode that fits what you're doing, and let Claude run at that level."})]})}function i(e={}){let{wrapper:i}={...t(),...e.components};return i?(0,n.jsx)(i,{...e,children:(0,n.jsx)(r,{...e})}):r(e)}function a(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}export{i as default};