...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: 0c80946b0465c493 */}
<Copy k="widget.description">
  Film: the user asks Claude, via a Sales plugin skill, to research a prospect
  account before a call, naming sources to pull from and asking for call
  openers. Claude reads the CRM history first, then a filing, recent news, and
  executive social posts, narrating each step before producing a one-page
  brief covering what the account does, what's changed recently (each change
  dated and sourced), where the seller's product fits, and openers tied to
  recent events and prior history. Claude also flags anything it couldn't
  confirm. The film closes by showing how the task can be scheduled to run
  automatically on a recurring cadence across multiple accounts, producing a
  saved brief for each before prospecting sessions.
</Copy>
<Copy k="widget.summary">
  Film: the user asks Claude to research a prospect account before a call,
  naming sources and asking for openers. Claude reads CRM history, a filing,
  news, and executive posts, then writes a one-page brief with dated changes,
  fit, and openers, and shows scheduling it recurringly.
</Copy>
`;export{e as default};