...
{/* Written from this widget's copy by \`node apps/academy/scripts/describe-widgets.ts\`, run at the
    repository root. Run it again after you edit its copy. described-from: afb2b29e9fef3bd8 */}
<Copy k="widget.description">
  Explorer: this widget presents the 4D Framework for AI fluency, organized
  around four competencies for educators: Description (communicating clearly
  with AI), Delegation (deciding what to do with AI versus oneself),
  Discernment (evaluating AI's output), and Diligence (using AI responsibly
  and accountably). Learners can filter by competency to browse a set of
  specific indicators describing fluent AI use in a classroom context. Each
  indicator expands to show example phrases illustrating "what it sounds like"
  in an educator's voice, plus concrete "things to try" prompts for practicing
  that behavior. The goal is to help educators recognize and build these
  specific habits of mind when working with AI in their teaching practice.
</Copy>
<Copy k="widget.summary">
  Explorer: browse the 4D Framework's four AI-fluency competencies for
  educators—Description, Delegation, Discernment, and Diligence—filtering to
  expand indicators with educator-voice examples and things to try in the
  classroom.
</Copy>
`;export{e as default};