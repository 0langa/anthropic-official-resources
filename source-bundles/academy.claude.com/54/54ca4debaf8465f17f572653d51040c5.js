...
`,(0,n.jsxs)(r.p,{children:["In TypeScript, the runner's recommended helper, ",(0,n.jsx)(r.code,{children:"betaZodTool()"}),", describes each tool with a short schema written in Zod, a TypeScript library for declaring and validating the shape of data. The helper needs Zod 3.25.0 or later, which a fresh install gets you:"]}),`
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:"language-bash",children:`npm install zod
`})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:"language-typescript",children:`import { betaZodTool } from "@anthropic-ai/sdk/helpers/beta/zod";
import { z } from "zod";
...
`,(0,n.jsxs)(r.li,{children:[(0,n.jsx)(r.strong,{children:"No handwritten JSON schemas"}),", just a short Zod schema per tool, which also validates the input Claude sends."]}),`
`,(0,n.jsxs)(r.li,{children:["Each ",(0,n.jsx)(r.code,{children:"run"})," function wraps the same lookup we ran by hand a minute ago."]}),`
...
`,(0,n.jsxs)(r.p,{children:["Take a compliance review agent: its tools are thin wrappers around ",(0,n.jsx)(r.code,{children:"lookup_building_code"})," and ",(0,n.jsx)(r.code,{children:"search_building_code"})," functions that already exist in the codebase. With the tool runner, you wrap each of those functions in a short tool definition with its own Zod schema, and the agent cites specific code sections in every finding it writes:"]}),`
...
`,(0,n.jsxs)(r.li,{children:["The SDK's ",(0,n.jsx)(r.strong,{children:"tool runner"})," (available in beta across the Claude SDKs) handles the whole loop, and in TypeScript each tool is a short definition with a Zod schema. Or you can run the loop yourself."]}),`
